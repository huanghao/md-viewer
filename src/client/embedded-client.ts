...
\`);if(n.length===0){Z=t,we=o,Ce=new Set,ee=!1,\$e=!0;return}\$e&&!ee&&Z===t&&we===o||ee&&Z===t&&we===o||(Tt+=1,Z=t,we=o,ee=!0,\$e=!1,Ce=new Set,Dr(t,n,o,Tt))}function Io(){let e=document.getElementById(Ye),t=document.getElementById(Lo);if(!t)return;let n=e?.value.trim()||"";t.textContent=n||"\\u8DEF\\u5F84\\u9884\\u89C8\\uFF1A\\u5728\\u4E0A\\u65B9\\u8F93\\u5165\\u540E\\u8FD9\\u91CC\\u4F1A\\u663E\\u793A\\u5B8C\\u6574\\u8DEF\\u5F84"}function Or(){let e=document.getElementById(kn);if(e)return e;let t=document.createElement("div");t.id=kn,t.className="sync-dialog-overlay add-workspace-overlay",t.innerHTML=\`
  ...
  \`}function Jr(e,t,n,o){let i=l.currentWorkspace===e.id,r=o?jr(e,o):l.fileTree.get(e.id),a=r;if(r){let h=Ie(r,e.path);h.size>0&&(a=Ao(r,h)??void 0)}let s=o?!0:e.isExpanded,c=s?"\\u25BC":"\\u25B6",d=t>0,u=t<n-1,m=!o||e.name.toLowerCase().includes(o)||e.path.toLowerCase().includes(o),p=!!a&&!!a.children&&a.children.length>0,g=s?Vr(e.id,e.path,a,o):"";return o&&!m&&!p&&!!!g?"":\`
...
>\\u{1F4CC}</button>\`;return\`
  ...
  \`}function Vr(e,t,n,o){let i=new Set;\$o(n,i);let r=\`\${t}/\`,a=nn().filter(u=>!u.isMissing||!u.path.startsWith(r)||i.has(u.path)?!1:o?u.name.toLowerCase().includes(o)||u.path.toLowerCase().includes(o):!0),s=new Set(a.map(u=>u.path)),c=Ut(t).filter(u=>!s.has(u)).filter(u=>!i.has(u)).filter(u=>{if(!o)return!0;let m=u.toLowerCase(),p=(u.split("/").pop()||"").toLowerCase();return m.includes(o)||p.includes(o)});return a.length===0&&c.length===0?"":\`
...
\`,d);return u===-1?o.length:u};switch(n){case"a":return a(s(i)),!0;case"e":return a(c(i)),!0;case"b":return a(Math.max(0,i-1)),!0;case"f":return a(Math.min(o.length,i+1)),!0;case"n":{let d=c(i);return a(d===o.length?d:Math.min(o.length,d+1+(i-s(i)))),!0}case"p":{let d=s(i);if(d===0)return a(0),!0;let u=s(d-1),m=d-1-u;return a(u+Math.min(i-d,m)),!0}case"d":return i<o.length&&(t.value=o.slice(0,i)+o.slice(i+1),a(i),t.dispatchEvent(new Event("input"))),!0;case"k":{let d=c(i),u=i===d&&d<o.length?d+1:d;return t.value=o.slice(0,i)+o.slice(u),a(i),t.dispatchEvent(new Event("input")),!0}case"u":{let d=s(i);return t.value=o.slice(0,d)+o.slice(i),a(d),t.dispatchEvent(new Event("input")),!0}case"w":{let d=i;for(;d>0&&/\\s/.test(o[d-1]);)d--;for(;d>0&&!/\\s/.test(o[d-1]);)d--;return t.value=o.slice(0,d)+o.slice(i),a(d),t.dispatchEvent(new Event("input")),!0}case"h":return i>0&&(t.value=o.slice(0,i-1)+o.slice(i),a(i-1),t.dispatchEvent(new Event("input"))),!0;default:return!1}}function te(e){return e==="up"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 4l4 4H4z"/></svg>':e==="down"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 12l-4-4h8z"/></svg>':e==="check"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M6.4 11.2L3.5 8.3l1.1-1.1 1.8 1.8 5-5 1.1 1.1z"/></svg>':e==="trash"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M6 2h4l1 1h3v1H2V3h3l1-1zm-1 4h1v7H5V6zm3 0h1v7H8V6zm3 0h1v7h-1V6z"/></svg>':e==="comment"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 2h12v9H8l-3 3v-3H2z"/></svg>':e==="list"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M3 3h10v1H3zm0 4h10v1H3zm0 4h10v1H3z"/></svg>':e==="filter"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 3h12L9.5 8v4.5l-3-1.5V8z"/></svg>':e==="edit"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M11.5 2.5a1.5 1.5 0 012.1 2.1L5 13.2l-3 .8.8-3 8.7-8.5z"/></svg>':e==="reopen"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 2a6 6 0 100 12A6 6 0 008 2zm0 1.5a4.5 4.5 0 110 9 4.5 4.5 0 010-9zM6 5.5l4 2.5-4 2.5V5.5z"/></svg>':'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M4.2 4.2L8 8l3.8-3.8 1 1L9 9l3.8 3.8-1 1L8 10l-3.8 3.8-1-1L7 9 3.2 5.2z"/></svg>'}function Nt(){return[...f.annotations].filter(e=>ra(e,f.filter)).sort((e,t)=>e.start-t.start)}function aa(){let e=T();if(e.filterMenu?.querySelectorAll(".annotation-filter-item[data-filter]").forEach(t=>{let n=t;n.classList.toggle("is-active",n.getAttribute("data-filter")===f.filter)}),e.densityToggle&&(e.densityToggle.classList.toggle("is-simple",f.density==="simple"),e.densityToggle.title=f.density==="simple"?"\\u5207\\u6362\\u5230\\u9ED8\\u8BA4\\u5217\\u8868":"\\u5207\\u6362\\u5230\\u6781\\u7B80\\u5217\\u8868"),e.filterToggle){let t={all:"\\u7B5B\\u9009\\uFF1A\\u5168\\u90E8",open:"\\u7B5B\\u9009\\uFF1A\\u672A\\u89E3\\u51B3",resolved:"\\u7B5B\\u9009\\uFF1A\\u5DF2\\u89E3\\u51B3",orphan:"\\u7B5B\\u9009\\uFF1A\\u5B9A\\u4F4D\\u5931\\u8D25"};e.filterToggle.title=t[f.filter]}}function sa(){let e=T();e.annotationCount&&(e.annotationCount.textContent=String(Nt().length))}function Ne(e){let t=T();t.sidebar&&(t.sidebar.classList.toggle("collapsed",e),document.body.classList.toggle("annotation-sidebar-collapsed",e),e&&(t.filterMenu?.classList.add("hidden"),Be(!0),ie(!0)))}function pi(){try{let e=localStorage.getItem(ri);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function la(e){localStorage.setItem(ri,JSON.stringify(e))}function mi(e){if(!f.currentFilePath)return;let t=pi();t[f.currentFilePath]=e,la(t)}function ca(e){return Math.max(Xr,Math.min(Yr,Math.round(e)))}function fi(e){let t=ca(e);document.documentElement.style.setProperty("--annotation-sidebar-width",\`\${t}px\`),localStorage.setItem(oi,String(t))}function da(){let e=Number(localStorage.getItem(oi)),t=Number.isFinite(e)&&e>0?e:ii;fi(t)}function oe(){let e=T();if(!e.sidebar)return;let t=document.getElementById("tabs"),n=Math.max(0,Math.round(t?.getBoundingClientRect().bottom||84)),o=Math.max(0,window.innerHeight-n);e.sidebar.style.top=\`\${n}px\`,e.sidebar.style.height=\`\${o}px\`,e.sidebarResizer&&(e.sidebarResizer.style.top=\`\${n}px\`,e.sidebarResizer.style.height=\`\${o}px\`),e.floatingOpenBtn&&(e.floatingOpenBtn.style.top=\`\${n+6}px\`)}function Yo(){Ne(!1),mi(!0),oe(),In()}function Zo(){Ne(!0),mi(!1)}function ua(){let e=T().sidebar;e&&Ne(!e.classList.contains("collapsed"))}function gi(){let e=T();return e.filterMenu&&!e.filterMenu.classList.contains("hidden")?(e.filterMenu.classList.add("hidden"),!0):e.quickAdd&&!e.quickAdd.classList.contains("hidden")?(Be(!0),!0):e.composer&&!e.composer.classList.contains("hidden")?(tt(),!0):e.popover&&!e.popover.classList.contains("hidden")?(f.pinnedAnnotationId=null,ie(!0),!0):!1}function pa(e,t){return e==="resolved"?"resolved":t}function ma(e,t,n){let o=T();if(!o.quickAdd)return;o.composer&&!o.composer.classList.contains("hidden")&&tt(),f.pendingAnnotation={...n,note:"",createdAt:Date.now()},f.pendingAnnotationFilePath=o.content?.getAttribute("data-current-file")||f.currentFilePath;let i=30,r=30,a=Ft(e,8,window.innerWidth-i-8),s=Ft(t,8,window.innerHeight-r-8);o.quickAdd.style.left=\`\${a}px\`,o.quickAdd.style.top=\`\${s}px\`,o.quickAdd.classList.remove("hidden")}function Be(e=!1){let t=T();t.quickAdd&&(t.quickAdd.classList.add("hidden"),e&&(\$n(),f.pendingAnnotation=null,f.pendingAnnotationFilePath=null))}function fa(e,t){let n=T();if(!f.pendingAnnotation||!n.composer||!n.composerNote)return;ya(),n.composerNote.value="",bi(n.composerNote);let o=typeof e=="number"?e:n.quickAdd?Number.parseFloat(n.quickAdd.style.left||"0"):0,i=typeof t=="number"?t:n.quickAdd?Number.parseFloat(n.quickAdd.style.top||"0"):0;Ln(n.composer,o,i+34),n.composer.classList.remove("hidden"),Be(!1),n.composerNote.focus()}function ga(){let e=T();e.composer&&e.composer.classList.add("hidden")}function ha(){let e=T();if(!e.composer||!f.pendingAnnotation)return;let n=document.getElementById("reader")?.querySelector(".annotation-mark-temp");if(n){let o=n.getBoundingClientRect();Ln(e.composer,o.right+6,o.top-8)}e.composer.classList.remove("hidden"),e.composerNote?.focus()}function tt(){let e=T();e.composer&&(\$n(),f.pendingAnnotation=null,f.pendingAnnotationFilePath=null,e.composerNote&&(e.composerNote.value=""),e.composer.classList.add("hidden"))}function \$n(){let e=document.getElementById("reader");if(!e)return;let t=Array.from(e.querySelectorAll(".annotation-mark-temp"));for(let n of t){let o=n.parentNode;for(;n.firstChild;)o?.insertBefore(n.firstChild,n);o?.removeChild(n)}}function ya(){let e=T();if(!e.reader||!f.pendingAnnotation)return;\$n();let t=f.pendingAnnotation,n=Lt(e.reader,t.start),o=Lt(e.reader,t.start+t.length);if(!(!n||!o)&&!(n.node===o.node&&n.offset===o.offset)){if(n.node===o.node){let i=document.createRange();i.setStart(n.node,n.offset),i.setEnd(o.node,o.offset);let r=document.createElement("span");r.className="annotation-mark-temp";try{i.surroundContents(r)}catch{}return}try{let i=[],r=document.createTreeWalker(e.reader,NodeFilter.SHOW_TEXT,null,!1),a;for(;a=r.nextNode();){let s=document.createRange();s.selectNode(a);let c=document.createRange();c.setStart(n.node,n.offset),c.setEnd(o.node,o.offset);let d=c.compareBoundaryPoints(Range.END_TO_START,s),u=c.compareBoundaryPoints(Range.START_TO_END,s);if(d>0||u<0)continue;let m=a===n.node?n.offset:0,p=a===o.node?o.offset:a.nodeValue?.length||0;m<p&&i.push({node:a,start:m,end:p})}for(let s=i.length-1;s>=0;s--){let{node:c,start:d,end:u}=i[s],m=document.createRange();m.setStart(c,d),m.setEnd(c,u);let p=document.createElement("span");p.className="annotation-mark-temp",m.surroundContents(p)}}catch{}}}function Cn(e){return ai(e),e.thread||[]}function hi(e,t=!1){let n=Cn(e),o=n[0],i=n.slice(1);return t?\`
  ...
  \`,o.popoverResolveBtn){let a=ne(e);o.popoverResolveBtn.title=a?"\\u91CD\\u65B0\\u6253\\u5F00":"\\u6807\\u8BB0\\u5DF2\\u89E3\\u51B3",o.popoverResolveBtn.setAttribute("aria-label",a?"\\u91CD\\u65B0\\u6253\\u5F00":"\\u6807\\u8BB0\\u5DF2\\u89E3\\u51B3"),o.popoverResolveBtn.innerHTML=te(a?"reopen":"check"),o.popoverResolveBtn.classList.toggle("is-resolved",a)}o.popover.style.left=\`\${Math.round(t)}px\`,o.popover.style.top=\`\${Math.round(n)}px\`,o.popover.classList.remove("hidden")}function ei(){let e=f.pinnedAnnotationId;if(!e)return;let t=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(!t)return;let n=f.annotations.find(i=>i.id===e);if(!n)return;let o=t.getBoundingClientRect();nt(n,o.right+8,o.top+8)}function ie(e=!1){let t=T();t.popover&&(!e&&f.pinnedAnnotationId||(t.popover.classList.add("hidden"),e&&(f.pinnedAnnotationId=null)))}function ti(e){let t=T();if(!f.pendingAnnotation||!t.composerNote)return;let n=f.pendingAnnotationFilePath;if(!n||n!==e)return;let o=t.composerNote.value.trim();if(!o)return;let i=Date.now(),r={...f.pendingAnnotation,serial:ea(f.annotations),note:o,thread:[{id:\`c-\${i}-\${Math.random().toString(16).slice(2,8)}\`,type:"comment",note:o,createdAt:i}]};f.annotations.push(r),Sn(e,r,"\\u521B\\u5EFA\\u8BC4\\u8BBA\\u5931\\u8D25"),tt(),N(),\$(e)}function wi(e,t){let n=f.annotations.slice();f.annotations=f.annotations.filter(o=>o.id!==e),f.pinnedAnnotationId===e&&(f.pinnedAnnotationId=null,ie(!0)),f.activeAnnotationId===e&&(f.activeAnnotationId=null),N(),\$(t),Jo(t,{id:e}).catch(o=>{f.annotations=n,S(\`\\u5220\\u9664\\u8BC4\\u8BBA\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`,2600),N(),\$(t)})}function ba(e){let t=T();if(!t.content)return;let n=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(n){let o=t.content.getBoundingClientRect(),i=n.getBoundingClientRect(),a=t.content.scrollTop+(i.top-o.top),c=Math.max(0,a-56);t.content.scrollTo({top:c,behavior:"smooth"})}}function vi(e,t){f.activeAnnotationId=e,N(),e&&(ba(e),f.pinnedAnnotationId=e,requestAnimationFrame(()=>{let n=f.annotations.find(r=>r.id===e),o=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(!n||!o)return;let i=o.getBoundingClientRect();nt(n,i.right+8,i.top+8)})),\$(t)}function It(e,t,n){let o=Nt(),i=o.findIndex(a=>a.id===e);if(i<0)return;let r=o[i+t];r&&vi(r.id,n)}function wa(e){let t=document.getElementById("content"),n=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(!t||!n)return null;let o=t.getBoundingClientRect(),i=n.getBoundingClientRect();return t.scrollTop+(i.top-o.top)}function In(){if(f.density!=="default")return;let e=document.getElementById("content"),t=document.getElementById("annotationList");!e||!t||(t.scrollTop=e.scrollTop)}function ki(e,t){let n=f.annotations.find(r=>r.id===e);if(!n)return;let o=n.status;n.status==="resolved"?n.status=(n.confidence||0)<=0?"unanchored":"anchored":n.status="resolved";let i=n.status||"anchored";ie(!0),N(),\$(t),Uo(t,{id:e},i).catch(r=>{n.status=o,S(\`\\u66F4\\u65B0\\u8BC4\\u8BBA\\u72B6\\u6001\\u5931\\u8D25: \${r?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`,2600),N(),\$(t)})}function ni(e,t){e.classList.add("annotation-mark"),e.dataset.annotationId=t.id,e.classList.add(\`status-\${Fn(t)}\`),ne(t)&&e.classList.add("is-resolved")}function va(e,t){let n=T();if(!n.reader||typeof e.start!="number"||typeof e.length!="number"||e.length<=0)return;let o=Lt(n.reader,e.start,t),i=Lt(n.reader,e.start+e.length,t);if(!(!o||!i)&&!(o.node===i.node&&o.offset===i.offset)){if(o.node===i.node){let r=document.createRange();r.setStart(o.node,o.offset),r.setEnd(i.node,i.offset);let a=document.createElement("span");ni(a,e);try{r.surroundContents(a)}catch{}return}try{let r=[],a=document.createTreeWalker(n.reader,NodeFilter.SHOW_TEXT,null,!1),s;for(;s=a.nextNode();){let c=document.createRange();c.selectNode(s);let d=document.createRange();d.setStart(o.node,o.offset),d.setEnd(i.node,i.offset);let u=d.compareBoundaryPoints(Range.END_TO_START,c),m=d.compareBoundaryPoints(Range.START_TO_END,c);if(u>0||m<0)continue;let p=s===o.node?o.offset:0,g=s===i.node?i.offset:s.nodeValue?.length||0;p<g&&r.push({node:s,start:p,end:g})}for(let c=r.length-1;c>=0;c--){let{node:d,start:u,end:m}=r[c],p=document.createRange();p.setStart(d,u),p.setEnd(d,m);let g=document.createElement("span");ni(g,e),p.surroundContents(g)}}catch{}}}function ka(){let e=T();e.reader&&e.reader.querySelectorAll(".annotation-mark").forEach(t=>{let n=t.getAttribute("data-annotation-id"),o=f.annotations.find(i=>i.id===n);o&&(t.classList.toggle("is-active",!!n&&n===f.activeAnnotationId),t.addEventListener("click",i=>{if(i.stopPropagation(),f.pinnedAnnotationId===n){f.pinnedAnnotationId=null,ie(!0);return}f.activeAnnotationId=n,f.pinnedAnnotationId=n;let r=t.getBoundingClientRect();nt(o,r.right+8,r.top+8);let a=j();\$(a||null)}))})}function xa(){let e=T();if(!e.reader)return;let t=Array.from(e.reader.querySelectorAll(".annotation-mark"));for(let n of t){let o=n.parentNode;for(;n.firstChild;)o?.insertBefore(n.firstChild,n);o?.removeChild(n)}}function N(){let e=T();xa();let t=e.reader?Do(Oo(e.reader)):void 0;if(e.reader){let o=t?t.nodes.map(a=>a.nodeValue||"").join(""):di(e.reader),i=!1,r=[];for(let a of f.annotations){let s=Go(o,a),c=!1,d=s.status;a.start!==s.start&&(a.start=s.start,i=!0,c=!0),a.length!==s.length&&(a.length=s.length,i=!0,c=!0);let u=pa(a.status,d);(a.status||"anchored")!==u&&(a.status=u,i=!0,c=!0),a.confidence!==s.confidence&&(a.confidence=s.confidence,i=!0,c=!0),c&&r.push({...a,thread:a.thread?[...a.thread]:a.thread})}if(i){let a=j();a&&li(a,r,"\\u540C\\u6B65\\u8BC4\\u8BBA\\u951A\\u70B9\\u5931\\u8D25")}}let n=[...Nt()].sort((o,i)=>i.start-o.start);for(let o of n)va(o,t);ka()}function Ea(e,t){let n=e.querySelector(".annotation-canvas");if(!n)return;let o=Array.from(n.querySelectorAll(".annotation-item.positioned"));if(o.length===0)return;let i=o.map(u=>u.offsetHeight),r=6,a=0,s=[];for(let u=0;u<o.length;u++){let m=Number(o[u].getAttribute("data-anchor-top")||"0"),p=Number.isFinite(m)?Math.max(0,m):0,g=Math.max(p,a>0?a+r:p);s.push(g),a=g+i[u]}for(let u=0;u<o.length;u++)o[u].style.top=\`\${Math.round(s[u])}px\`;let c=Math.max(0,t),d=Math.ceil(a+24);n.style.height=\`\${Math.max(c,d)}px\`}function \$(e){let t=T();if(!t.annotationList)return;sa(),aa();let n=new Map;if(t.annotationList.querySelectorAll("[data-reply-input]").forEach(r=>{let a=r.getAttribute("data-reply-input");a&&r.value.trim()&&n.set(a,r.value)}),!e||f.annotations.length===0){t.annotationList.innerHTML='<div class="annotation-empty">\\u65E0\\u8BC4\\u8BBA\\uFF08\\u9009\\u4E2D\\u6587\\u672C\\u5373\\u53EF\\u6DFB\\u52A0\\uFF09</div>';return}let o=Nt();if(o.length===0){t.annotationList.innerHTML='<div class="annotation-empty">\\u5F53\\u524D\\u7B5B\\u9009\\u4E0B\\u65E0\\u8BC4\\u8BBA</div>';return}let i=(r,a,s=!1,c=0)=>\`
    <div class="annotation-item \${f.activeAnnotationId===r.id?"is-active":""} status-\${Fn(r)}\${ne(r)?" is-resolved":""}\${s?" positioned":""}" data-annotation-id="\${r.id}"\${s?\` data-anchor-top="\${Math.max(0,Math.round(c))}" style="top:\${Math.max(0,Math.round(c))}px"\`:""}>
      <div class="annotation-row-top">
        <div class="annotation-row-title">#\${r.serial||a+1} | \${w(r.quote.substring(0,28))}\${r.quote.length>28?"...":""}</div>
  ...
  \`;if(f.density==="default"){let r=o.map(u=>wa(u.id)),a=0,s=o.map((u,m)=>{let p=r[m]??m*88;return a=Math.max(a,p),i(u,m,!0,p)}).join(""),c=document.getElementById("content"),d=Math.max(c?.scrollHeight||0,a+180);t.annotationList.classList.add("default-mode"),t.annotationList.innerHTML=\`<div class="annotation-canvas" style="height:\${d}px">\${s}</div>\`,Ea(t.annotationList,c?.scrollHeight||0),In()}else t.annotationList.classList.remove("default-mode"),t.annotationList.innerHTML=o.map((r,a)=>i(r,a)).join("");t.annotationList.querySelectorAll(".annotation-icon-action").forEach(r=>{r.addEventListener("click",a=>{a.stopPropagation();let s=a.currentTarget,c=s.getAttribute("data-action"),d=s.getAttribute("data-id");!d||!e||(c==="prev"?It(d,-1,e):c==="next"?It(d,1,e):c==="resolve"?ki(d,e):c==="delete"&&wi(d,e))})}),t.annotationList.querySelectorAll("[data-edit-thread-item]").forEach(r=>{r.addEventListener("click",a=>{a.stopPropagation();let s=r.getAttribute("data-edit-thread-item"),c=r.getAttribute("data-annotation-id");!s||!c||!e||Ct(c,s,e)})}),t.annotationList.querySelectorAll("[data-reply-entry]").forEach(r=>{r.addEventListener("click",a=>{a.stopPropagation();let s=r.getAttribute("data-reply-entry");if(!s)return;let c=t.annotationList?.querySelector(\`[data-reply-input="\${s}"]\`);c&&(ve(c),c.focus())}),r.addEventListener("keydown",a=>{if(a.target instanceof HTMLTextAreaElement||a.key!=="Enter"&&a.key!==" ")return;a.preventDefault(),a.stopPropagation();let c=r.getAttribute("data-reply-entry");if(!c)return;let d=t.annotationList?.querySelector(\`[data-reply-input="\${c}"]\`);d&&(ve(d),d.focus())})}),n.size>0&&t.annotationList.querySelectorAll("[data-reply-input]").forEach(r=>{let a=r.getAttribute("data-reply-input");a&&n.has(a)&&(r.value=n.get(a))}),requestAnimationFrame(()=>{t.annotationList?.querySelectorAll("[data-reply-input]").forEach(r=>{ve(r)})}),t.annotationList.querySelectorAll("[data-reply-input]").forEach(r=>{let a=r;a.addEventListener("input",()=>ve(a)),a.addEventListener("click",s=>s.stopPropagation()),r.addEventListener("keydown",s=>{if(\$t(s,s.currentTarget)){s.preventDefault();return}if(s.key!=="Enter"||!(s.metaKey||s.ctrlKey))return;s.preventDefault();let c=s.currentTarget,d=c.getAttribute("data-reply-input");!d||!e||(yi(d,e,c.value),c.value="",\$(e))})}),t.annotationList.querySelectorAll(".annotation-item").forEach(r=>{r.addEventListener("click",()=>{let a=r.getAttribute("data-annotation-id");!a||!e||vi(a,e)})})}function xi(e){let t=T(),n=t.content?.getAttribute("data-current-file");if(!e||!n||e!==n||!t.reader)return;let o=window.getSelection();if(!o||o.rangeCount===0||o.isCollapsed)return;let i=o.getRangeAt(0);if(!t.reader.contains(i.commonAncestorContainer))return;let r=o.toString().trim();if(!r)return;let a=Xo(t.reader,i.startContainer,i.startOffset),s=Xo(t.reader,i.endContainer,i.endOffset);if(a<0||s<=a)return;let c=di(t.reader),d=32,u=32,m=c.slice(Math.max(0,a-d),a),p=c.slice(s,Math.min(c.length,s+u)),g=i.getBoundingClientRect();ma(g.right+6,g.top-8,{id:\`ann-\${Date.now()}-\${Math.random().toString(16).slice(2,8)}\`,start:a,length:s-a,quote:r,quotePrefix:m,quoteSuffix:p,status:"anchored",confidence:1})}function Ei(){da(),Ne(!0),document.getElementById("composerSaveBtn")?.addEventListener("click",()=>{let e=j();e&&ti(e)}),document.getElementById("composerCancelBtn")?.addEventListener("click",tt),T().composerNote?.addEventListener("keydown",e=>{if(\$t(e,e.currentTarget)){e.preventDefault();return}if(e.key!=="Enter"||!(e.metaKey||e.ctrlKey))return;e.preventDefault();let t=j();t&&ti(t)}),T().composerNote?.addEventListener("input",e=>{let t=e.currentTarget;bi(t)}),T().quickAdd?.addEventListener("click",e=>{e.stopPropagation(),fa()}),document.getElementById("popoverCloseBtn")?.addEventListener("click",()=>{f.pinnedAnnotationId=null,ie(!0)}),document.getElementById("popoverDeleteBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&wi(t,e)}),document.getElementById("popoverResolveBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&ki(t,e)}),document.getElementById("popoverPrevBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&It(t,-1,e)}),document.getElementById("popoverNextBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&It(t,1,e)}),document.getElementById("annotationPopover")?.addEventListener("click",e=>{let t=e.target,n=j();if(!n)return;let o=t.closest("[data-edit-thread-item]");if(o){e.stopPropagation();let a=o.getAttribute("data-edit-thread-item"),s=o.getAttribute("data-annotation-id");a&&s&&Ct(s,a,n);return}let i=t.closest("[data-popover-reply-entry]");if(i){e.stopPropagation();let a=i.getAttribute("data-popover-reply-entry");if(!a)return;let s=document.querySelector(\`[data-popover-reply-input="\${a}"]\`);if(!s)return;ve(s),s.focus();return}t.closest("[data-popover-reply-input]")&&e.stopPropagation()}),document.getElementById("annotationPopover")?.addEventListener("keydown",e=>{let t=e.target;if(t instanceof HTMLTextAreaElement)return;let n=t.closest("[data-popover-reply-entry]");if(!n||e.key!=="Enter"&&e.key!==" ")return;e.preventDefault(),e.stopPropagation();let o=n.getAttribute("data-popover-reply-entry");if(!o)return;let i=document.querySelector(\`[data-popover-reply-input="\${o}"]\`);i&&(ve(i),i.focus())}),document.getElementById("annotationPopover")?.addEventListener("keydown",e=>{let t=e.target;if(!(t instanceof HTMLTextAreaElement))return;if(\$t(e,t)){e.preventDefault();return}if(e.key!=="Enter"||!(e.metaKey||e.ctrlKey))return;let n=t.getAttribute("data-popover-reply-input"),o=j();if(!n||!o)return;e.preventDefault(),yi(n,o,t.value),t.value="";let i=f.annotations.find(s=>s.id===n),a=document.querySelector(\`[data-annotation-id="\${n}"]\`)?.getBoundingClientRect();i&&nt(i,a?a.right+8:120,a?a.top+8:120),\$(o)}),document.getElementById("annotationPopover")?.addEventListener("input",e=>{let t=e.target;t instanceof HTMLTextAreaElement&&t.hasAttribute("data-popover-reply-input")&&ve(t)}),T().filterMenu?.querySelectorAll(".annotation-filter-item[data-filter]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-filter");if(!t)return;f.filter=t,T().filterMenu?.classList.add("hidden");let n=j();N(),\$(n||null)})}),T().filterToggle?.addEventListener("click",e=>{e.stopPropagation();let t=T().filterMenu;t&&t.classList.toggle("hidden")}),T().densityToggle?.addEventListener("click",()=>{f.density=f.density==="default"?"simple":"default",localStorage.setItem("md-viewer:annotation-density",f.density);let e=j();\$(e||null)}),T().closeToggle?.addEventListener("click",()=>{Zo()}),T().floatingOpenBtn?.addEventListener("click",()=>{Yo()}),T().sidebarResizer?.addEventListener("mousedown",e=>{if(T().sidebar?.classList.contains("collapsed"))return;e.preventDefault();let t=document.documentElement,n=Number(getComputedStyle(t).getPropertyValue("--annotation-sidebar-width").replace("px",""))||ii,o=e.clientX;document.body.classList.add("annotation-sidebar-resizing");let i=a=>{let s=o-a.clientX;fi(n+s),oe()},r=()=>{document.body.classList.remove("annotation-sidebar-resizing"),window.removeEventListener("mousemove",i),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",i),window.addEventListener("mouseup",r)}),document.getElementById("content")?.addEventListener("scroll",()=>{Be(!1),In(),ei()}),window.addEventListener("resize",()=>{oe(),ei()}),window.openAnnotationSidebar=Yo,window.closeAnnotationSidebar=Zo,window.toggleAnnotationSidebar=ua,document.addEventListener("mousedown",e=>{let t=e.target,n=T();if(t.closest(".annotation-mark-temp")){ha();return}n.composer&&!n.composer.classList.contains("hidden")&&!n.composer.contains(t)&&!(n.quickAdd&&n.quickAdd.contains(t))&&ga(),n.popover&&!n.popover.contains(t)&&!t.closest(".annotation-mark")&&(f.pinnedAnnotationId=null,ie(!0)),n.filterMenu&&!n.filterMenu.classList.contains("hidden")&&!n.filterMenu.contains(t)&&!t.closest("#annotationFilterToggle")&&n.filterMenu.classList.add("hidden"),n.quickAdd&&!n.quickAdd.classList.contains("hidden")&&!n.quickAdd.contains(t)&&!t.closest("#annotationComposer")&&Be(!0)}),T().composerHeader?.addEventListener("mousedown",e=>{if(e.target.closest(".annotation-row-actions"))return;let t=T().composer;if(!t)return;let n=t.getBoundingClientRect(),o=e.clientX,i=e.clientY,r=n.left,a=n.top;e.preventDefault();let s=d=>{let u=r+(d.clientX-o),m=a+(d.clientY-i);Ln(t,u,m)},c=()=>{window.removeEventListener("mousemove",s),window.removeEventListener("mouseup",c)};window.addEventListener("mousemove",s),window.addEventListener("mouseup",c)})}var oi,ii,Xr,Yr,f,ri,Nn=b(()=>{"use strict";qo();fe();Vo();Ae();Qo();oi="md-viewer:annotation-sidebar-width",ii=320,Xr=260,Yr=540;f={annotations:[],pendingAnnotation:null,pendingAnnotationFilePath:null,pinnedAnnotationId:null,activeAnnotationId:null,currentFilePath:null,filter:"open",density:Zr()},ri="md-viewer:annotation-panel-open-by-file"});var F={};de(F,{renderCurrentPath:()=>Wn,renderFiles:()=>jn,renderSearchBox:()=>\$i,renderSidebar:()=>A,renderTabs:()=>re,setSidebarTab:()=>Fi});function Li(e){l.currentFile&&(Ti||requestAnimationFrame(()=>{let t=e.querySelector(".file-item.current, .tree-item.current");if(!t)return;let n=t.offsetTop-e.clientHeight*.4,o=Math.max(0,e.scrollHeight-e.clientHeight),i=Math.max(0,Math.min(n,o));e.scrollTo({top:i,behavior:"auto"}),Ti=!0}))}function Fi(e){l.config.sidebarTab=e,H(l.config),A()}function Ta(e){if(!e)return;let t=He.indexOf(e);t>=0&&He.splice(t,1),He.unshift(e),He.length>300&&(He.length=300)}function Ai(e){let t=He.indexOf(e);return t>=0?t:Number.MAX_SAFE_INTEGER}function Ma(){D=!D,re()}function Sa(){D&&(D=!1,re())}function Aa(e){Wt=(e||"").trimStart(),D||(D=!0),re()}function La(e){ot=e==="name"?"name":"recent",re()}function Fa(){Mi||(Mi=!0,document.addEventListener("click",e=>{!D||e.target?.closest(".tab-manager-wrap")||Sa()}))}function \$a(){if(Si)return;Si=!0;let e=document.getElementById("tabs");e&&e.addEventListener("scroll",t=>{let n=t.target;n.classList.contains("tabs-scroll")?Pt=n.scrollLeft:n.classList.contains("tab-manager-list")&&(jt=n.scrollTop)},{passive:!0,capture:!0})}function Ca(e){let t=kt(l.sessionFiles),n=Te(e,t,l.currentFile,i=>{let r=t.find(s=>s.path===i);if(!r)return!1;let a=z(r,W(r.path));return a.type==="normal"||a.type==="new"}),o=window.removeFile;if(!o||n.length===0){re();return}n.forEach(i=>o(i))}function Hn(){if(l.config.sidebarTab==="focus"||l.config.sidebarTab==="full"){A();return}jn()}function Ia(e){let t=e.trim();return t?!!(/^https?:\\/\\//i.test(t)||t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||t.includes("/")||t.includes("\\\\")||/\\.[a-zA-Z0-9]{1,10}\$/.test(t)):!1}function \$i(){let e=document.getElementById("searchBox");if(!e)return;let t=e.querySelector("#searchInput"),n=e.querySelector("#searchClear"),o=l.config.sidebarTab,i=o==="list"?"\\u641C\\u7D22\\u5DF2\\u6253\\u5F00\\u7684\\u6587\\u4EF6":o==="focus"?"\\u641C\\u7D22\\u7126\\u70B9\\u6587\\u4EF6":"\\u641C\\u7D22\\u6216\\u8F93\\u5165\\u8DEF\\u5F84\\uFF08Enter\\u8865\\u5168\\uFF0CCmd/Ctrl+Enter\\u6DFB\\u52A0\\uFF09";if(!t||!n){if(e.innerHTML=\`
  ...
  \`}function jn(){let e=document.getElementById("fileList");if(!e)return;if(l.sessionFiles.size===0){e.innerHTML='<div class="empty-tip">\\u70B9\\u51FB\\u4E0A\\u65B9\\u6DFB\\u52A0 Markdown/HTML \\u6587\\u4EF6</div>';return}let t=ln();if(t.length===0){e.innerHTML='<div class="empty-tip">\\u672A\\u627E\\u5230\\u5339\\u914D\\u7684\\u6587\\u4EF6</div>';return}let n=new Map(t.map(i=>[i.path,i])),o=kt(n);e.innerHTML=o.map(i=>{let r=i.path===l.currentFile,a=i.isMissing||!1,s=ge(i.path),c=["file-item",r?"current":"",a?"deleted":""].filter(Boolean).join(" "),d=i.displayName||i.name,u=l.searchQuery.toLowerCase().trim();if(u){let g=d.toLowerCase().indexOf(u);if(g!==-1){let y=d.substring(0,g),h=d.substring(g,g+u.length),k=d.substring(g+u.length);d=\`\${y}<mark class="search-highlight">\${h}</mark>\${k}\`}}let m=z(i,W(i.path)),p="&nbsp;";return m.badge==="dot"?p='<span class="new-dot"></span>':m.badge&&(p=\`<span class="status-badge status-\${m.type}" style="color: \${m.color}">\${m.badge}</span>\`),\`
      <div class="\${c}"
    ...
    \`}).join(""),Li(e)}function A(){let e=l.config.sidebarTab,t=document.querySelector(".sidebar");if(t&&t.classList.toggle("workspace-mode",e==="focus"||e==="full"),\$i(),Na(),e==="list"){Wn(),jn(),re();return}if(Wn(),!t)return;let n=document.getElementById("fileList");n||(n=document.createElement("div"),n.id="fileList",n.className="file-list",t.appendChild(n)),n.innerHTML=No(),Ho(),Li(n),re()}function re(){let e=Array.from(l.sessionFiles.values()),t=document.getElementById("tabs");if(!t)return;Fa(),\$a();let n=t.querySelector(".tab-manager-list");n&&(jt=n.scrollTop);let o=t.querySelector(".tabs-scroll");if(o&&(Pt=o.scrollLeft),e.length===0){t.innerHTML="",t.style.display="none",D=!1,Bn="";return}let i=kt(l.sessionFiles),r=i.map(p=>{let g=z(p,W(p.path));return[p.path,p.displayName||p.name,p.isMissing?"1":"0",p.path===l.currentFile?"1":"0",g.type,g.badge||""].join("|")}).join("||"),a=[l.currentFile||"",D?"1":"0",ot,Wt,r].join("###");if(a===Bn)return;Bn=a,Ta(l.currentFile),t.style.display="flex";let s=i.map(p=>{let g=p.path===l.currentFile,y=p.isMissing||!1,h=["tab"];return g&&h.push("active"),y&&h.push("deleted"),\`
        <div class="\${h.join(" ")}"
  ...
  \`,requestAnimationFrame(()=>{let p=t.querySelector(".tab-manager-list");p&&jt>0&&(p.scrollTop=jt);let g=t.querySelector(".tabs-scroll");g&&Pt>0&&(g.scrollLeft=Pt),oe()})}var Bt,Ht,Ti,D,Wt,ot,Mi,jt,Pt,Si,Bn,He,L=b(()=>{"use strict";I();X();xe();fe();ko();wt();Je();xo();Wo();Nn();vn();Bt=0,Ht="",Ti=!1,D=!1,Wt="",ot="recent",Mi=!1,jt=0,Pt=0,Si=!1,Bn="",He=[];typeof window<"u"&&(window.setSidebarTab=Fi,window.toggleTabManager=Ma,window.setTabManagerQuery=Aa,window.setTabManagerSort=La,window.applyTabBatchAction=Ca)});function Ii(e){let t=e.replace(/[.+^\${}()|[\\]\\\\]/g,"\\\\\$&");return t=t.replace(/\\*\\*/g,"\\xA7GLOBSTAR\\xA7"),t=t.replace(/\\*/g,"[^/]*"),t=t.replace(/\\?/g,"[^/]"),t=t.replace(/§GLOBSTAR§\\//g,"(?:.+/)?"),t=t.replace(/§GLOBSTAR§/g,".*"),e.endsWith("/")?new RegExp(\`(^|/)\${t}\`):new RegExp(\`(^|/)\${t}(/|\$)\`)}function Ni(e){if(e.type==="file")return[e];let t=[];for(let n of e.children||[])t.push(...Ni(n));return t}function Ba(e,t,n,o){if(!t)return[];let i=Date.now()-n,r=Ie(t,e);return Ni(t).filter(s=>r.has(s.path)?!1:!!(o.has(s.path)||typeof s.lastModified=="number"&&s.lastModified>=i)).sort((s,c)=>{let d=o.has(s.path),u=o.has(c.path);return d!==u?d?-1:1:(c.lastModified||0)-(s.lastModified||0)})}function Ha(e){let t=Date.now()-e,n=Math.floor(t/6e4);if(n<60)return\`\${n}m\`;let o=Math.floor(t/36e5);return o<24?\`\${o}h\`:\`\${Math.floor(t/864e5)}d\`}function Wa(e,t){if(!t)return w(e);let n=e.toLowerCase().indexOf(t.toLowerCase());return n===-1?w(e):w(e.slice(0,n))+\`<mark class="search-highlight">\${w(e.slice(n,n+t.length))}</mark>\`+w(e.slice(n+t.length))}function ja(e,t,n){let o=l.currentFile===e.path,i=t.has(e.path),r=l.sessionFiles.get(e.path),a="normal";r?a=z(r,W(e.path)).type:_e(e.path)?a="modified":W(e.path)&&(a="new");let s=ge(e.path),c=Ue(e.name)||e.name,d=e.lastModified?Ha(e.lastModified):"",u=a==="modified"?'<span class="focus-file-dot modified"></span>':a==="new"?'<span class="focus-file-dot new-file"></span>':"",m=i?\`<button class="tree-pin-btn active" title="\\u53D6\\u6D88\\u56FA\\u5B9A" onclick="event.stopPropagation();handleUnpinFile('\${v(e.path)}')" data-path="\${v(e.path)}">\\u{1F4CC}</button>\`:\`<button class="tree-pin-btn" title="\\u56FA\\u5B9A\\u5230\\u7126\\u70B9\\u89C6\\u56FE" onclick="event.stopPropagation();handlePinFile('\${v(e.path)}')">\\u{1F4CC}</button>\`;return\`
    <div class="tree-item file-node focus-file-item\${o?" current":""}"
      ...
      <span class="file-type-icon \${s.cls}">\${w(s.label)}</span>
      <span class="tree-name"><span class="tree-name-full">\${Wa(c,n)}</span></span>
      \${u}
      \${d?\`<span class="focus-file-time">\${w(d)}</span>\`:""}
      \${m}
    </div>
  \`}function Pa(){let e=l.config.focusWindowKey||"8h";return\`
  ...
  \`}function Da(e,t,n,o,i){let r=t.length>0,a=o?'<span class="focus-ws-badge empty">\\u2026</span>':r?\`<span class="focus-ws-badge">\${t.length}</span>\`:'<span class="focus-ws-badge empty">0</span>',s=r?t.map(c=>ja(c,n,i)).join(""):"";return\`
...
\`});function tr(e){return _n.find(t=>t.key===e)?.css??qn}function nr(e){return Kn.find(t=>t.key===e)?.css??zn}var _n,Kn,Jn=b(()=>{"use strict";Ki();Ui();Gi();Qi();Yi();er();_n=[{key:"github",label:"GitHub",css:qn},{key:"notion",label:"Notion",css:Ji},{key:"bear",label:"Bear / iA Writer",css:Vi}],Kn=[{key:"github",label:"GitHub Light",css:zn},{key:"github-dark",label:"GitHub Dark",css:Xi},{key:"atom-one-dark",label:"Atom One Dark",css:Zi}]});function ir(){qt=l.config.markdownTheme||"github",Un=l.config.codeTheme||"github",Vn=l.config.mathInline!==!1,document.getElementById("settingsDialogOverlay")||Va(),Ga();let t=document.getElementById("settingsDialogOverlay");t&&t.classList.add("show")}function Va(){let e=document.createElement("div");e.id="settingsDialogOverlay",e.className="sync-dialog-overlay",e.innerHTML=\`
  ...
  \`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&rt()})}function Ga(){let e=document.getElementById("settingsDialogBody");if(!e)return;let t=Xa();e.innerHTML=\`
    ...
    <div class="settings-section">
      ...
      <div class="settings-key-list">
        \${t.mdvKeys.map(a=>\`<span class="settings-key-chip">\${or(a)}</span>\`).join("")}
      </div>
    </div>
    <div class="settings-section">
  ...
  \`,document.getElementById("clearClientStateBtn")?.addEventListener("click",()=>{Ya()}),document.getElementById("clearAllCommentsBtn")?.addEventListener("click",()=>{Za()});let i=document.getElementById("markdownThemeSelect"),r=document.getElementById("codeThemeSelect");i?.addEventListener("change",()=>{l.config.markdownTheme=i.value,window.applyTheme?.()}),r?.addEventListener("change",()=>{l.config.codeTheme=r.value,window.applyTheme?.()})}function rt(){qt&&(l.config.markdownTheme=qt,l.config.codeTheme=Un,l.config.mathInline=Vn,window.applyTheme?.());let e=document.getElementById("settingsDialogOverlay");e&&e.classList.remove("show")}function Qa(){let e=document.getElementById("markdownThemeSelect"),t=document.getElementById("codeThemeSelect"),n=document.getElementById("mathInlineCheckbox");e&&(l.config.markdownTheme=e.value),t&&(l.config.codeTheme=t.value),n&&(l.config.mathInline=n.checked),H(l.config),A(),qt="",Un="",Vn=!0,rt()}function Xa(){let e=[];for(let o=0;o<localStorage.length;o+=1){let i=localStorage.key(o);i&&e.push(i)}e.sort();let t=e.filter(o=>o.startsWith("md-viewer:")),n=t.filter(o=>o==="md-viewer:annotation-panel-open-by-file"||o==="md-viewer:annotation-density"||o==="md-viewer:annotation-sidebar-width"||o.startsWith("md-viewer:annotations:")).length;return{currentFile:l.currentFile,openFilesCount:l.sessionFiles.size,workspaceCount:l.config.workspaces.length,commentStateKeyCount:n,mdvKeyCount:t.length,localStorageKeyCount:e.length,mdvKeys:t}}function Ya(){let e=[];for(let t=0;t<localStorage.length;t+=1){let n=localStorage.key(t);n&&n.startsWith("md-viewer:")&&e.push(n)}for(let t of e)localStorage.removeItem(t);_(\`\\u5DF2\\u6E05\\u7406\\u5BA2\\u6237\\u7AEF\\u72B6\\u6001\\uFF08\${e.length} \\u9879\\uFF09\`,1800),window.setTimeout(()=>window.location.reload(),250)}async function Za(){try{let e=await fetch("/api/annotations/clear",{method:"POST"}),t=await e.json();if(!e.ok||t?.success!==!0)throw new Error(t?.error||\`HTTP \${e.status}\`);let n=[];for(let o=0;o<localStorage.length;o+=1){let i=localStorage.key(o);i&&(i.startsWith("md-viewer:annotations:")&&n.push(i),i==="md-viewer:annotation-panel-open-by-file"&&n.push(i),i==="md-viewer:annotation-density"&&n.push(i),i==="md-viewer:annotation-sidebar-width"&&n.push(i))}for(let o of n)localStorage.removeItem(o);_(\`\\u5DF2\\u6E05\\u7A7A\\u8BC4\\u8BBA\\u72B6\\u6001\\uFF08\\u670D\\u52A1\\u7AEF \${t?.deleted||0} \\u6761\\uFF0C\\u672C\\u5730 \${n.length} \\u9879\\uFF09\`,1800),window.setTimeout(()=>window.location.reload(),250)}catch(e){S(\`\\u6E05\\u7A7A\\u8BC4\\u8BBA\\u72B6\\u6001\\u5931\\u8D25: \${e?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`,2600)}}function or(e){return String(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var qt,Un,Vn,rr=b(()=>{"use strict";I();xe();L();Ae();Jn();qt="",Un="",Vn=!0;typeof window<"u"&&(window.closeSettingsDialog=rt,window.saveSettings=Qa)});function es(e,t=60){let n=JSON.stringify(e);return n.length<=t?w(n):w(n.slice(0,t))+"\\u2026"}function Gn(e,t,n,o){let i=e!==null&&typeof e=="object",r=n<1;if(!i){let E=t!==null?\`<span class="json-key">\${Pe(w(JSON.stringify(t)),o)}</span><span class="json-colon">:</span>\`:"",x=ts(e,o);return\`
      ...
      </li>\`}let a=Array.isArray(e),s=a?e.map((E,x)=>({k:String(x),v:E})):Object.entries(e).map(([E,x])=>({k:E,v:x})),c=s.length,d=a?"[":"{",u=a?"]":"}",m=!r,p=m?"\\u25B6":"\\u25BC",g=m?"json-children collapsed":"json-children",y=t!==null?\`<span class="json-key">\${Pe(w(JSON.stringify(t)),o)}</span><span class="json-colon">:</span>\`:"",h=m?\`<span class="json-preview">\${es(e)}</span>\`:"",k=s.map(({k:E,v:x})=>Gn(x,a?null:E,n+1,o)).join("");return\`
    <li>
    ...
    </li>\`}function ts(e,t){return e===null?\`<span class="json-null">\${Pe("null",t)}</span>\`:typeof e=="boolean"?\`<span class="json-boolean">\${Pe(String(e),t)}</span>\`:typeof e=="number"?\`<span class="json-number">\${Pe(String(e),t)}</span>\`:\`<span class="json-string">\${Pe(w(JSON.stringify(e)),t)}</span>\`}function Pe(e,t){if(!t)return e;let n=t.toLowerCase(),o=e.toLowerCase(),i="",r=0;for(;r<e.length;){let a=o.indexOf(n,r);if(a===-1){i+=e.slice(r);break}i+=e.slice(r,a),i+=\`<mark class="json-match">\${e.slice(a,a+n.length)}</mark>\`,r=a+n.length}return i}function ns(e,t){if(!t)return!1;let n=t.toLowerCase(),o=!1;function i(a){let s=a.querySelector(":scope > .json-node"),c=a.querySelector(":scope > .json-children");if(!c)return(s?.textContent?.toLowerCase()||"").includes(n);let d=Array.from(c.querySelectorAll(":scope > li")),u=!1;for(let m of d)i(m)&&(u=!0);if(u){if(o=!0,s){s.setAttribute("data-expanded","true");let m=s.querySelector(".json-toggle");m&&(m.textContent="\\u25BC");let p=s.querySelector(".json-close-bracket");p&&(p.style.display="inline");let g=s.querySelector(".json-preview");g&&(g.style.display="none")}c.classList.remove("collapsed")}return u}let r=Array.from(e.querySelectorAll(":scope > ul > li"));for(let a of r)i(a);return o}function os(e){e.addEventListener("click",t=>{let o=t.target.closest(".json-node-expandable");if(!o)return;let r=o.parentElement.querySelector(":scope > .json-children");if(!r)return;let a=o.getAttribute("data-expanded")==="true",s=o.querySelector(".json-toggle"),c=o.querySelector(".json-close-bracket"),d=o.querySelector(".json-preview");if(a)if(o.setAttribute("data-expanded","false"),s&&(s.textContent="\\u25B6"),r.classList.add("collapsed"),c&&(c.style.display="none"),d)d.style.display="";else{let u=document.createElement("span");u.className="json-preview",u.textContent="\\u2026",o.appendChild(u)}else o.setAttribute("data-expanded","true"),s&&(s.textContent="\\u25BC"),r.classList.remove("collapsed"),c&&(c.style.display="inline"),d&&(d.style.display="none")})}function ar(e,t,n,o=""){if(Ke(n)?rs(e,t,o):is(e,t,o),os(e),o&&!ns(e,o)){let a=document.createElement("div");a.className="json-no-results",a.textContent="\\u65E0\\u5339\\u914D\\u7ED3\\u679C",e.appendChild(a)}}function is(e,t,n){let o;try{o=JSON.parse(t)}catch(r){e.innerHTML=\`
      <div class="json-viewer">
        <div class="json-error">
          JSON \\u89E3\\u6790\\u5931\\u8D25\\uFF1A\${w(String(r))}
          <pre>\${w(t.slice(0,500))}</pre>
        </div>
      </div>\`;return}let i=document.createElement("div");i.className="json-viewer",i.innerHTML=\`<ul>\${Gn(o,null,0,n)}</ul>\`,e.appendChild(i)}function rs(e,t,n){let o=t.split(\`
\`),i=document.createElement("div");i.className="json-viewer";let r=0;for(let a of o){let s=a.trim();if(!s)continue;r++;let c=document.createElement("div");c.className="json-line-header",c.textContent=\`Line \${r}\`,i.appendChild(c);let d;try{d=JSON.parse(s)}catch(m){let p=document.createElement("div");p.className="json-error",p.innerHTML=\`\\u89E3\\u6790\\u5931\\u8D25\\uFF1A\${w(String(m))}<pre>\${w(s.slice(0,200))}</pre>\`,i.appendChild(p);continue}let u=document.createElement("ul");u.innerHTML=Gn(d,null,0,n),i.appendChild(u)}e.appendChild(i)}var sr=b(()=>{"use strict";fe();Je()});var ye={};de(ye,{renderAll:()=>us});function dr(){let e=tr(l.config.markdownTheme||"github"),t=nr(l.config.codeTheme||"github"),n=document.getElementById("theme-md-css"),o=document.getElementById("theme-hl-css");n&&(n.textContent=e),o&&(o.textContent=t)}function ke(e=!1){let t=l.currentFile&&!yr(l.currentFile)?l.currentFile:null,n=ui();(e||t!==n)&&ci(t),N(),\$(t)}async function pr(e,t=!1){let n=l.currentFile,o=t;rn(e,o),o&&(l.config.sidebarTab==="focus"||l.config.sidebarTab==="full")&&await Rn(e.path),o&&e.path,A(),U(),ke(o&&n!==e.path),o&&n!==e.path&&mr()}function mr(){let e=document.getElementById("content");e&&e.scrollTo({top:0,behavior:"auto"})}function ss(){return Math.max(ur,Math.min(as,window.innerWidth-360))}function to(e){return Math.min(ss(),Math.max(ur,Math.round(e)))}function at(e){let t=to(e);document.documentElement.style.setProperty("--sidebar-width",\`\${t}px\`)}function ls(){let e=Number(localStorage.getItem(Zn)),t=Number.isFinite(e)&&e>0?e:eo;at(t)}function cs(){let e=document.getElementById("sidebarResizer");if(!e)return;let t=!1,n=i=>{if(!t)return;let r=to(i.clientX);at(r)},o=i=>{if(!t)return;t=!1;let r=to(i.clientX);at(r),localStorage.setItem(Zn,String(r)),document.body.classList.remove("sidebar-resizing"),window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",o)};e.addEventListener("mousedown",i=>{window.innerWidth<=900||(t=!0,document.body.classList.add("sidebar-resizing"),window.addEventListener("mousemove",n),window.addEventListener("mouseup",o),i.preventDefault())}),e.addEventListener("dblclick",()=>{at(eo),localStorage.setItem(Zn,String(eo))}),window.addEventListener("resize",()=>{let i=Number.parseInt(getComputedStyle(document.documentElement).getPropertyValue("--sidebar-width"),10);Number.isFinite(i)&&at(i)})}async function ds(){l.currentFile&&await hr(l.currentFile,{silent:!0,highlight:!1})}async function fr(e){await hr(e,{silent:!1,highlight:!0})&&l.currentFile===e&&_("\\u6587\\u4EF6\\u5DF2\\u5237\\u65B0",2e3)}function gr(){let e=document.getElementById("content");e&&(e.style.animation="flash 700ms ease-out",setTimeout(()=>{e.style.animation=""},700))}async function hr(e,t={}){let n=l.sessionFiles.get(e);if(!n||n.isMissing)return!1;let o=(Qn.get(e)||0)+1;Qn.set(e,o);let i=await Le(e,t.silent!==!1);if(!i||Qn.get(e)!==o)return!1;let r=l.sessionFiles.get(e)||l.sessionFiles.get(i.path);if(!r)return!1;if(r.content=i.content,r.pendingContent=void 0,i.lastModified>=(r.lastModified||0)&&(r.lastModified=i.lastModified),r.displayedModified=i.lastModified,r.isMissing=!1,q(),l.currentFile===e||l.currentFile===i.path){if(se){se=!1;let a=document.getElementById("diffButton");a&&a.classList.remove("active")}U(),requestAnimationFrame(()=>{ke(!1),t.highlight&&gr()})}return A(),await ae(),!0}function us(){A(),U(),ke(!1)}function ps(e,t){let n=\`\${e}/\${t}\`,o=n.startsWith("/"),i=n.split("/"),r=[];for(let a of i)if(!(!a||a===".")){if(a===".."){r.length>0&&r.pop();continue}r.push(a)}return\`\${o?"/":""}\${r.join("/")}\`}function ms(e,t){let n=e.trim();if(!n||n.startsWith("http://")||n.startsWith("https://")||n.startsWith("data:")||n.startsWith("blob:")||n.startsWith("/api/")||br(t))return null;let o=n.indexOf("?"),i=n.indexOf("#"),r=[o,i].filter(u=>u>=0).sort((u,m)=>u-m)[0]??-1,a=r>=0?n.slice(0,r):n,s=r>=0?n.slice(r):"",c=t.slice(0,t.lastIndexOf("/")),d=a.startsWith("/")?a:ps(c,a);return\`/api/file-asset?path=\${encodeURIComponent(d)}\${s}\`}function fs(e,t){let n=e.querySelector(".markdown-body");n&&n.querySelectorAll("img[src], video[src], source[src]").forEach(o=>{let i=o.getAttribute("src");if(!i)return;let r=ms(i,t);r&&o.setAttribute("src",r)})}function gs(e){let t=window.renderMathInElement;if(!t)return;let n=l.config.mathInline!==!1,o=[{left:"\$\$",right:"\$\$",display:!0},{left:"\\\\[",right:"\\\\]",display:!0},{left:"\\\\(",right:"\\\\)",display:!1},...n?[{left:"\$",right:"\$",display:!1}]:[]];t(e,{delimiters:o,throwOnError:!1,ignoredTags:["script","noscript","style","textarea","pre","code"]})}async function hs(e){let t=window.mermaid;if(!t)return;let n=Array.from(e.querySelectorAll(".markdown-body pre > code.language-mermaid, .markdown-body pre > code.lang-mermaid, .markdown-body pre > code.language-flowchart, .markdown-body pre > code.lang-flowchart"));if(n.length===0)return;lr||(t.initialize({startOnLoad:!1,theme:"neutral",securityLevel:"loose"}),lr=!0);let o=r=>{let a=r.textContent||"\\u590D\\u5236";r.textContent="\\u2713",r.classList.add("copied"),window.setTimeout(()=>{r.textContent=a,r.classList.remove("copied")},900)},i=(r,a)=>{let s=document.createElement("div");s.className="mermaid-source-panel",s.style.display=a?"block":"none";let c=document.createElement("div");c.className="mermaid-source-head";let d=document.createElement("span");d.textContent="Mermaid \\u6E90\\u7801";let u=document.createElement("button");u.className="mermaid-source-copy",u.textContent="\\u590D\\u5236",u.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(r),o(u)}catch{}}),c.appendChild(d),c.appendChild(u);let m=document.createElement("pre"),p=document.createElement("code");p.className="language-mermaid",p.textContent=r,m.appendChild(p),s.appendChild(c),s.appendChild(m);let g=document.createElement("button");return g.className="mermaid-source-toggle",g.textContent=a?"\\u9690\\u85CF\\u6E90\\u7801":"\\u6E90\\u7801",g.addEventListener("click",()=>{let y=s.style.display!=="none";s.style.display=y?"none":"block",g.textContent=y?"\\u6E90\\u7801":"\\u9690\\u85CF\\u6E90\\u7801"}),{panel:s,toggleButton:g}};for(let r=0;r<n.length;r+=1){let a=n[r],s=a.closest("pre");if(!s)continue;let c=(a.textContent||"").trim();if(!c)continue;let d=a.classList.contains("language-flowchart")||a.classList.contains("lang-flowchart"),u=c.split(\`
\`).find(p=>p.trim().length>0)?.trim().toLowerCase()||"",m=d&&!u.startsWith("flowchart")&&!u.startsWith("graph")?\`flowchart TD
\${c}\`:c;if(m)try{let p=\`mdv-mermaid-\${Date.now()}-\${r}\`,{svg:g,bindFunctions:y}=await t.render(p,m),h=document.createElement("div");h.className="mermaid-block";let k=document.createElement("div");k.className="mermaid-actions";let{panel:E,toggleButton:x}=i(m,!1);k.appendChild(x);let M=document.createElement("div");M.className="mermaid",M.setAttribute("data-mdv-mermaid","1"),M.innerHTML=g,h.appendChild(k),h.appendChild(M),h.appendChild(E),s.replaceWith(h),typeof y=="function"&&y(M)}catch(p){let g=document.createElement("div");g.className="mermaid-fallback-block";let y=document.createElement("div");y.className="mermaid-actions";let{panel:h,toggleButton:k}=i(m,!0);y.appendChild(k);let E=document.createElement("div");E.className="mermaid-fallback-notice",E.textContent="Mermaid \\u8BED\\u6CD5\\u9519\\u8BEF\\uFF0C\\u5DF2\\u56DE\\u9000\\u4E3A\\u539F\\u6587\\u663E\\u793A",g.appendChild(y),g.appendChild(E),g.appendChild(h),s.replaceWith(g),console.error("Mermaid \\u6E32\\u67D3\\u5931\\u8D25\\uFF0C\\u5DF2\\u56DE\\u9000\\u539F\\u6587:",p)}}}function U(){let e=document.getElementById("content");if(!e)return;if(!l.currentFile){e.removeAttribute("data-current-file"),e.innerHTML=\`
      <div class="empty-state">
        <h2>\\u6B22\\u8FCE\\u4F7F\\u7528 MD Viewer</h2>
        <p>\\u5728\\u5DE6\\u4FA7\\u6DFB\\u52A0 Markdown/HTML \\u6587\\u4EF6\\u5F00\\u59CB\\u9605\\u8BFB</p>
      </div>
    \`;return}let t=l.sessionFiles.get(l.currentFile);if(!t)return;if(yr(t.path)){e.setAttribute("data-current-file",t.path),e.innerHTML=\`<iframe class="html-preview-frame" srcdoc="\${t.content.replace(/"/g,"&quot;").replace(/'/g,"&#39;")}" sandbox="allow-scripts allow-same-origin allow-forms allow-popups allow-modals"></iframe>\`;let r=document.getElementById("fileMeta");r&&(r.textContent=Ot(t.lastModified)),Yn(),ae();return}if(ws(t.path)){e.setAttribute("data-current-file",t.path),e.innerHTML="";let a=document.getElementById("searchInput")?.value?.trim()??"";ar(e,t.content,t.path,a);let s=document.getElementById("fileMeta");s&&(s.textContent=Ot(t.lastModified)),Yn(),ae();return}let n=window.marked.parse(t.content),o=t.isMissing?\`
      <div class="content-file-status deleted">
        \\u8BE5\\u6587\\u4EF6\\u5DF2\\u4ECE\\u78C1\\u76D8\\u5220\\u9664\\uFF0C\\u5F53\\u524D\\u5185\\u5BB9\\u4E3A\\u672C\\u5730\\u7F13\\u5B58\\u5FEB\\u7167\\u3002
      </div>
    \`:"";e.innerHTML=\`\${o}<div class="markdown-body" id="reader">\${n}</div>\`,e.setAttribute("data-current-file",t.path),fs(e,t.path),hs(e),gs(e),N();let i=document.getElementById("fileMeta");i&&(i.textContent=Ot(t.lastModified)),Yn(),ae()}function Yn(){let e=document.getElementById("breadcrumb");if(!e||!l.currentFile){e&&(e.innerHTML="");return}let t=l.sessionFiles.get(l.currentFile);if(!t)return;let n=t.path.split("/").filter(Boolean),o=n[n.length-1]||"",i=n.map((r,a)=>{let s=a===n.length-1,c="/"+n.slice(0,a+1).join("/");return s?\`<span class="breadcrumb-item active">\${w(r)}</span>\`:\`
  ...
  \`}async function ys(e){if(e.stopPropagation(),!l.currentFile)return;let t=e.target,n=document.querySelector(".nearby-menu");if(n){n.remove();return}try{let o=await hn(l.currentFile);if(!o.files||o.files.length===0){gn("\\u9644\\u8FD1\\u6CA1\\u6709\\u5176\\u4ED6 Markdown \\u6587\\u4EF6",3e3);return}let i=document.createElement("div");i.className="nearby-menu",i.innerHTML=\`
      ...
      \`).join("")}
    \`;let r=t.getBoundingClientRect();i.style.position="fixed",i.style.left=r.left+"px",i.style.top=r.bottom+5+"px",document.body.appendChild(i);let a=()=>{i.remove(),document.removeEventListener("click",a)};setTimeout(()=>document.addEventListener("click",a),0)}catch(o){S("\\u83B7\\u53D6\\u9644\\u8FD1\\u6587\\u4EF6\\u5931\\u8D25: "+o.message)}}function bs(e){let t=e.split("/").filter(Boolean);return t[t.length-1]||"workspace"}function yr(e){let t=e.toLowerCase();return t.endsWith(".html")||t.endsWith(".htm")}function ws(e){let t=e.toLowerCase();return t.endsWith(".json")||t.endsWith(".jsonl")}function br(e){return/^https?:\\/\\//i.test(e)}async function vs(e){if(P(e),A(),br(e)){window.open(e,"_blank","noopener,noreferrer");return}try{let n=await(await fetch("/api/open-local-file",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:e})})).json();n?.error&&S(\`\\u6253\\u5F00 HTML \\u5931\\u8D25: \${n.error}\`)}catch(t){S(\`\\u6253\\u5F00 HTML \\u5931\\u8D25: \${t?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)}}function ks(e){let t=e.trim();return t?!!(/^https?:\\/\\//i.test(t)||t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||t.includes("/")||t.includes("\\\\")||/\\.[a-zA-Z0-9]{1,10}\$/.test(t)):!1}function st(){J=null;let e=document.getElementById("quickActionConfirm"),t=document.getElementById("quickActionConfirmText"),n=document.getElementById("quickActionConfirmActions");e&&(e.style.display="none",e.className="add-file-confirm"),t&&(t.textContent=""),n&&(n.innerHTML=""),document.body.classList.remove("quick-action-confirm-visible")}function wr(){let e=document.getElementById("quickActionConfirm");return!!e&&e.style.display!=="none"}function zt(e,t,n={}){document.getElementById("searchInput")?.dispatchEvent(new Event("path-autocomplete-hide"));let i=document.getElementById("quickActionConfirm"),r=document.getElementById("quickActionConfirmText"),a=document.getElementById("quickActionConfirmActions");if(!(!i||!r||!a)){if(r.textContent=e,a.innerHTML="",i.className=\`add-file-confirm state-\${t}\`,i.style.display="flex",document.body.classList.add("quick-action-confirm-visible"),n.primaryLabel&&n.onPrimary){let s=document.createElement("button");s.className="add-file-confirm-button primary",s.textContent=n.primaryLabel,s.onclick=async()=>{await n.onPrimary(),st()},a.appendChild(s)}if(n.allowCancel!==!1){let s=document.createElement("button");s.className="add-file-confirm-button",s.textContent="\\u53D6\\u6D88",s.onclick=()=>st(),a.appendChild(s)}}}async function cr(){if(!J)return;if(J.kind==="add-other-file"){await Re(J.path,!0);return}let e=Rt(bs(J.path),J.path);A(),_(\`\\u5DF2\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A: \${e.name}\`,2e3),Y(""),A()}async function Re(e,t=!0){if(!e.trim())return;let n=await Le(e);n&&(await pr(n,t),await wn(e,t),Y(""),A())}async function vr(e){let t=e.trim();if(!t)return;let n=await bn(t),o=n.path||t;if(n.kind==="md_file"||n.kind==="html_file"){st(),await Re(o,!0);return}if(n.kind==="other_file"){J={kind:"add-other-file",path:o,ext:n.ext||null},zt(\`\\u68C0\\u6D4B\\u5230\\u975E Markdown \\u6587\\u4EF6\${n.ext?\`: \${n.ext}\`:""}\`,"warning",{primaryLabel:"\\u7EE7\\u7EED\\u6DFB\\u52A0\\u6587\\u4EF6",onPrimary:cr});return}if(n.kind==="directory"){J={kind:"add-workspace",path:o},zt("\\u68C0\\u6D4B\\u5230\\u76EE\\u5F55\\uFF0C\\u662F\\u5426\\u4F5C\\u4E3A\\u5DE5\\u4F5C\\u533A\\u6DFB\\u52A0\\uFF1F","directory",{primaryLabel:"\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A",onPrimary:cr});return}if(n.kind==="not_found"){J=null,zt("\\u8DEF\\u5F84\\u4E0D\\u5B58\\u5728\\uFF0C\\u8BF7\\u68C0\\u67E5\\u540E\\u91CD\\u8BD5","error",{allowCancel:!0});return}J=null,zt(n.error||"\\u65E0\\u6CD5\\u8BC6\\u522B\\u8F93\\u5165\\u8DEF\\u5F84","error",{allowCancel:!0})}async function xs(e){if(se){se=!1;let n=document.getElementById("diffButton");n&&n.classList.remove("active")}let t=l.currentFile;sn(e),A(),U(),ke(!0),t!==e&&mr(),await ae()}function kr(e){an(e),A(),U(),ke(!0)}async function Es(e){let t=document.getElementById("searchInput"),n=(typeof e=="string"?e:t?.value||"").trim();if(n)try{let o=l.config.workspaces.map(r=>r.path).filter(Boolean),i=await Ge(n,{roots:o,limit:50});i.files&&i.files.length>0?await Re(i.files[0].path):gn("\\u6CA1\\u6709\\u627E\\u5230\\u5339\\u914D\\u7684\\u6587\\u4EF6",3e3)}catch(o){S("\\u641C\\u7D22\\u5931\\u8D25: "+o.message)}}function Ts(){document.body.addEventListener("dragover",e=>{e.preventDefault()}),document.body.addEventListener("drop",async e=>{e.preventDefault();let t=Array.from(e.dataTransfer?.files||[]);for(let n of t){let o=n.name.toLowerCase();(o.endsWith(".md")||o.endsWith(".markdown")||o.endsWith(".html")||o.endsWith(".htm"))&&await Re(n.path)}})}function Ms(){document.addEventListener("keydown",e=>{if(e.key==="Escape"){if(gi()){e.preventDefault();return}if(document.getElementById("settingsDialogOverlay")?.classList.contains("show")){e.preventDefault(),rt();return}let n=document.getElementById("addWorkspaceDialogOverlay");if(n?.classList.contains("show")){e.preventDefault(),n.classList.remove("show");return}}if((e.metaKey||e.ctrlKey)&&e.key.toLowerCase()==="k"){let t=document.activeElement?.tagName?.toLowerCase();if(t==="textarea"||t==="input")return;e.preventDefault();let n=document.getElementById("searchInput");n&&(n.focus(),n.select());return}(e.metaKey||e.ctrlKey)&&e.key==="w"&&(e.preventDefault(),l.currentFile&&kr(l.currentFile))})}function Ss(){let e=new URLSearchParams(window.location.search),t=e.get("file"),n=e.get("focus")!=="false";t&&(Re(t,n),window.history.replaceState({},"",window.location.pathname))}async function As(e){let t=l.sessionFiles.get(e);if(!t)return null;if(t.pendingContent!==void 0)return t.pendingContent;let n=await Le(e,!0);return n?(t.pendingContent=n.content,n.content):null}function Ls(e,t){let n=document.getElementById("content");if(!n)return;let o=Oi(e,t);if(!o.some(d=>d.type!=="equal")){n.innerHTML=\`
  ...
  \`}async function Fs(){if(!l.currentFile)return;let e=l.sessionFiles.get(l.currentFile);if(!e)return;if(se){xr();return}let t=await As(l.currentFile);if(t===null)return;se=!0;let n=document.getElementById("diffButton");n&&n.classList.add("active"),Ls(e.content,t)}function xr(){se=!1;let e=document.getElementById("diffButton");e&&e.classList.remove("active"),U()}async function \$s(){if(!l.currentFile)return;let e=l.sessionFiles.get(l.currentFile);!e||e.pendingContent===void 0||(e.content=e.pendingContent,e.pendingContent=void 0,e.displayedModified=e.lastModified,q(),se=!1,U(),ke(!1),gr(),A(),await ae())}async function ae(){let e=document.getElementById("diffButton"),t=document.getElementById("refreshButton");if(!l.currentFile){e&&(e.style.display="none"),t&&(t.style.display="none");return}let n=l.sessionFiles.get(l.currentFile);if(!n)return;if(n.isMissing){e&&(e.style.display="none"),t&&(t.style.display="none");return}let o=n.lastModified>n.displayedModified;e&&(e.style.display=o&&!n.isRemote?"flex":"none"),t&&(t.style.display=o?"flex":"none")}async function Cs(){l.currentFile&&await fr(l.currentFile)}function Is(e){return e?.target?e.target.closest(".copy-filename-button, .sync-dialog-copy-btn, .sync-dialog-btn"):null}function Ns(e,t){if(!e)return;if(e.classList.contains("copy-filename-button")){e.classList.add("success");let o=e.querySelector(".copy-tooltip"),i=o?.textContent;o&&(o.textContent=t||"\\u5DF2\\u590D\\u5236"),setTimeout(()=>{e.classList.remove("success"),o&&i&&(o.textContent=i)},1e3);return}let n=e.textContent;e.textContent="\\u2713 \\u5DF2\\u590D\\u5236",setTimeout(()=>{n!=null&&(e.textContent=n)},1e3)}function no(e,t,n){navigator.clipboard.writeText(e).then(()=>{Ns(Is(t),n)}).catch(()=>{S("\\u590D\\u5236\\u5931\\u8D25")})}function Bs(e,t){no(e,t)}function Er(e,t){if(t instanceof MouseEvent&&t.altKey){no(e,t,"\\u5DF2\\u590D\\u5236\\u7EDD\\u5BF9\\u8DEF\\u5F84");return}let o=l.config.workspaces,i=e;for(let r of o){let a=r.path.replace(/\\/+\$/,"");if(e===a||e.startsWith(a+"/")){i=e.slice(a.length+1);break}}no(i,t,"\\u5DF2\\u590D\\u5236\\u76F8\\u5BF9\\u8DEF\\u5F84")}function Hs(e,t){Er(e,t)}function Ws(){let e=localStorage.getItem("fontScale");e&&(De=parseFloat(e)),Tr()}function Tr(){document.documentElement.style.setProperty("--font-scale",De.toString()),Mr(),localStorage.setItem("fontScale",De.toString())}function Mr(){let e=document.getElementById("fontScaleText");if(e){let o=Math.round(De*100);e.textContent=\`\${o}%\`}let t=document.querySelectorAll(".font-scale-option");t.forEach(o=>{o.classList.remove("active")});let n=Math.round(De*100);t.forEach(o=>{o.textContent?.trim()===\`\${n}%\`&&o.classList.add("active")})}function js(e){De=e,Tr(),oo()}function Ps(){let e=document.getElementById("fontScaleMenu");if(!e)return;e.style.display!=="none"?oo():(e.style.display="block",Mr())}function oo(){let e=document.getElementById("fontScaleMenu");e&&(e.style.display="none")}function Sr(){let e=new EventSource("/api/events");e.addEventListener("file-changed",async t=>{let n=JSON.parse(t.data),o=Ee(n.path);o?(o.lastModified=n.lastModified,o.isMissing&&(o.isMissing=!1,V(n.path)),q()):Yt(n.path),A(),await ae()}),e.addEventListener("file-deleted",async t=>{let n=JSON.parse(t.data),o=Ee(n.path);o?(o.isMissing=!0,q()):pe(n.path),A(),l.currentFile===n.path&&(U(),ae(),S("\\u6587\\u4EF6\\u5DF2\\u4E0D\\u5B58\\u5728"))}),e.addEventListener("file-opened",async t=>{let n=JSON.parse(t.data);await pr(n,n.focus!==!1)}),e.addEventListener("state-request",async t=>{let o=JSON.parse(t.data).requestId;if(!o)return;let i=Array.from(l.sessionFiles.values()).map(r=>({path:r.path,name:r.name}));try{await fetch("/api/session-state",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requestId:o,currentFile:l.currentFile,openFiles:i})})}catch(r){console.error("\\u54CD\\u5E94\\u72B6\\u6001\\u8BF7\\u6C42\\u5931\\u8D25:",r)}}),e.onerror=()=>{console.error("SSE \\u8FDE\\u63A5\\u65AD\\u5F00\\uFF0C\\u5C1D\\u8BD5\\u91CD\\u8FDE..."),e.close(),setTimeout(Sr,3e3)}}function Ds(){window.setInterval(async()=>{if(Xn||l.config.sidebarTab==="list")return;let e=l.config.sidebarTab==="focus"?l.config.workspaces:l.config.workspaces.filter(t=>t.isExpanded);if(e.length!==0){Xn=!0;try{for(let t of e)await K(t.id);A()}finally{Xn=!1}}},1500)}function Rs(){let e=document.createElement("div");e.id="findBar",e.innerHTML=\`
  ...
  \`,document.body.appendChild(e);let t=document.getElementById("findBarInput"),n=document.getElementById("findBarCount"),o=document.getElementById("findBarPrev"),i=document.getElementById("findBarNext"),r=document.getElementById("findBarClose"),a=[],s=-1,c=null;function d(){c&&c.querySelectorAll("mark.find-highlight").forEach(x=>{let M=x.parentNode;M&&(M.replaceChild(document.createTextNode(x.textContent||""),x),M.normalize())}),a=[],s=-1,n.textContent=""}function u(x){return x.replace(/[.*+?^\${}()|[\\]\\\\]/g,"\\\\\$&")}function m(x){if(d(),!x)return;let M=document.getElementById("content");if(!M)return;c=M;let C=new RegExp(u(x),"gi"),B=document.createTreeWalker(M,NodeFilter.SHOW_TEXT,{acceptNode(le){let R=le.parentElement;if(!R)return NodeFilter.FILTER_REJECT;let O=R.tagName.toLowerCase();return O==="script"||O==="style"||O==="mark"?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),lt=[],ct;for(;ct=B.nextNode();)lt.push(ct);for(let le of lt){let R=le.textContent||"",O,Oe=[],qe=0;for(C.lastIndex=0;(O=C.exec(R))!==null;){O.index>qe&&Oe.push(R.slice(qe,O.index));let ce=document.createElement("mark");ce.className="find-highlight",ce.textContent=O[0],Oe.push(ce),a.push(document.createRange()),qe=O.index+O[0].length}if(Oe.length===0)continue;qe<R.length&&Oe.push(R.slice(qe));let _t=document.createDocumentFragment();Oe.forEach(ce=>{typeof ce=="string"?_t.appendChild(document.createTextNode(ce)):_t.appendChild(ce)}),le.parentNode.replaceChild(_t,le)}a=[],M.querySelectorAll("mark.find-highlight").forEach(le=>{let R=document.createRange();R.selectNode(le),a.push(R)}),a.length>0&&(s=0,p(0)),g()}function p(x){let M=document.getElementById("content");if(!M)return;let C=M.querySelectorAll("mark.find-highlight");C.forEach((lt,ct)=>{lt.classList.toggle("find-highlight-current",ct===x)});let B=C[x];B&&B.scrollIntoView({block:"center",behavior:"smooth"})}function g(){a.length===0?(n.textContent=t.value?"\\u65E0\\u7ED3\\u679C":"",n.className=t.value?"no-result":""):(n.textContent=\`\${s+1} / \${a.length}\`,n.className="")}function y(){a.length!==0&&(s=(s+1)%a.length,p(s),g())}function h(){a.length!==0&&(s=(s-1+a.length)%a.length,p(s),g())}function k(){e.classList.add("visible"),t.focus(),t.select(),t.value&&m(t.value)}function E(){e.classList.remove("visible"),d()}window.__showFindBar=k,t.addEventListener("input",()=>m(t.value)),t.addEventListener("keydown",x=>{x.key==="Enter"?(x.shiftKey?h():y(),x.preventDefault()):x.key==="Escape"&&(E(),x.preventDefault())}),o.addEventListener("click",h),i.addEventListener("click",y),r.addEventListener("click",E)}var Zn,eo,ur,as,Qn,se,Xn,lr,J,De,be=b(()=>{I();X();Ze();he();fe();qi();zi();L();Ae();rr();sr();Jn();Nn();Zn="md-viewer:sidebar-width",eo=260,ur=220,as=680,Qn=new Map,se=!1,Xn=!1,lr=!1;J=null;De=1;document.addEventListener("click",e=>{let t=document.getElementById("fontScaleMenu"),n=document.getElementById("fontScaleButton");if(!t||!n)return;let o=e.target;!t.contains(o)&&!n.contains(o)&&oo()});window.addFile=()=>{let e=document.getElementById("searchInput");e&&vr(e.value).catch(t=>{S(\`\\u6DFB\\u52A0\\u5931\\u8D25: \${t?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)})};window.handleUnifiedInputSubmit=e=>{let t=document.getElementById("searchInput"),n=(typeof e=="string"?e:t?.value||"").trim();if(n){if(!ks(n)){Es(n).catch(o=>{S(\`\\u641C\\u7D22\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)});return}vr(n).catch(o=>{S(\`\\u6DFB\\u52A0\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)})}};window.dismissQuickActionConfirm=()=>{wr()&&st()};window.switchFile=xs;window.removeFile=kr;window.showNearbyMenu=ys;window.addFileByPath=Re;window.refreshFile=fr;window.handleRefreshButtonClick=Cs;window.handleDiffButtonClick=Fs;window.closeDiffView=xr;window.acceptDiffUpdate=\$s;window.copySingleText=Bs;window.copyFileName=Hs;window.copyFilePath=Er;window.showToast=Se;window.showSettingsDialog=ir;window.toggleFontScaleMenu=Ps;window.setFontScale=js;window.openExternalFile=vs;window.renderContent=U;window.applyTheme=dr;(async()=>(ls(),Ws(),Ei(),oe(),window.addEventListener("resize",()=>{oe()}),await on(Le),dr(),await Dn(),Ds(),A(),U(),ke(!0),Ts(),cs(),document.addEventListener("click",e=>{if(!wr())return;let t=e.target;t&&(t.closest(".sidebar-header")||t.closest("#quickActionConfirm")||st())}),Ss(),Ms(),document.addEventListener("mouseup",()=>{setTimeout(()=>{let e=document.getElementById("content")?.getAttribute("data-current-file")||null;xi(e)},0)}),await ds(),Sr(),Rs()))()});be();})();
