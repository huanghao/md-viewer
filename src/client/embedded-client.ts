...
export const EMBEDDED_CLIENT_JS = `"use strict";(()=>{var Ar=Object.defineProperty;var b=(e,t)=>()=>(e&&(t=e(e=0)),t);var ce=(e,t)=>{for(var n in t)Ar(e,n,{get:t[n],enumerable:!0})};var so={};ce(so,{defaultConfig:()=>dt,loadConfig:()=>ut,saveConfig:()=>H,updateConfig:()=>Lr});function ut(){try{let e=localStorage.getItem(ro);if(!e)return{...dt};let t=JSON.parse(e);return{...dt,...t}}catch(e){return console.error("\\u52A0\\u8F7D\\u914D\\u7F6E\\u5931\\u8D25:",e),{...dt}}}function H(e){try{localStorage.setItem(ro,JSON.stringify(e))}catch(t){console.error("\\u4FDD\\u5B58\\u914D\\u7F6E\\u5931\\u8D25:",t)}}function Lr(e){let n={...ut(),...e};return H(n),n}var ro,dt,xe=b(()=>{"use strict";ro="md-viewer:config",dt={sidebarTab:"focus",focusWindowKey:"8h",markdownTheme:"github",codeTheme:"github",mathInline:!0,workspaces:[]}});function lo(){try{localStorage.setItem(ao,JSON.stringify(Array.from(de.entries()).map(([e,t])=>[e,Array.from(t)])))}catch(e){console.error("\\u4FDD\\u5B58\\u5217\\u8868\\u5DEE\\u5F02\\u72B6\\u6001\\u5931\\u8D25:",e)}}function co(){de.clear();try{let e=localStorage.getItem(ao);if(!e)return;let t=JSON.parse(e);if(!Array.isArray(t))return;for(let n of t){if(!Array.isArray(n)||n.length!==2)continue;let o=n[0],i=n[1];typeof o!="string"||!Array.isArray(i)||de.set(o,new Set(i.filter(r=>typeof r=="string"&&r.length>0)))}}catch(e){console.error("\\u6062\\u590D\\u5217\\u8868\\u5DEE\\u5F02\\u72B6\\u6001\\u5931\\u8D25:",e)}}function uo(e){return de.get(e)}function Kt(e,t){de.set(e,t),lo()}function po(e){let t=de.get(e);return de.delete(e),lo(),t}var ao,de,mo=b(()=>{"use strict";ao="md-viewer:workspaceKnownFiles",de=new Map});function ue(e){pt.add(e)}function V(e){pt.delete(e)}function Jt(e){return pt.has(e)}function Ut(e){let t=Array.from(pt.values());if(!e)return t;let n=\`\${e.replace(/\\/+\$/,"")}/\`;return t.filter(o=>o.startsWith(n))}var pt,Vt=b(()=>{"use strict";pt=new Set});function Gt(){try{let e=Array.from(G.entries()).map(([t,n])=>[t,Array.from(n.entries())]);localStorage.setItem(fo,JSON.stringify(e))}catch(e){console.error("\\u4FDD\\u5B58\\u5DE5\\u4F5C\\u533A\\u76EE\\u5F55\\u5C55\\u5F00\\u72B6\\u6001\\u5931\\u8D25:",e)}}function go(){G.clear();try{let e=localStorage.getItem(fo);if(!e)return;let t=JSON.parse(e);if(!Array.isArray(t))return;for(let n of t){if(!Array.isArray(n)||n.length!==2)continue;let o=n[0],i=n[1];if(typeof o!="string"||!Array.isArray(i))continue;let r=new Map;for(let s of i){if(!Array.isArray(s)||s.length!==2)continue;let a=s[0],c=s[1];typeof a!="string"||typeof c!="boolean"||r.set(a,c)}r.size>0&&G.set(o,r)}}catch(e){console.error("\\u6062\\u590D\\u5DE5\\u4F5C\\u533A\\u76EE\\u5F55\\u5C55\\u5F00\\u72B6\\u6001\\u5931\\u8D25:",e)}}function ho(e){return G.get(e)}function mt(e,t){if(t.size===0){G.delete(e),Gt();return}G.set(e,new Map(t)),Gt()}function yo(e){G.has(e)&&(G.delete(e),Gt())}function ft(e){let t=new Map,n=o=>{if(o.type==="directory"){typeof o.isExpanded=="boolean"&&t.set(o.path,o.isExpanded);for(let i of o.children||[])n(i)}};return n(e),t}var fo,G,Qt=b(()=>{"use strict";fo="md-viewer:workspaceTreeExpandedState",G=new Map});function W(e){return Q.has(e)}function Xt(e){Q.add(e)}function P(e){Q.has(e)&&Q.delete(e)}function _e(e){return ze.has(e)}function Yt(e){ze.add(e)}function gt(e){ze.delete(e)}function Zt(){Q.clear(),ze.clear(),co(),go()}function en(e,t){let n=new Set(t),o=uo(e);if(!o){Kt(e,n);return}for(let i of n)o.has(i)||Q.add(i),V(i);for(let i of o)n.has(i)||(Q.delete(i),ue(i));Kt(e,n)}function tn(e){let t=po(e);if(t)for(let n of t)Q.delete(n),ze.delete(n)}var Q,ze,bo=b(()=>{"use strict";mo();Vt();Qt();Q=new Set,ze=new Set});var X=b(()=>{"use strict";bo();Vt()});var pe={};ce(pe,{addOrUpdateFile:()=>rn,getFilteredFiles:()=>ln,getSessionFile:()=>Ee,getSessionFiles:()=>nn,hasSessionFile:()=>bt,markFileMissing:()=>Fr,removeFile:()=>sn,restoreState:()=>on,saveState:()=>q,setSearchQuery:()=>Y,state:()=>l,switchToFile:()=>an});function Ee(e){return l.sessionFiles.get(e)}function bt(e){return l.sessionFiles.has(e)}function nn(){return Array.from(l.sessionFiles.values())}function q(){try{let e={files:Array.from(l.sessionFiles.entries()).map(([t,n])=>[t,{path:n.path,name:n.name,isRemote:n.isRemote||!1,isMissing:n.isMissing||!1,lastModified:n.lastModified,displayedModified:n.displayedModified,lastAccessed:n.lastAccessed||Date.now()}]),currentFile:l.currentFile};localStorage.setItem(yt,JSON.stringify(e))}catch(e){if(e.name==="QuotaExceededError"||e.code===22){console.warn("localStorage \\u914D\\u989D\\u5DF2\\u6EE1\\uFF0C\\u6267\\u884C\\u6E05\\u7406..."),wo();try{let t={files:Array.from(l.sessionFiles.entries()).map(([n,o])=>[n,{path:o.path,name:o.name,isRemote:o.isRemote||!1,isMissing:o.isMissing||!1,lastModified:o.lastModified,displayedModified:o.displayedModified,lastAccessed:o.lastAccessed||Date.now()}]),currentFile:l.currentFile};localStorage.setItem(yt,JSON.stringify(t))}catch(t){console.error("\\u4FDD\\u5B58\\u72B6\\u6001\\u5931\\u8D25\\uFF08\\u91CD\\u8BD5\\u540E\\uFF09:",t)}}else console.error("\\u4FDD\\u5B58\\u72B6\\u6001\\u5931\\u8D25:",e)}}function wo(){if(l.sessionFiles.size<=ht)return;let e=Array.from(l.sessionFiles.entries()).sort((o,i)=>(i[1].lastAccessed||i[1].lastModified||0)-(o[1].lastAccessed||o[1].lastModified||0)),t=e.slice(0,ht),n=e.slice(ht);l.sessionFiles.clear(),t.forEach(([o,i])=>{l.sessionFiles.set(o,i)}),console.log(\`\\u5DF2\\u6E05\\u7406 \${n.length} \\u4E2A\\u65E7\\u6587\\u4EF6\`)}async function on(e){try{Zt();let t=localStorage.getItem(yt);if(!t)return;let n=JSON.parse(t);if(!n.files||n.files.length===0)return;let o=[];for(let[i,r]of n.files){let s=await e(i,!0);if(s){let a=r.displayedModified||s.lastModified,c=Math.max(s.lastModified,r.lastModified||0);l.sessionFiles.set(i,{path:s.path,name:s.filename,content:s.content,lastModified:c,displayedModified:a,isRemote:s.isRemote||!1,isMissing:!1,lastAccessed:r.lastAccessed||s.lastModified}),o.push([i,r])}}if(o.length!==n.files.length){let i=l.sessionFiles.has(n.currentFile)?n.currentFile:null;localStorage.setItem(yt,JSON.stringify({files:o,currentFile:i}))}if(n.currentFile&&l.sessionFiles.has(n.currentFile))l.currentFile=n.currentFile;else{let i=Array.from(l.sessionFiles.values())[0];l.currentFile=i?i.path:null}}catch(t){console.error("\\u6062\\u590D\\u72B6\\u6001\\u5931\\u8D25:",t)}}function rn(e,t=!1){l.sessionFiles.size>=ht&&!l.sessionFiles.has(e.path)&&wo();let n=l.sessionFiles.get(e.path),o=!n,i=n&&n.lastModified>n.displayedModified?n.displayedModified:e.lastModified,r=n?Math.max(n.lastModified,e.lastModified):e.lastModified;l.sessionFiles.set(e.path,{path:e.path,name:e.filename,content:e.content,lastModified:r,displayedModified:i,isRemote:e.isRemote||!1,isMissing:!1,lastAccessed:Date.now()}),t&&(l.currentFile=e.path,P(e.path)),V(e.path),o&&(t||Xt(e.path)),q()}function sn(e){let n=Array.from(l.sessionFiles.keys()).indexOf(e);if(l.sessionFiles.delete(e),P(e),V(e),l.currentFile===e){let o=Array.from(l.sessionFiles.values());l.currentFile=o.length>0?o[Math.max(0,n-1)].path:null}q()}function an(e){l.currentFile=e;let t=l.sessionFiles.get(e);t&&(t.lastAccessed=Date.now()),P(e),V(e),q()}function Fr(e,t=!1){let n=l.sessionFiles.get(e),o=Date.now(),i=e.split("/").pop()||n?.name||e;l.sessionFiles.set(e,{path:e,name:i,content:n?.content||\`# \\u6587\\u4EF6\\u5DF2\\u5220\\u9664

\\u8BE5\\u6587\\u4EF6\\u5DF2\\u4ECE\\u78C1\\u76D8\\u5220\\u9664\\uFF0C\\u4E14\\u5F53\\u524D\\u65E0\\u672C\\u5730\\u7F13\\u5B58\\u5185\\u5BB9\\u3002\`,lastModified:n?.lastModified||o,displayedModified:n?.displayedModified||o,isRemote:n?.isRemote||!1,isMissing:!0}),t&&(l.currentFile=e,P(e)),ue(e),q()}function Y(e){l.searchQuery=e}function ln(){let e=l.searchQuery.toLowerCase().trim();return e?Array.from(l.sessionFiles.values()).filter(t=>t.name.toLowerCase().includes(e)||t.path.toLowerCase().includes(e)):Array.from(l.sessionFiles.values())}var l,yt,ht,I=b(()=>{"use strict";xe();X();l={sessionFiles:new Map,currentFile:null,searchQuery:"",config:ut(),currentWorkspace:null,fileTree:new Map},yt="md-viewer:openFiles",ht=100});function w(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function v(e){return w(e)}var me=b(()=>{"use strict"});function z(e,t=!1){return e.isMissing?{badge:"D",color:"#ff3b30",type:"deleted"}:e.lastModified>e.displayedModified?{badge:"M",color:"#ff9500",type:"modified"}:t?{badge:"dot",color:"#007AFF",type:"new"}:{badge:null,color:null,type:"normal"}}var wt=b(()=>{"use strict"});function cn(e){let t=e.match(/\\.([^.]+)\$/);return t?t[1].toLowerCase():""}function \$r(e){let t=cn(e);return t==="html"||t==="htm"}function dn(e){return cn(e)==="json"}function Ke(e){return cn(e)==="jsonl"}function fe(e){return \$r(e)?{cls:"html",label:"<>"}:dn(e)||Ke(e)?{cls:"json",label:"{}"}:{cls:"md",label:"M"}}var Je=b(()=>{"use strict"});function Ue(e){return e&&(e.replace(/\\.(md|markdown|html?)\$/i,"")||e)}var un=b(()=>{"use strict"});var fn={};ce(fn,{getPinnedFiles:()=>mn,isPinned:()=>pn,pinFile:()=>Cr,unpinFile:()=>Ir});function vt(){try{let e=localStorage.getItem(vo);if(!e)return new Set;let t=JSON.parse(e);return Array.isArray(t)?new Set(t):new Set}catch{return new Set}}function ko(e){try{localStorage.setItem(vo,JSON.stringify(Array.from(e)))}catch{}}function pn(e){return vt().has(e)}function Cr(e){let t=vt();t.add(e),ko(t)}function Ir(e){let t=vt();t.delete(e),ko(t)}function mn(){return vt()}var vo,Ve=b(()=>{"use strict";vo="md-viewer:pinned-files"});function kt(e){let t=Array.from(e.values()),n={};return t.forEach(o=>{n[o.name]=(n[o.name]||0)+1}),t.map(o=>{if(n[o.name]===1)return{...o,displayName:o.name};let i=o.path.split("/").filter(Boolean),r=t.filter(a=>a.name===o.name&&a.path!==o.path),s="";for(let a=i.length-2;a>=0;a--){let c=i[a];if(r.every(d=>d.path.split("/").filter(Boolean)[a]!==c)){s=c;break}}return!s&&i.length>=2&&(s=i[i.length-2]),{...o,displayName:s?\`\${o.name} (\${s})\`:o.name}})}var xo=b(()=>{"use strict"});function Te(e,t,n,o){if(t.length===0)return[];if(e==="close-all")return t.map(i=>i.path);if(!n)return[];if(e==="close-others")return t.filter(i=>i.path!==n).map(i=>i.path);if(e==="close-right"){let i=t.findIndex(r=>r.path===n);return i<0?[]:t.slice(i+1).map(r=>r.path)}return t.filter(i=>i.path!==n&&o(i.path)).map(i=>i.path)}var Eo=b(()=>{"use strict"});function Nr(){Me||(Me=document.createElement("div"),Me.id="toast-container",Me.className="toast-container",document.body.appendChild(Me))}function Se(e){let t=typeof e=="string"?{message:e,type:"info",duration:3e3}:{type:"info",duration:3e3,...e};Nr();let n=document.createElement("div");n.className=\`toast toast-\${t.type}\`;let o={success:"\\u2713",error:"\\u2717",warning:"\\u26A0",info:"\\u2139"};return n.innerHTML=\`
    <span class="toast-icon">\${o[t.type]}</span>
    <span class="toast-message">\${t.message}</span>
  \`,Me.appendChild(n),requestAnimationFrame(()=>{n.classList.add("toast-show")}),t.duration&&t.duration>0&&setTimeout(()=>{To(n)},t.duration),n.addEventListener("click",()=>{To(n)}),n}function To(e){e.classList.remove("toast-show"),e.classList.add("toast-hide"),setTimeout(()=>{e.remove()},300)}function _(e,t){return Se({message:e,type:"success",duration:t})}function S(e,t){return Se({message:e,type:"error",duration:t})}function Mo(e,t){return Se({message:e,type:"warning",duration:t})}function gn(e,t){return Se({message:e,type:"info",duration:t})}var Me,Ae=b(()=>{"use strict";Me=null});var xt={};ce(xt,{detectPathType:()=>bn,getNearbyFiles:()=>hn,getPathSuggestions:()=>yn,loadFile:()=>Le,openFile:()=>wn,searchFiles:()=>Ge});async function Le(e,t=!1){try{let o=await(await fetch(\`/api/file?path=\${encodeURIComponent(e)}\`)).json();return o.error?(t||S(o.error),null):o}catch(n){return t||S(\`\\u52A0\\u8F7D\\u5931\\u8D25: \${n.message}\`),null}}async function Ge(e,t={}){let n=new URLSearchParams({query:e});t.limit&&Number.isFinite(t.limit)&&n.set("limit",String(t.limit));for(let i of t.roots||[])i.trim()&&n.append("root",i.trim());return(await fetch(\`/api/files?\${n.toString()}\`)).json()}async function hn(e){return(await fetch(\`/api/nearby?path=\${encodeURIComponent(e)}\`)).json()}async function yn(e,t={}){let n=t.kind||"file",o=t.markdownOnly!==!1,i=new URLSearchParams({input:e,kind:n,markdownOnly:o?"true":"false"});return(await fetch(\`/api/path-suggestions?\${i.toString()}\`)).json()}async function bn(e){return(await fetch("/api/detect-path",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:e})})).json()}async function wn(e,t=!0){await fetch("/api/open",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:e,focus:t})})}var ge=b(()=>{"use strict";Ae()});function Et(e,t){let n=[],o=-1,i=0,r=null,s=document.createElement("div");s.className="path-autocomplete-panel",s.style.display="none",document.body.appendChild(s);let a=()=>s.style.display!=="none",c=()=>{i+=1,r!==null&&(window.clearTimeout(r),r=null),s.style.display="none",n=[],o=-1},d=()=>{let y=e.getBoundingClientRect();s.style.left=\`\${Math.round(y.left+window.scrollX)}px\`,s.style.top=\`\${Math.round(y.bottom+window.scrollY+4)}px\`,s.style.width=\`\${Math.round(y.width)}px\`},u=()=>{if(n.length===0){c();return}s.innerHTML=n.map((y,h)=>{let k=h===o?"path-autocomplete-item active":"path-autocomplete-item",E=y.type==="directory"?"\\u{1F4C1}":"\\u{1F4C4}";return\`
          <div class="\${k}" data-index="\${h}">
            <span class="path-autocomplete-icon">\${E}</span>
            <span class="path-autocomplete-text">\${Br(y.display)}</span>
          </div>
        \`}).join(""),d(),s.style.display="block"},m=y=>{let h=n[y];if(!h)return;let k=h.type==="directory",E=k&&!h.path.endsWith("/")?\`\${h.path}/\`:h.path;e.value=E,e.dispatchEvent(new Event("input",{bubbles:!0})),e.focus(),e.setSelectionRange(e.value.length,e.value.length),c(),k&&g()},p=async()=>{let y=e.value.trim();if(!y){c();return}if(document.body.classList.contains("quick-action-confirm-visible")){c();return}if(t.shouldActivate&&!t.shouldActivate(y)){c();return}let h=++i;try{let k=await yn(y,{kind:t.kind,markdownOnly:t.markdownOnly});if(h!==i)return;n=k.suggestions||[],o=n.length>0?0:-1,u()}catch{c()}},g=()=>{r!==null&&window.clearTimeout(r),r=window.setTimeout(p,100)};s.addEventListener("mousedown",y=>{y.preventDefault();let h=y.target.closest(".path-autocomplete-item");if(!h)return;let k=Number(h.dataset.index);Number.isNaN(k)||m(k)}),e.addEventListener("focus",g),e.addEventListener("input",g),e.addEventListener("path-autocomplete-hide",c),e.addEventListener("keydown",y=>{let h=y.key;if(a()){if(h==="ArrowDown"){y.preventDefault(),n.length>0&&(o=(o+1)%n.length,u());return}if(h==="ArrowUp"){y.preventDefault(),n.length>0&&(o=(o-1+n.length)%n.length,u());return}if(h==="Tab"){o>=0&&(y.preventDefault(),m(o));return}if(h==="Enter"){if(y.metaKey||y.ctrlKey)return;if(y.preventDefault(),o>=0){m(o);return}c();return}h==="Escape"&&(y.preventDefault(),c())}}),e.addEventListener("blur",()=>{window.setTimeout(c,120)}),window.addEventListener("resize",()=>{a()&&d()}),window.addEventListener("scroll",()=>{a()&&d()},!0)}function Br(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}var vn=b(()=>{"use strict";ge()});function Lo(e,t){if(e.type==="file")return t.has(e.path)?null:e;let n=[];for(let o of e.children||[]){let i=Lo(o,t);i&&n.push(i)}return n.length===0&&(e.children||[]).length>0?null:{...e,children:n}}function Hr(e){let t=e.split("/").filter(Boolean);return t[t.length-1]||"workspace"}function \$o(e){let t=Ue(e)||e;return\`<span class="tree-name-full">\${w(t)}</span>\`}function Co(e,t){if(e){if(e.type==="file"){t.add(e.path);return}(e.children||[]).forEach(n=>Co(n,t))}}function Io(e){if(e.type==="file")return 1;let t=0;for(let n of e.children||[])t+=Io(n);return e.fileCount=t,t}function Wr(e,t){let n=e.path.replace(/\\/+\$/,""),o={name:e.name,path:n,type:"directory",isExpanded:!0,children:[]},i=new Map([[n,o]]),r=Array.from(new Set(t)).sort((s,a)=>s.localeCompare(a,"zh-CN"));for(let s of r){if(!s.startsWith(\`\${n}/\`))continue;let c=s.slice(n.length+1).split("/").filter(Boolean);if(c.length===0)continue;let d=n,u=o;for(let m=0;m<c.length;m+=1){let p=c[m],g=m===c.length-1;if(d=\`\${d}/\${p}\`,g)(u.children||[]).some(h=>h.path===d)||u.children.push({name:p,path:d,type:"file"});else{let y=i.get(d);y||(y={name:p,path:d,type:"directory",isExpanded:!0,children:[]},i.set(d,y),u.children.push(y)),u=y}}}return Io(o),o}function jr(e,t){if(!t)return l.fileTree.get(e.id);let n=e.path.replace(/\\/+\$/,""),o=\`\${n}/\`,i=Array.from(Ce).filter(r=>r===n||r.startsWith(o));if(i.length!==0)return Wr(e,i)}function Pr(){return l.config.workspaces.map(e=>e.path.trim()).filter(Boolean)}function Ao(){Z="",be="",ee=!1,\$e=!1,Ce=new Set}async function Dr(e,t,n,o){try{let r=await Ge(e,{roots:t,limit:200});if(o!==Tt)return;Z=e,be=n,Ce=new Set((r.files||[]).map(s=>s.path).filter(Boolean)),ee=!1,\$e=!0}catch(r){if(o!==Tt)return;console.error("\\u5DE5\\u4F5C\\u533A\\u641C\\u7D22\\u5931\\u8D25:",r),Z=e,be=n,Ce=new Set,ee=!1,\$e=!0}let{renderSidebar:i}=await Promise.resolve().then(()=>(L(),F));i()}function Rr(e){let t=e.trim();if(!t){Ao();return}if(t.startsWith("/")||t.startsWith("~/")||t.startsWith("~\\\\")){Ao();return}let n=Pr(),o=n.join(\`
\`);if(n.length===0){Z=t,be=o,Ce=new Set,ee=!1,\$e=!0;return}\$e&&!ee&&Z===t&&be===o||ee&&Z===t&&be===o||(Tt+=1,Z=t,be=o,ee=!0,\$e=!1,Ce=new Set,Dr(t,n,o,Tt))}function No(){let e=document.getElementById(Ye),t=document.getElementById(Fo);if(!t)return;let n=e?.value.trim()||"";t.textContent=n||"\\u8DEF\\u5F84\\u9884\\u89C8\\uFF1A\\u5728\\u4E0A\\u65B9\\u8F93\\u5165\\u540E\\u8FD9\\u91CC\\u4F1A\\u663E\\u793A\\u5B8C\\u6574\\u8DEF\\u5F84"}function Or(){let e=document.getElementById(kn);if(e)return e;let t=document.createElement("div");t.id=kn,t.className="sync-dialog-overlay add-workspace-overlay",t.innerHTML=\`
    <div class="sync-dialog add-workspace-dialog">
      ...
      <div class="sync-dialog-body">
        <div class="sync-dialog-field">
          ...
          <div id="\${Fo}" class="workspace-path-preview">\\u8DEF\\u5F84\\u9884\\u89C8\\uFF1A\\u5728\\u4E0A\\u65B9\\u8F93\\u5165\\u540E\\u8FD9\\u91CC\\u4F1A\\u663E\\u793A\\u5B8C\\u6574\\u8DEF\\u5F84</div>
        </div>
      </div>
  ...
  \`,document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&Mt()});let n=t.querySelector(\`#\${Ye}\`);return n&&(Et(n,{kind:"directory",markdownOnly:!1}),n.addEventListener("input",No),n.addEventListener("keydown",o=>{(o.metaKey||o.ctrlKey)&&o.key==="Enter"&&(o.preventDefault(),window.confirmAddWorkspaceDialog()),o.key==="Escape"&&(o.preventDefault(),Mt())})),t}function qr(){Or().classList.add("show");let t=document.getElementById(Ye);t&&(t.value="",No(),t.focus())}function Mt(){let e=document.getElementById(kn);e&&e.classList.remove("show")}async function zr(){try{let e=document.getElementById(Ye),t=e?.value.trim()||"";if(!t){Mo("\\u8BF7\\u8F93\\u5165\\u5DE5\\u4F5C\\u533A\\u8DEF\\u5F84"),e?.focus();return}let n=Hr(t),{addWorkspace:o}=await Promise.resolve().then(()=>(Ze(),Do)),i=o(n,t),{renderSidebar:r}=await Promise.resolve().then(()=>(L(),F));r(),Mt(),_(\`\\u5DF2\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A: \${i.name}\`,2e3)}catch(e){console.error("\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25:",e),S(\`\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25: \${e?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)}}function Bo(){if(l.config.sidebarTab==="focus")return Po();let e=l.searchQuery.trim().toLowerCase();return Rr(e),\`\${_r(e)}\`}function _r(e){let t=l.config.workspaces,n=t.map((o,i)=>Jr(o,i,t.length,e)).filter(Boolean).join("");return\`
  ...
  \`}function Jr(e,t,n,o){let i=l.currentWorkspace===e.id,r=o?jr(e,o):l.fileTree.get(e.id),s=r;if(r){let h=Ie(r,e.path);h.size>0&&(s=Lo(r,h)??void 0)}let a=o?!0:e.isExpanded,c=a?"\\u25BC":"\\u25B6",d=t>0,u=t<n-1,m=!o||e.name.toLowerCase().includes(o)||e.path.toLowerCase().includes(o),p=!!s&&!!s.children&&s.children.length>0,g=a?Vr(e.id,e.path,s,o):"";return o&&!m&&!p&&!!!g?"":\`
...
>\\u{1F4CC}</button>\`;return\`
      <div class="tree-node">
        <div class="\${y}"
          ...
          <span class="tree-name" title="\${v(t.name)}">\${\$o(t.name)}</span>
          \${k}
        </div>
      </div>
    ...
    <div class="tree-node">
      ...
      \${r&&a?\`
        <div class="file-tree">
          \${t.children.map(c=>Ho(e,c,n+1)).join("")}
        </div>
      \`:""}
    </div>
  \`}function Vr(e,t,n,o){let i=new Set;Co(n,i);let r=\`\${t}/\`,s=nn().filter(u=>!u.isMissing||!u.path.startsWith(r)||i.has(u.path)?!1:o?u.name.toLowerCase().includes(o)||u.path.toLowerCase().includes(o):!0),a=new Set(s.map(u=>u.path)),c=Ut(t).filter(u=>!a.has(u)).filter(u=>!i.has(u)).filter(u=>{if(!o)return!0;let m=u.toLowerCase(),p=(u.split("/").pop()||"").toLowerCase();return m.includes(o)||p.includes(o)});return s.length===0&&c.length===0?"":\`
    <div class="tree-missing-section">
      <div class="tree-missing-title">\\u5DF2\\u5220\\u9664</div>
      \${[...s.map(u=>({path:u.path,name:u.path.split("/").pop()||u.name,isCurrent:l.currentFile===u.path,hasRetry:!0,hasClose:!0})),...c.map(u=>({path:u,name:u.split("/").pop()||u,isCurrent:l.currentFile===u,hasRetry:!1,hasClose:!1}))].map(u=>{let m=fe(u.path);return\`
          <div class="tree-item file-node missing \${u.isCurrent?"current":""}" onclick="handleFileClick('\${v(u.path)}')">
            ...
            <span class="tree-name" title="\${v(u.name)}">\${\$o(u.name)}</span>
...
\`,d);return u===-1?o.length:u};switch(n){case"a":return s(a(i)),!0;case"e":return s(c(i)),!0;case"b":return s(Math.max(0,i-1)),!0;case"f":return s(Math.min(o.length,i+1)),!0;case"n":{let d=c(i);return s(d===o.length?d:Math.min(o.length,d+1+(i-a(i)))),!0}case"p":{let d=a(i);if(d===0)return s(0),!0;let u=a(d-1),m=d-1-u;return s(u+Math.min(i-d,m)),!0}case"d":return i<o.length&&(t.value=o.slice(0,i)+o.slice(i+1),s(i),t.dispatchEvent(new Event("input"))),!0;case"k":{let d=c(i),u=i===d&&d<o.length?d+1:d;return t.value=o.slice(0,i)+o.slice(u),s(i),t.dispatchEvent(new Event("input")),!0}case"u":{let d=a(i);return t.value=o.slice(0,d)+o.slice(i),s(d),t.dispatchEvent(new Event("input")),!0}case"w":{let d=i;for(;d>0&&/\\s/.test(o[d-1]);)d--;for(;d>0&&!/\\s/.test(o[d-1]);)d--;return t.value=o.slice(0,d)+o.slice(i),s(d),t.dispatchEvent(new Event("input")),!0}case"h":return i>0&&(t.value=o.slice(0,i-1)+o.slice(i),s(i-1),t.dispatchEvent(new Event("input"))),!0;default:return!1}}function te(e){return e==="up"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 4l4 4H4z"/></svg>':e==="down"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 12l-4-4h8z"/></svg>':e==="check"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M6.4 11.2L3.5 8.3l1.1-1.1 1.8 1.8 5-5 1.1 1.1z"/></svg>':e==="trash"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M6 2h4l1 1h3v1H2V3h3l1-1zm-1 4h1v7H5V6zm3 0h1v7H8V6zm3 0h1v7h-1V6z"/></svg>':e==="comment"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 2h12v9H8l-3 3v-3H2z"/></svg>':e==="list"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M3 3h10v1H3zm0 4h10v1H3zm0 4h10v1H3z"/></svg>':e==="filter"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 3h12L9.5 8v4.5l-3-1.5V8z"/></svg>':e==="edit"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M11.5 2.5a1.5 1.5 0 012.1 2.1L5 13.2l-3 .8.8-3 8.7-8.5z"/></svg>':e==="reopen"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 2a6 6 0 100 12A6 6 0 008 2zm0 1.5a4.5 4.5 0 110 9 4.5 4.5 0 010-9zM6 5.5l4 2.5-4 2.5V5.5z"/></svg>':'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M4.2 4.2L8 8l3.8-3.8 1 1L9 9l3.8 3.8-1 1L8 10l-3.8 3.8-1-1L7 9 3.2 5.2z"/></svg>'}function Nt(){return[...f.annotations].filter(e=>rs(e,f.filter)).sort((e,t)=>e.start-t.start)}function ss(){let e=T();if(e.filterMenu?.querySelectorAll(".annotation-filter-item[data-filter]").forEach(t=>{let n=t;n.classList.toggle("is-active",n.getAttribute("data-filter")===f.filter)}),e.densityToggle&&(e.densityToggle.classList.toggle("is-simple",f.density==="simple"),e.densityToggle.title=f.density==="simple"?"\\u5207\\u6362\\u5230\\u9ED8\\u8BA4\\u5217\\u8868":"\\u5207\\u6362\\u5230\\u6781\\u7B80\\u5217\\u8868"),e.filterToggle){let t={all:"\\u7B5B\\u9009\\uFF1A\\u5168\\u90E8",open:"\\u7B5B\\u9009\\uFF1A\\u672A\\u89E3\\u51B3",resolved:"\\u7B5B\\u9009\\uFF1A\\u5DF2\\u89E3\\u51B3",orphan:"\\u7B5B\\u9009\\uFF1A\\u5B9A\\u4F4D\\u5931\\u8D25"};e.filterToggle.title=t[f.filter]}}function as(){let e=T();e.annotationCount&&(e.annotationCount.textContent=String(Nt().length))}function Ne(e){let t=T();t.sidebar&&(t.sidebar.classList.toggle("collapsed",e),document.body.classList.toggle("annotation-sidebar-collapsed",e),e&&(t.filterMenu?.classList.add("hidden"),Be(!0),ie(!0)))}function mi(){try{let e=localStorage.getItem(si);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function ls(e){localStorage.setItem(si,JSON.stringify(e))}function fi(e){if(!f.currentFilePath)return;let t=mi();t[f.currentFilePath]=e,ls(t)}function cs(e){return Math.max(Xr,Math.min(Yr,Math.round(e)))}function gi(e){let t=cs(e);document.documentElement.style.setProperty("--annotation-sidebar-width",\`\${t}px\`),localStorage.setItem(ii,String(t))}function ds(){let e=Number(localStorage.getItem(ii)),t=Number.isFinite(e)&&e>0?e:ri;gi(t)}function oe(){let e=T();if(!e.sidebar)return;let t=document.getElementById("tabs"),n=Math.max(0,Math.round(t?.getBoundingClientRect().bottom||84)),o=Math.max(0,window.innerHeight-n);e.sidebar.style.top=\`\${n}px\`,e.sidebar.style.height=\`\${o}px\`,e.sidebarResizer&&(e.sidebarResizer.style.top=\`\${n}px\`,e.sidebarResizer.style.height=\`\${o}px\`),e.floatingOpenBtn&&(e.floatingOpenBtn.style.top=\`\${n+6}px\`)}function Zo(){Ne(!1),fi(!0),oe(),In()}function ei(){Ne(!0),fi(!1)}function us(){let e=T().sidebar;e&&Ne(!e.classList.contains("collapsed"))}function hi(){let e=T();return e.filterMenu&&!e.filterMenu.classList.contains("hidden")?(e.filterMenu.classList.add("hidden"),!0):e.quickAdd&&!e.quickAdd.classList.contains("hidden")?(Be(!0),!0):e.composer&&!e.composer.classList.contains("hidden")?(tt(),!0):e.popover&&!e.popover.classList.contains("hidden")?(f.pinnedAnnotationId=null,ie(!0),!0):!1}function ps(e,t){return e==="resolved"?"resolved":t}function ms(e,t,n){let o=T();if(!o.quickAdd)return;o.composer&&!o.composer.classList.contains("hidden")&&tt(),f.pendingAnnotation={...n,note:"",createdAt:Date.now()},f.pendingAnnotationFilePath=o.content?.getAttribute("data-current-file")||f.currentFilePath;let i=30,r=30,s=Ft(e,8,window.innerWidth-i-8),a=Ft(t,8,window.innerHeight-r-8);o.quickAdd.style.left=\`\${s}px\`,o.quickAdd.style.top=\`\${a}px\`,o.quickAdd.classList.remove("hidden")}function Be(e=!1){let t=T();t.quickAdd&&(t.quickAdd.classList.add("hidden"),e&&(\$n(),f.pendingAnnotation=null,f.pendingAnnotationFilePath=null))}function fs(e,t){let n=T();if(!f.pendingAnnotation||!n.composer||!n.composerNote)return;ys(),n.composerNote.value="",wi(n.composerNote);let o=typeof e=="number"?e:n.quickAdd?Number.parseFloat(n.quickAdd.style.left||"0"):0,i=typeof t=="number"?t:n.quickAdd?Number.parseFloat(n.quickAdd.style.top||"0"):0;Ln(n.composer,o,i+34),n.composer.classList.remove("hidden"),Be(!1),n.composerNote.focus()}function gs(){let e=T();e.composer&&e.composer.classList.add("hidden")}function hs(){let e=T();if(!e.composer||!f.pendingAnnotation)return;let n=document.getElementById("reader")?.querySelector(".annotation-mark-temp");if(n){let o=n.getBoundingClientRect();Ln(e.composer,o.right+6,o.top-8)}e.composer.classList.remove("hidden"),e.composerNote?.focus()}function tt(){let e=T();e.composer&&(\$n(),f.pendingAnnotation=null,f.pendingAnnotationFilePath=null,e.composerNote&&(e.composerNote.value=""),e.composer.classList.add("hidden"))}function \$n(){let e=document.getElementById("reader");if(!e)return;let t=Array.from(e.querySelectorAll(".annotation-mark-temp"));for(let n of t){let o=n.parentNode;for(;n.firstChild;)o?.insertBefore(n.firstChild,n);o?.removeChild(n)}}function ys(){let e=T();if(!e.reader||!f.pendingAnnotation)return;\$n();let t=f.pendingAnnotation,n=Lt(e.reader,t.start),o=Lt(e.reader,t.start+t.length);if(!(!n||!o)&&!(n.node===o.node&&n.offset===o.offset)){if(n.node===o.node){let i=document.createRange();i.setStart(n.node,n.offset),i.setEnd(o.node,o.offset);let r=document.createElement("span");r.className="annotation-mark-temp";try{i.surroundContents(r)}catch{}return}try{let i=[],r=document.createTreeWalker(e.reader,NodeFilter.SHOW_TEXT,null,!1),s;for(;s=r.nextNode();){let a=document.createRange();a.selectNode(s);let c=document.createRange();c.setStart(n.node,n.offset),c.setEnd(o.node,o.offset);let d=c.compareBoundaryPoints(Range.END_TO_START,a),u=c.compareBoundaryPoints(Range.START_TO_END,a);if(d>0||u<0)continue;let m=s===n.node?n.offset:0,p=s===o.node?o.offset:s.nodeValue?.length||0;m<p&&i.push({node:s,start:m,end:p})}for(let a=i.length-1;a>=0;a--){let{node:c,start:d,end:u}=i[a],m=document.createRange();m.setStart(c,d),m.setEnd(c,u);let p=document.createElement("span");p.className="annotation-mark-temp",m.surroundContents(p)}}catch{}}}function Cn(e){return ai(e),e.thread||[]}function yi(e,t=!1){let n=Cn(e),o=n[0],i=n.slice(1);return t?\`
  ...
  \`,o.popoverResolveBtn){let s=ne(e);o.popoverResolveBtn.title=s?"\\u91CD\\u65B0\\u6253\\u5F00":"\\u6807\\u8BB0\\u5DF2\\u89E3\\u51B3",o.popoverResolveBtn.setAttribute("aria-label",s?"\\u91CD\\u65B0\\u6253\\u5F00":"\\u6807\\u8BB0\\u5DF2\\u89E3\\u51B3"),o.popoverResolveBtn.innerHTML=te(s?"reopen":"check"),o.popoverResolveBtn.classList.toggle("is-resolved",s)}o.popover.style.left=\`\${Math.round(t)}px\`,o.popover.style.top=\`\${Math.round(n)}px\`,o.popover.classList.remove("hidden")}function ti(){let e=f.pinnedAnnotationId;if(!e)return;let t=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(!t)return;let n=f.annotations.find(i=>i.id===e);if(!n)return;let o=t.getBoundingClientRect();nt(n,o.right+8,o.top+8)}function ie(e=!1){let t=T();t.popover&&(!e&&f.pinnedAnnotationId||(t.popover.classList.add("hidden"),e&&(f.pinnedAnnotationId=null)))}function ni(e){let t=T();if(!f.pendingAnnotation||!t.composerNote)return;let n=f.pendingAnnotationFilePath;if(!n||n!==e)return;let o=t.composerNote.value.trim();if(!o)return;let i=Date.now(),r={...f.pendingAnnotation,serial:es(f.annotations),note:o,thread:[{id:\`c-\${i}-\${Math.random().toString(16).slice(2,8)}\`,type:"comment",note:o,createdAt:i}]};f.annotations.push(r),Sn(e,r,"\\u521B\\u5EFA\\u8BC4\\u8BBA\\u5931\\u8D25"),tt(),N(),\$(e)}function vi(e,t){let n=f.annotations.slice();f.annotations=f.annotations.filter(o=>o.id!==e),f.pinnedAnnotationId===e&&(f.pinnedAnnotationId=null,ie(!0)),f.activeAnnotationId===e&&(f.activeAnnotationId=null),N(),\$(t),Uo(t,{id:e}).catch(o=>{f.annotations=n,S(\`\\u5220\\u9664\\u8BC4\\u8BBA\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`,2600),N(),\$(t)})}function bs(e){let t=T();if(!t.content)return;let n=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(n){let o=t.content.getBoundingClientRect(),i=n.getBoundingClientRect(),s=t.content.scrollTop+(i.top-o.top),c=Math.max(0,s-56);t.content.scrollTo({top:c,behavior:"smooth"})}}function ki(e,t){f.activeAnnotationId=e,N(),e&&(bs(e),f.pinnedAnnotationId=e,requestAnimationFrame(()=>{let n=f.annotations.find(r=>r.id===e),o=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(!n||!o)return;let i=o.getBoundingClientRect();nt(n,i.right+8,i.top+8)})),\$(t)}function It(e,t,n){let o=Nt(),i=o.findIndex(s=>s.id===e);if(i<0)return;let r=o[i+t];r&&ki(r.id,n)}function ws(e){let t=document.getElementById("content"),n=document.querySelector(\`[data-annotation-id="\${e}"]\`);if(!t||!n)return null;let o=t.getBoundingClientRect(),i=n.getBoundingClientRect();return t.scrollTop+(i.top-o.top)}function In(){if(f.density!=="default")return;let e=document.getElementById("content"),t=document.getElementById("annotationList");!e||!t||(t.scrollTop=e.scrollTop)}function xi(e,t){let n=f.annotations.find(r=>r.id===e);if(!n)return;let o=n.status;n.status==="resolved"?n.status=(n.confidence||0)<=0?"unanchored":"anchored":n.status="resolved";let i=n.status||"anchored";ie(!0),N(),\$(t),Vo(t,{id:e},i).catch(r=>{n.status=o,S(\`\\u66F4\\u65B0\\u8BC4\\u8BBA\\u72B6\\u6001\\u5931\\u8D25: \${r?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`,2600),N(),\$(t)})}function oi(e,t){e.classList.add("annotation-mark"),e.dataset.annotationId=t.id,e.classList.add(\`status-\${Fn(t)}\`),ne(t)&&e.classList.add("is-resolved")}function vs(e,t){let n=T();if(!n.reader||typeof e.start!="number"||typeof e.length!="number"||e.length<=0)return;let o=Lt(n.reader,e.start,t),i=Lt(n.reader,e.start+e.length,t);if(!(!o||!i)&&!(o.node===i.node&&o.offset===i.offset)){if(o.node===i.node){let r=document.createRange();r.setStart(o.node,o.offset),r.setEnd(i.node,i.offset);let s=document.createElement("span");oi(s,e);try{r.surroundContents(s)}catch{}return}try{let r=[],s=document.createTreeWalker(n.reader,NodeFilter.SHOW_TEXT,null,!1),a;for(;a=s.nextNode();){let c=document.createRange();c.selectNode(a);let d=document.createRange();d.setStart(o.node,o.offset),d.setEnd(i.node,i.offset);let u=d.compareBoundaryPoints(Range.END_TO_START,c),m=d.compareBoundaryPoints(Range.START_TO_END,c);if(u>0||m<0)continue;let p=a===o.node?o.offset:0,g=a===i.node?i.offset:a.nodeValue?.length||0;p<g&&r.push({node:a,start:p,end:g})}for(let c=r.length-1;c>=0;c--){let{node:d,start:u,end:m}=r[c],p=document.createRange();p.setStart(d,u),p.setEnd(d,m);let g=document.createElement("span");oi(g,e),p.surroundContents(g)}}catch{}}}function ks(){let e=T();e.reader&&e.reader.querySelectorAll(".annotation-mark").forEach(t=>{let n=t.getAttribute("data-annotation-id"),o=f.annotations.find(i=>i.id===n);o&&(t.classList.toggle("is-active",!!n&&n===f.activeAnnotationId),t.addEventListener("click",i=>{if(i.stopPropagation(),f.pinnedAnnotationId===n){f.pinnedAnnotationId=null,ie(!0);return}f.activeAnnotationId=n,f.pinnedAnnotationId=n;let r=t.getBoundingClientRect();nt(o,r.right+8,r.top+8);let s=j();\$(s||null)}))})}function xs(){let e=T();if(!e.reader)return;let t=Array.from(e.reader.querySelectorAll(".annotation-mark"));for(let n of t){let o=n.parentNode;for(;n.firstChild;)o?.insertBefore(n.firstChild,n);o?.removeChild(n)}}function N(){let e=T();xs();let t=e.reader?Ro(qo(e.reader)):void 0;if(e.reader){let o=t?t.nodes.map(s=>s.nodeValue||"").join(""):ui(e.reader),i=!1,r=[];for(let s of f.annotations){let a=Qo(o,s),c=!1,d=a.status;s.start!==a.start&&(s.start=a.start,i=!0,c=!0),s.length!==a.length&&(s.length=a.length,i=!0,c=!0);let u=ps(s.status,d);(s.status||"anchored")!==u&&(s.status=u,i=!0,c=!0),s.confidence!==a.confidence&&(s.confidence=a.confidence,i=!0,c=!0),c&&r.push({...s,thread:s.thread?[...s.thread]:s.thread})}if(i){let s=j();s&&ci(s,r,"\\u540C\\u6B65\\u8BC4\\u8BBA\\u951A\\u70B9\\u5931\\u8D25")}}let n=[...Nt()].sort((o,i)=>i.start-o.start);for(let o of n)vs(o,t);ks()}function Es(e,t){let n=e.querySelector(".annotation-canvas");if(!n)return;let o=Array.from(n.querySelectorAll(".annotation-item.positioned"));if(o.length===0)return;let i=o.map(u=>u.offsetHeight),r=6,s=0,a=[];for(let u=0;u<o.length;u++){let m=Number(o[u].getAttribute("data-anchor-top")||"0"),p=Number.isFinite(m)?Math.max(0,m):0,g=Math.max(p,s>0?s+r:p);a.push(g),s=g+i[u]}for(let u=0;u<o.length;u++)o[u].style.top=\`\${Math.round(a[u])}px\`;let c=Math.max(0,t),d=Math.ceil(s+24);n.style.height=\`\${Math.max(c,d)}px\`}function \$(e){let t=T();if(!t.annotationList)return;as(),ss();let n=new Map;if(t.annotationList.querySelectorAll("[data-reply-input]").forEach(r=>{let s=r.getAttribute("data-reply-input");s&&r.value.trim()&&n.set(s,r.value)}),!e||f.annotations.length===0){t.annotationList.innerHTML='<div class="annotation-empty">\\u65E0\\u8BC4\\u8BBA\\uFF08\\u9009\\u4E2D\\u6587\\u672C\\u5373\\u53EF\\u6DFB\\u52A0\\uFF09</div>';return}let o=Nt();if(o.length===0){t.annotationList.innerHTML='<div class="annotation-empty">\\u5F53\\u524D\\u7B5B\\u9009\\u4E0B\\u65E0\\u8BC4\\u8BBA</div>';return}let i=(r,s,a=!1,c=0)=>\`
    <div class="annotation-item \${f.activeAnnotationId===r.id?"is-active":""} status-\${Fn(r)}\${ne(r)?" is-resolved":""}\${a?" positioned":""}" data-annotation-id="\${r.id}"\${a?\` data-anchor-top="\${Math.max(0,Math.round(c))}" style="top:\${Math.max(0,Math.round(c))}px"\`:""}>
      ...
      <div class="annotation-thread">\${yi(r,f.density==="simple")}</div>
      \${f.density==="simple"?"":\`
  ...
  \`;if(f.density==="default"){let r=o.map(u=>ws(u.id)),s=0,a=o.map((u,m)=>{let p=r[m]??m*88;return s=Math.max(s,p),i(u,m,!0,p)}).join(""),c=document.getElementById("content"),d=Math.max(c?.scrollHeight||0,s+180);t.annotationList.classList.add("default-mode"),t.annotationList.innerHTML=\`<div class="annotation-canvas" style="height:\${d}px">\${a}</div>\`,Es(t.annotationList,c?.scrollHeight||0),In()}else t.annotationList.classList.remove("default-mode"),t.annotationList.innerHTML=o.map((r,s)=>i(r,s)).join("");t.annotationList.querySelectorAll(".annotation-icon-action").forEach(r=>{r.addEventListener("click",s=>{s.stopPropagation();let a=s.currentTarget,c=a.getAttribute("data-action"),d=a.getAttribute("data-id");!d||!e||(c==="prev"?It(d,-1,e):c==="next"?It(d,1,e):c==="resolve"?xi(d,e):c==="delete"&&vi(d,e))})}),t.annotationList.querySelectorAll("[data-edit-thread-item]").forEach(r=>{r.addEventListener("click",s=>{s.stopPropagation();let a=r.getAttribute("data-edit-thread-item"),c=r.getAttribute("data-annotation-id");!a||!c||!e||Ct(c,a,e)})}),t.annotationList.querySelectorAll("[data-reply-entry]").forEach(r=>{r.addEventListener("click",s=>{s.stopPropagation();let a=r.getAttribute("data-reply-entry");if(!a)return;let c=t.annotationList?.querySelector(\`[data-reply-input="\${a}"]\`);c&&(we(c),c.focus())}),r.addEventListener("keydown",s=>{if(s.target instanceof HTMLTextAreaElement||s.key!=="Enter"&&s.key!==" ")return;s.preventDefault(),s.stopPropagation();let c=r.getAttribute("data-reply-entry");if(!c)return;let d=t.annotationList?.querySelector(\`[data-reply-input="\${c}"]\`);d&&(we(d),d.focus())})}),n.size>0&&t.annotationList.querySelectorAll("[data-reply-input]").forEach(r=>{let s=r.getAttribute("data-reply-input");s&&n.has(s)&&(r.value=n.get(s))}),requestAnimationFrame(()=>{t.annotationList?.querySelectorAll("[data-reply-input]").forEach(r=>{we(r)})}),t.annotationList.querySelectorAll("[data-reply-input]").forEach(r=>{let s=r;s.addEventListener("input",()=>we(s)),s.addEventListener("click",a=>a.stopPropagation()),r.addEventListener("keydown",a=>{if(\$t(a,a.currentTarget)){a.preventDefault();return}if(a.key!=="Enter"||!(a.metaKey||a.ctrlKey))return;a.preventDefault();let c=a.currentTarget,d=c.getAttribute("data-reply-input");!d||!e||(bi(d,e,c.value),c.value="",\$(e))})}),t.annotationList.querySelectorAll(".annotation-item").forEach(r=>{r.addEventListener("click",()=>{let s=r.getAttribute("data-annotation-id");!s||!e||ki(s,e)})})}function Ei(e){let t=T(),n=t.content?.getAttribute("data-current-file");if(!e||!n||e!==n||!t.reader)return;let o=window.getSelection();if(!o||o.rangeCount===0||o.isCollapsed)return;let i=o.getRangeAt(0);if(!t.reader.contains(i.commonAncestorContainer))return;let r=o.toString().trim();if(!r)return;let s=Yo(t.reader,i.startContainer,i.startOffset),a=Yo(t.reader,i.endContainer,i.endOffset);if(s<0||a<=s)return;let c=ui(t.reader),d=32,u=32,m=c.slice(Math.max(0,s-d),s),p=c.slice(a,Math.min(c.length,a+u)),g=i.getBoundingClientRect();ms(g.right+6,g.top-8,{id:\`ann-\${Date.now()}-\${Math.random().toString(16).slice(2,8)}\`,start:s,length:a-s,quote:r,quotePrefix:m,quoteSuffix:p,status:"anchored",confidence:1})}function Ti(){ds(),Ne(!0),document.getElementById("composerSaveBtn")?.addEventListener("click",()=>{let e=j();e&&ni(e)}),document.getElementById("composerCancelBtn")?.addEventListener("click",tt),T().composerNote?.addEventListener("keydown",e=>{if(\$t(e,e.currentTarget)){e.preventDefault();return}if(e.key!=="Enter"||!(e.metaKey||e.ctrlKey))return;e.preventDefault();let t=j();t&&ni(t)}),T().composerNote?.addEventListener("input",e=>{let t=e.currentTarget;wi(t)}),T().quickAdd?.addEventListener("click",e=>{e.stopPropagation(),fs()}),document.getElementById("popoverCloseBtn")?.addEventListener("click",()=>{f.pinnedAnnotationId=null,ie(!0)}),document.getElementById("popoverDeleteBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&vi(t,e)}),document.getElementById("popoverResolveBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&xi(t,e)}),document.getElementById("popoverPrevBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&It(t,-1,e)}),document.getElementById("popoverNextBtn")?.addEventListener("click",()=>{let e=j(),t=f.pinnedAnnotationId;t&&e&&It(t,1,e)}),document.getElementById("annotationPopover")?.addEventListener("click",e=>{let t=e.target,n=j();if(!n)return;let o=t.closest("[data-edit-thread-item]");if(o){e.stopPropagation();let s=o.getAttribute("data-edit-thread-item"),a=o.getAttribute("data-annotation-id");s&&a&&Ct(a,s,n);return}let i=t.closest("[data-popover-reply-entry]");if(i){e.stopPropagation();let s=i.getAttribute("data-popover-reply-entry");if(!s)return;let a=document.querySelector(\`[data-popover-reply-input="\${s}"]\`);if(!a)return;we(a),a.focus();return}t.closest("[data-popover-reply-input]")&&e.stopPropagation()}),document.getElementById("annotationPopover")?.addEventListener("keydown",e=>{let t=e.target;if(t instanceof HTMLTextAreaElement)return;let n=t.closest("[data-popover-reply-entry]");if(!n||e.key!=="Enter"&&e.key!==" ")return;e.preventDefault(),e.stopPropagation();let o=n.getAttribute("data-popover-reply-entry");if(!o)return;let i=document.querySelector(\`[data-popover-reply-input="\${o}"]\`);i&&(we(i),i.focus())}),document.getElementById("annotationPopover")?.addEventListener("keydown",e=>{let t=e.target;if(!(t instanceof HTMLTextAreaElement))return;if(\$t(e,t)){e.preventDefault();return}if(e.key!=="Enter"||!(e.metaKey||e.ctrlKey))return;let n=t.getAttribute("data-popover-reply-input"),o=j();if(!n||!o)return;e.preventDefault(),bi(n,o,t.value),t.value="";let i=f.annotations.find(a=>a.id===n),s=document.querySelector(\`[data-annotation-id="\${n}"]\`)?.getBoundingClientRect();i&&nt(i,s?s.right+8:120,s?s.top+8:120),\$(o)}),document.getElementById("annotationPopover")?.addEventListener("input",e=>{let t=e.target;t instanceof HTMLTextAreaElement&&t.hasAttribute("data-popover-reply-input")&&we(t)}),T().filterMenu?.querySelectorAll(".annotation-filter-item[data-filter]").forEach(e=>{e.addEventListener("click",()=>{let t=e.getAttribute("data-filter");if(!t)return;f.filter=t,T().filterMenu?.classList.add("hidden");let n=j();N(),\$(n||null)})}),T().filterToggle?.addEventListener("click",e=>{e.stopPropagation();let t=T().filterMenu;t&&t.classList.toggle("hidden")}),T().densityToggle?.addEventListener("click",()=>{f.density=f.density==="default"?"simple":"default",localStorage.setItem("md-viewer:annotation-density",f.density);let e=j();\$(e||null)}),T().closeToggle?.addEventListener("click",()=>{ei()}),T().floatingOpenBtn?.addEventListener("click",()=>{Zo()}),T().sidebarResizer?.addEventListener("mousedown",e=>{if(T().sidebar?.classList.contains("collapsed"))return;e.preventDefault();let t=document.documentElement,n=Number(getComputedStyle(t).getPropertyValue("--annotation-sidebar-width").replace("px",""))||ri,o=e.clientX;document.body.classList.add("annotation-sidebar-resizing");let i=s=>{let a=o-s.clientX;gi(n+a),oe()},r=()=>{document.body.classList.remove("annotation-sidebar-resizing"),window.removeEventListener("mousemove",i),window.removeEventListener("mouseup",r)};window.addEventListener("mousemove",i),window.addEventListener("mouseup",r)}),document.getElementById("content")?.addEventListener("scroll",()=>{Be(!1),In(),ti()}),window.addEventListener("resize",()=>{oe(),ti()}),window.openAnnotationSidebar=Zo,window.closeAnnotationSidebar=ei,window.toggleAnnotationSidebar=us,document.addEventListener("mousedown",e=>{let t=e.target,n=T();if(t.closest(".annotation-mark-temp")){hs();return}n.composer&&!n.composer.classList.contains("hidden")&&!n.composer.contains(t)&&!(n.quickAdd&&n.quickAdd.contains(t))&&gs(),n.popover&&!n.popover.contains(t)&&!t.closest(".annotation-mark")&&(f.pinnedAnnotationId=null,ie(!0)),n.filterMenu&&!n.filterMenu.classList.contains("hidden")&&!n.filterMenu.contains(t)&&!t.closest("#annotationFilterToggle")&&n.filterMenu.classList.add("hidden"),n.quickAdd&&!n.quickAdd.classList.contains("hidden")&&!n.quickAdd.contains(t)&&!t.closest("#annotationComposer")&&Be(!0)}),T().composerHeader?.addEventListener("mousedown",e=>{if(e.target.closest(".annotation-row-actions"))return;let t=T().composer;if(!t)return;let n=t.getBoundingClientRect(),o=e.clientX,i=e.clientY,r=n.left,s=n.top;e.preventDefault();let a=d=>{let u=r+(d.clientX-o),m=s+(d.clientY-i);Ln(t,u,m)},c=()=>{window.removeEventListener("mousemove",a),window.removeEventListener("mouseup",c)};window.addEventListener("mousemove",a),window.addEventListener("mouseup",c)})}var ii,ri,Xr,Yr,f,si,Nn=b(()=>{"use strict";zo();me();Go();Ae();Xo();ii="md-viewer:annotation-sidebar-width",ri=320,Xr=260,Yr=540;f={annotations:[],pendingAnnotation:null,pendingAnnotationFilePath:null,pinnedAnnotationId:null,activeAnnotationId:null,currentFilePath:null,filter:"open",density:Zr()},si="md-viewer:annotation-panel-open-by-file"});var F={};ce(F,{renderCurrentPath:()=>Wn,renderFiles:()=>jn,renderSearchBox:()=>Ci,renderSidebar:()=>A,renderTabs:()=>re,setSidebarTab:()=>\$i});function Fi(e){l.currentFile&&(Mi||requestAnimationFrame(()=>{let t=e.querySelector(".file-item.current, .tree-item.current");if(!t)return;let n=t.offsetTop-e.clientHeight*.4,o=Math.max(0,e.scrollHeight-e.clientHeight),i=Math.max(0,Math.min(n,o));e.scrollTo({top:i,behavior:"auto"}),Mi=!0}))}function \$i(e){l.config.sidebarTab=e,H(l.config),A()}function Ts(e){if(!e)return;let t=He.indexOf(e);t>=0&&He.splice(t,1),He.unshift(e),He.length>300&&(He.length=300)}function Li(e){let t=He.indexOf(e);return t>=0?t:Number.MAX_SAFE_INTEGER}function Ms(){D=!D,re()}function Ss(){D&&(D=!1,re())}function As(e){Wt=(e||"").trimStart(),D||(D=!0),re()}function Ls(e){ot=e==="name"?"name":"recent",re()}function Fs(){Si||(Si=!0,document.addEventListener("click",e=>{!D||e.target?.closest(".tab-manager-wrap")||Ss()}))}function \$s(){if(Ai)return;Ai=!0;let e=document.getElementById("tabs");e&&e.addEventListener("scroll",t=>{let n=t.target;n.classList.contains("tabs-scroll")?Pt=n.scrollLeft:n.classList.contains("tab-manager-list")&&(jt=n.scrollTop)},{passive:!0,capture:!0})}function Cs(e){let t=kt(l.sessionFiles),n=Te(e,t,l.currentFile,i=>{let r=t.find(a=>a.path===i);if(!r)return!1;let s=z(r,W(r.path));return s.type==="normal"||s.type==="new"}),o=window.removeFile;if(!o||n.length===0){re();return}n.forEach(i=>o(i))}function Hn(){if(l.config.sidebarTab==="focus"||l.config.sidebarTab==="full"){A();return}jn()}function Is(e){let t=e.trim();return t?!!(/^https?:\\/\\//i.test(t)||t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||t.includes("/")||t.includes("\\\\")||/\\.[a-zA-Z0-9]{1,10}\$/.test(t)):!1}function Ci(){let e=document.getElementById("searchBox");if(!e)return;let t=e.querySelector("#searchInput"),n=e.querySelector("#searchClear"),o=l.config.sidebarTab,i=o==="list"?"\\u641C\\u7D22\\u5DF2\\u6253\\u5F00\\u7684\\u6587\\u4EF6":o==="focus"?"\\u641C\\u7D22\\u7126\\u70B9\\u6587\\u4EF6":"\\u641C\\u7D22\\u6216\\u8F93\\u5165\\u8DEF\\u5F84\\uFF08Enter\\u8865\\u5168\\uFF0CCmd/Ctrl+Enter\\u6DFB\\u52A0\\uFF09";if(!t||!n){if(e.innerHTML=\`
  ...
  \`}function jn(){let e=document.getElementById("fileList");if(!e)return;if(l.sessionFiles.size===0){e.innerHTML='<div class="empty-tip">\\u70B9\\u51FB\\u4E0A\\u65B9\\u6DFB\\u52A0 Markdown/HTML \\u6587\\u4EF6</div>';return}let t=ln();if(t.length===0){e.innerHTML='<div class="empty-tip">\\u672A\\u627E\\u5230\\u5339\\u914D\\u7684\\u6587\\u4EF6</div>';return}let n=new Map(t.map(i=>[i.path,i])),o=kt(n);e.innerHTML=o.map(i=>{let r=i.path===l.currentFile,s=i.isMissing||!1,a=fe(i.path),c=["file-item",r?"current":"",s?"deleted":""].filter(Boolean).join(" "),d=i.displayName||i.name,u=l.searchQuery.toLowerCase().trim();if(u){let g=d.toLowerCase().indexOf(u);if(g!==-1){let y=d.substring(0,g),h=d.substring(g,g+u.length),k=d.substring(g+u.length);d=\`\${y}<mark class="search-highlight">\${h}</mark>\${k}\`}}let m=z(i,W(i.path)),p="&nbsp;";return m.badge==="dot"?p='<span class="new-dot"></span>':m.badge&&(p=\`<span class="status-badge status-\${m.type}" style="color: \${m.color}">\${m.badge}</span>\`),\`
      <div class="\${c}"
...
}\`});var qn,Ji=b(()=>{"use strict";it();qn=je});var Ui,Vi=b(()=>{"use strict";it();Ui=je+\`
...
\`});var Gi,Qi=b(()=>{"use strict";it();Gi=je+\`
...
\`});var zn,Xi=b(()=>{"use strict";it();zn=Ki});var Yi,Zi=b(()=>{"use strict";Yi=\`
...
\`});function nr(e){return _n.find(t=>t.key===e)?.css??qn}function or(e){return Kn.find(t=>t.key===e)?.css??zn}var _n,Kn,Jn=b(()=>{"use strict";Ji();Vi();Qi();Xi();Zi();tr();_n=[{key:"github",label:"GitHub",css:qn},{key:"notion",label:"Notion",css:Ui},{key:"bear",label:"Bear / iA Writer",css:Gi}],Kn=[{key:"github",label:"GitHub Light",css:zn},{key:"github-dark",label:"GitHub Dark",css:Yi},{key:"atom-one-dark",label:"Atom One Dark",css:er}]});function rr(){qt=l.config.markdownTheme||"github",Un=l.config.codeTheme||"github",Vn=l.config.mathInline!==!1,document.getElementById("settingsDialogOverlay")||Vs(),Gs();let t=document.getElementById("settingsDialogOverlay");t&&t.classList.add("show")}function Vs(){let e=document.createElement("div");e.id="settingsDialogOverlay",e.className="sync-dialog-overlay",e.innerHTML=\`
  ...
  \`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&rt()})}function Gs(){let e=document.getElementById("settingsDialogBody");if(!e)return;let t=Xs();e.innerHTML=\`
    ...
    <div class="settings-section">
      ...
      <div class="settings-kv-grid">
        <div>\\u5F53\\u524D\\u6587\\u4EF6</div><div>\${ir(t.currentFile||"\\u65E0")}</div>
      ...
      <div class="settings-key-list">
        \${t.mdvKeys.map(s=>\`<span class="settings-key-chip">\${ir(s)}</span>\`).join("")}
      </div>
    </div>
    <div class="settings-section">
...
\${c}\`:c;if(m)try{let p=\`mdv-mermaid-\${Date.now()}-\${r}\`,{svg:g,bindFunctions:y}=await t.render(p,m),h=document.createElement("div");h.className="mermaid-block";let k=document.createElement("div");k.className="mermaid-actions";let{panel:E,toggleButton:x}=i(m,!1);k.appendChild(x);let M=document.createElement("div");M.className="mermaid",M.setAttribute("data-mdv-mermaid","1"),M.innerHTML=g,h.appendChild(k),h.appendChild(M),h.appendChild(E),a.replaceWith(h),typeof y=="function"&&y(M)}catch(p){let g=document.createElement("div");g.className="mermaid-fallback-block";let y=document.createElement("div");y.className="mermaid-actions";let{panel:h,toggleButton:k}=i(m,!0);y.appendChild(k);let E=document.createElement("div");E.className="mermaid-fallback-notice",E.textContent="Mermaid \\u8BED\\u6CD5\\u9519\\u8BEF\\uFF0C\\u5DF2\\u56DE\\u9000\\u4E3A\\u539F\\u6587\\u663E\\u793A",g.appendChild(y),g.appendChild(E),g.appendChild(h),a.replaceWith(g),console.error("Mermaid \\u6E32\\u67D3\\u5931\\u8D25\\uFF0C\\u5DF2\\u56DE\\u9000\\u539F\\u6587:",p)}}}function U(){let e=document.getElementById("content");if(!e)return;if(!l.currentFile){e.removeAttribute("data-current-file"),e.innerHTML=\`
  ...
  \`}async function Fa(){if(!l.currentFile)return;let e=l.sessionFiles.get(l.currentFile);if(!e)return;if(se){xr();return}let t=await Aa(l.currentFile);if(t===null)return;se=!0;let n=document.getElementById("diffButton");n&&n.classList.add("active"),La(e.content,t)}function xr(){se=!1;let e=document.getElementById("diffButton");e&&e.classList.remove("active"),U()}async function \$a(){if(!l.currentFile)return;let e=l.sessionFiles.get(l.currentFile);!e||e.pendingContent===void 0||(e.content=e.pendingContent,e.pendingContent=void 0,e.displayedModified=e.lastModified,q(),se=!1,U(),ke(!1),hr(),A(),await ve())}async function ve(){let e=document.getElementById("diffButton"),t=document.getElementById("refreshButton");if(!l.currentFile){e&&(e.style.display="none"),t&&(t.style.display="none");return}let n=l.sessionFiles.get(l.currentFile);if(!n)return;if(n.isMissing){e&&(e.style.display="none"),t&&(t.style.display="none");return}let o=n.lastModified>n.displayedModified;e&&(e.style.display=o&&!n.isRemote?"flex":"none"),t&&(t.style.display=o?"flex":"none")}async function Ca(){l.currentFile&&await gr(l.currentFile)}function Ia(e){return e?.target?e.target.closest(".copy-filename-button, .sync-dialog-copy-btn, .sync-dialog-btn"):null}function Na(e,t){if(!e)return;if(e.classList.contains("copy-filename-button")){e.classList.add("success");let o=e.querySelector(".copy-tooltip"),i=o?.textContent;o&&(o.textContent=t||"\\u5DF2\\u590D\\u5236"),setTimeout(()=>{e.classList.remove("success"),o&&i&&(o.textContent=i)},1e3);return}let n=e.textContent;e.textContent="\\u2713 \\u5DF2\\u590D\\u5236",setTimeout(()=>{n!=null&&(e.textContent=n)},1e3)}function no(e,t,n){navigator.clipboard.writeText(e).then(()=>{Na(Ia(t),n)}).catch(()=>{S("\\u590D\\u5236\\u5931\\u8D25")})}function Ba(e,t){no(e,t)}function Er(e,t){if(t instanceof MouseEvent&&t.altKey){no(e,t,"\\u5DF2\\u590D\\u5236\\u7EDD\\u5BF9\\u8DEF\\u5F84");return}let o=l.config.workspaces,i=e;for(let r of o){let s=r.path.replace(/\\/+\$/,"");if(e===s||e.startsWith(s+"/")){i=e.slice(s.length+1);break}}no(i,t,"\\u5DF2\\u590D\\u5236\\u76F8\\u5BF9\\u8DEF\\u5F84")}function Ha(e,t){Er(e,t)}function Wa(){let e=localStorage.getItem("fontScale");e&&(De=parseFloat(e)),Tr()}function Tr(){document.documentElement.style.setProperty("--font-scale",De.toString()),Mr(),localStorage.setItem("fontScale",De.toString())}function Mr(){let e=document.getElementById("fontScaleText");if(e){let o=Math.round(De*100);e.textContent=\`\${o}%\`}let t=document.querySelectorAll(".font-scale-option");t.forEach(o=>{o.classList.remove("active")});let n=Math.round(De*100);t.forEach(o=>{o.textContent?.trim()===\`\${n}%\`&&o.classList.add("active")})}function ja(e){De=e,Tr(),io()}function Pa(){let e=document.getElementById("fontScaleMenu");if(!e)return;e.style.display!=="none"?io():(e.style.display="block",Mr())}function io(){let e=document.getElementById("fontScaleMenu");e&&(e.style.display="none")}function Sr(){let e=new EventSource("/api/events");e.addEventListener("file-changed",async t=>{let n=JSON.parse(t.data),o=Ee(n.path);o?(o.lastModified=n.lastModified,o.isMissing&&(o.isMissing=!1,V(n.path)),q()):Yt(n.path),A(),await ve()}),e.addEventListener("file-deleted",async t=>{let n=JSON.parse(t.data),o=Ee(n.path);o?(o.isMissing=!0,q()):ue(n.path),A(),l.currentFile===n.path&&(U(),ve(),S("\\u6587\\u4EF6\\u5DF2\\u4E0D\\u5B58\\u5728"))}),e.addEventListener("file-opened",async t=>{let n=JSON.parse(t.data);await mr(n,n.focus!==!1)}),e.addEventListener("state-request",async t=>{let o=JSON.parse(t.data).requestId;if(!o)return;let i=Array.from(l.sessionFiles.values()).map(r=>({path:r.path,name:r.name}));try{await fetch("/api/session-state",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({requestId:o,currentFile:l.currentFile,openFiles:i})})}catch(r){console.error("\\u54CD\\u5E94\\u72B6\\u6001\\u8BF7\\u6C42\\u5931\\u8D25:",r)}}),e.onerror=()=>{console.error("SSE \\u8FDE\\u63A5\\u65AD\\u5F00\\uFF0C\\u5C1D\\u8BD5\\u91CD\\u8FDE..."),e.close(),setTimeout(Sr,3e3)}}function Da(){window.setInterval(async()=>{if(Xn||l.config.sidebarTab==="list")return;let e=l.config.sidebarTab==="focus"?l.config.workspaces:l.config.workspaces.filter(t=>t.isExpanded);if(e.length!==0){Xn=!0;try{for(let t of e)await K(t.id);A()}finally{Xn=!1}}},1500)}function Ra(){let e=document.createElement("div");e.id="findBar",e.innerHTML=\`
  ...
  \`,document.body.appendChild(e);let t=document.getElementById("findBarInput"),n=document.getElementById("findBarCount"),o=document.getElementById("findBarPrev"),i=document.getElementById("findBarNext"),r=document.getElementById("findBarClose"),s=[],a=-1,c=null;function d(){c&&c.querySelectorAll("mark.find-highlight").forEach(x=>{let M=x.parentNode;M&&(M.replaceChild(document.createTextNode(x.textContent||""),x),M.normalize())}),s=[],a=-1,n.textContent=""}function u(x){return x.replace(/[.*+?^\${}()|[\\]\\\\]/g,"\\\\\$&")}function m(x){if(d(),!x)return;let M=document.getElementById("content");if(!M)return;c=M;let C=new RegExp(u(x),"gi"),B=document.createTreeWalker(M,NodeFilter.SHOW_TEXT,{acceptNode(ae){let R=ae.parentElement;if(!R)return NodeFilter.FILTER_REJECT;let O=R.tagName.toLowerCase();return O==="script"||O==="style"||O==="mark"?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),lt=[],ct;for(;ct=B.nextNode();)lt.push(ct);for(let ae of lt){let R=ae.textContent||"",O,Oe=[],qe=0;for(C.lastIndex=0;(O=C.exec(R))!==null;){O.index>qe&&Oe.push(R.slice(qe,O.index));let le=document.createElement("mark");le.className="find-highlight",le.textContent=O[0],Oe.push(le),s.push(document.createRange()),qe=O.index+O[0].length}if(Oe.length===0)continue;qe<R.length&&Oe.push(R.slice(qe));let _t=document.createDocumentFragment();Oe.forEach(le=>{typeof le=="string"?_t.appendChild(document.createTextNode(le)):_t.appendChild(le)}),ae.parentNode.replaceChild(_t,ae)}s=[],M.querySelectorAll("mark.find-highlight").forEach(ae=>{let R=document.createRange();R.selectNode(ae),s.push(R)}),s.length>0&&(a=0,p(0)),g()}function p(x){let M=document.getElementById("content");if(!M)return;let C=M.querySelectorAll("mark.find-highlight");C.forEach((lt,ct)=>{lt.classList.toggle("find-highlight-current",ct===x)});let B=C[x];B&&B.scrollIntoView({block:"center",behavior:"smooth"})}function g(){s.length===0?(n.textContent=t.value?"\\u65E0\\u7ED3\\u679C":"",n.className=t.value?"no-result":""):(n.textContent=\`\${a+1} / \${s.length}\`,n.className="")}function y(){s.length!==0&&(a=(a+1)%s.length,p(a),g())}function h(){s.length!==0&&(a=(a-1+s.length)%s.length,p(a),g())}function k(){e.classList.add("visible"),t.focus(),t.select(),t.value&&m(t.value)}function E(){e.classList.remove("visible"),d()}window.__showFindBar=k,t.addEventListener("input",()=>m(t.value)),t.addEventListener("keydown",x=>{x.key==="Enter"?(x.shiftKey?h():y(),x.preventDefault()):x.key==="Escape"&&(E(),x.preventDefault())}),o.addEventListener("click",h),i.addEventListener("click",y),r.addEventListener("click",E)}var Zn,eo,pr,sa,Qn,se,Xn,cr,J,De,ye=b(()=>{I();X();Ze();ge();me();zi();_i();L();Ae();sr();lr();Jn();Nn();Zn="md-viewer:sidebar-width",eo=260,pr=220,sa=680,Qn=new Map,se=!1,Xn=!1,cr=!1;J=null;De=1;document.addEventListener("click",e=>{let t=document.getElementById("fontScaleMenu"),n=document.getElementById("fontScaleButton");if(!t||!n)return;let o=e.target;!t.contains(o)&&!n.contains(o)&&io()});window.addFile=()=>{let e=document.getElementById("searchInput");e&&vr(e.value).catch(t=>{S(\`\\u6DFB\\u52A0\\u5931\\u8D25: \${t?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)})};window.handleUnifiedInputSubmit=e=>{let t=document.getElementById("searchInput"),n=(typeof e=="string"?e:t?.value||"").trim();if(n){if(!ka(n)){Ea(n).catch(o=>{S(\`\\u641C\\u7D22\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)});return}vr(n).catch(o=>{S(\`\\u6DFB\\u52A0\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)})}};window.dismissQuickActionConfirm=()=>{wr()&&at()};window.switchFile=xa;window.removeFile=kr;window.showNearbyMenu=ya;window.addFileByPath=Re;window.refreshFile=gr;window.handleRefreshButtonClick=Ca;window.handleDiffButtonClick=Fa;window.closeDiffView=xr;window.acceptDiffUpdate=\$a;window.copySingleText=Ba;window.copyFileName=Ha;window.copyFilePath=Er;window.showToast=Se;window.showSettingsDialog=rr;window.toggleFontScaleMenu=Pa;window.setFontScale=ja;window.openExternalFile=va;window.renderContent=U;window.applyTheme=ur;(async()=>(la(),Wa(),Ti(),oe(),window.addEventListener("resize",()=>{oe()}),await on(Le),ur(),await Dn(),Da(),A(),U(),ke(!0),Ta(),ca(),document.addEventListener("click",e=>{if(!wr())return;let t=e.target;t&&(t.closest(".sidebar-header")||t.closest("#quickActionConfirm")||at())}),Sa(),Ma(),document.addEventListener("mouseup",()=>{setTimeout(()=>{let e=document.getElementById("content")?.getAttribute("data-current-file")||null;Ei(e)},0)}),await da(),Sr(),Ra()))()});ye();})();
