...
## 支持flowchart [✅完成 - 2026-03-01]
- 实现：`flowchart` fenced code block 作为 Mermaid 流程图渲染（兼容 `mermaid` fenced）。
- 验证用例：`tests/e2e/cases/case-20/`

## FileWatcher的测试计划（进行中）
- 什么时候扫描工作区下所目录，还是watcher有系统调用支持？

## 状态复杂度打分表

## 该重构了吗

## 快速扫描基研的所有工具：https://km.sankuai.com/space/itudoc
- 不要过深，只需要知道是什么，用在什么场景，大概有哪些开放（Open）能力
- 给分组、从文档内容、更新时间、丰富度等多维信息，判断产品热度和成熟度
