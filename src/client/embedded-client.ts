...
export const EMBEDDED_CLIENT_JS = `"use strict";(()=>{var ki=Object.defineProperty;var x=(e,t)=>()=>(e&&(t=e(e=0)),t);var le=(e,t)=>{for(var n in t)ki(e,n,{get:t[n],enumerable:!0})};var no={};le(no,{defaultConfig:()=>ct,loadConfig:()=>dt,saveConfig:()=>H,updateConfig:()=>xi});function dt(){try{let e=localStorage.getItem(to);if(!e)return{...ct};let t=JSON.parse(e);return{...ct,...t}}catch(e){return console.error("\\u52A0\\u8F7D\\u914D\\u7F6E\\u5931\\u8D25:",e),{...ct}}}function H(e){try{localStorage.setItem(to,JSON.stringify(e))}catch(t){console.error("\\u4FDD\\u5B58\\u914D\\u7F6E\\u5931\\u8D25:",t)}}function xi(e){let n={...dt(),...e};return H(n),n}var to,ct,xe=x(()=>{"use strict";to="md-viewer:config",ct={sidebarTab:"focus",focusWindowKey:"8h",markdownTheme:"github",codeTheme:"github",workspaces:[]}});function ro(){try{localStorage.setItem(oo,JSON.stringify(Array.from(ce.entries()).map(([e,t])=>[e,Array.from(t)])))}catch(e){console.error("\\u4FDD\\u5B58\\u5217\\u8868\\u5DEE\\u5F02\\u72B6\\u6001\\u5931\\u8D25:",e)}}function io(){ce.clear();try{let e=localStorage.getItem(oo);if(!e)return;let t=JSON.parse(e);if(!Array.isArray(t))return;for(let n of t){if(!Array.isArray(n)||n.length!==2)continue;let o=n[0],r=n[1];typeof o!="string"||!Array.isArray(r)||ce.set(o,new Set(r.filter(i=>typeof i=="string"&&i.length>0)))}}catch(e){console.error("\\u6062\\u590D\\u5217\\u8868\\u5DEE\\u5F02\\u72B6\\u6001\\u5931\\u8D25:",e)}}function ao(e){return ce.get(e)}function zt(e,t){ce.set(e,t),ro()}function so(e){let t=ce.get(e);return ce.delete(e),ro(),t}var oo,ce,lo=x(()=>{"use strict";oo="md-viewer:workspaceKnownFiles",ce=new Map});function de(e){ut.add(e)}function ue(e){ut.delete(e)}function _t(e){return ut.has(e)}function Kt(e){let t=Array.from(ut.values());if(!e)return t;let n=\`\${e.replace(/\\/+\$/,"")}/\`;return t.filter(o=>o.startsWith(n))}var ut,Jt=x(()=>{"use strict";ut=new Set});function Ut(){try{let e=Array.from(V.entries()).map(([t,n])=>[t,Array.from(n.entries())]);localStorage.setItem(co,JSON.stringify(e))}catch(e){console.error("\\u4FDD\\u5B58\\u5DE5\\u4F5C\\u533A\\u76EE\\u5F55\\u5C55\\u5F00\\u72B6\\u6001\\u5931\\u8D25:",e)}}function uo(){V.clear();try{let e=localStorage.getItem(co);if(!e)return;let t=JSON.parse(e);if(!Array.isArray(t))return;for(let n of t){if(!Array.isArray(n)||n.length!==2)continue;let o=n[0],r=n[1];if(typeof o!="string"||!Array.isArray(r))continue;let i=new Map;for(let a of r){if(!Array.isArray(a)||a.length!==2)continue;let s=a[0],c=a[1];typeof s!="string"||typeof c!="boolean"||i.set(s,c)}i.size>0&&V.set(o,i)}}catch(e){console.error("\\u6062\\u590D\\u5DE5\\u4F5C\\u533A\\u76EE\\u5F55\\u5C55\\u5F00\\u72B6\\u6001\\u5931\\u8D25:",e)}}function po(e){return V.get(e)}function pt(e,t){if(t.size===0){V.delete(e),Ut();return}V.set(e,new Map(t)),Ut()}function mo(e){V.has(e)&&(V.delete(e),Ut())}function mt(e){let t=new Map,n=o=>{if(o.type==="directory"){typeof o.isExpanded=="boolean"&&t.set(o.path,o.isExpanded);for(let r of o.children||[])n(r)}};return n(e),t}var co,V,Vt=x(()=>{"use strict";co="md-viewer:workspaceTreeExpandedState",V=new Map});function W(e){return G.has(e)}function Gt(e){G.add(e)}function P(e){G.has(e)&&G.delete(e)}function ze(e){return qe.has(e)}function Qt(e){qe.add(e)}function ft(e){qe.delete(e)}function Xt(){G.clear(),qe.clear(),io(),uo()}function Yt(e,t){let n=new Set(t),o=ao(e);if(!o){zt(e,n);return}for(let r of n)o.has(r)||G.add(r),ue(r);for(let r of o)n.has(r)||(G.delete(r),de(r));zt(e,n)}function Zt(e){let t=so(e);if(t)for(let n of t)G.delete(n),qe.delete(n)}var G,qe,fo=x(()=>{"use strict";lo();Jt();Vt();G=new Set,qe=new Set});var Q=x(()=>{"use strict";fo();Jt()});var pe={};le(pe,{addOrUpdateFile:()=>nn,getFilteredFiles:()=>an,getSessionFile:()=>Ee,getSessionFiles:()=>en,hasSessionFile:()=>yt,markFileMissing:()=>Ei,removeFile:()=>on,restoreState:()=>tn,saveState:()=>q,setSearchQuery:()=>X,state:()=>l,switchToFile:()=>rn});function Ee(e){return l.sessionFiles.get(e)}function yt(e){return l.sessionFiles.has(e)}function en(){return Array.from(l.sessionFiles.values())}function q(){try{let e={files:Array.from(l.sessionFiles.entries()).map(([t,n])=>[t,{path:n.path,name:n.name,isRemote:n.isRemote||!1,isMissing:n.isMissing||!1,displayedModified:n.displayedModified,lastAccessed:n.lastAccessed||Date.now()}]),currentFile:l.currentFile};localStorage.setItem(ht,JSON.stringify(e))}catch(e){if(e.name==="QuotaExceededError"||e.code===22){console.warn("localStorage \\u914D\\u989D\\u5DF2\\u6EE1\\uFF0C\\u6267\\u884C\\u6E05\\u7406..."),go();try{let t={files:Array.from(l.sessionFiles.entries()).map(([n,o])=>[n,{path:o.path,name:o.name,isRemote:o.isRemote||!1,isMissing:o.isMissing||!1,displayedModified:o.displayedModified,lastAccessed:o.lastAccessed||Date.now()}]),currentFile:l.currentFile};localStorage.setItem(ht,JSON.stringify(t))}catch(t){console.error("\\u4FDD\\u5B58\\u72B6\\u6001\\u5931\\u8D25\\uFF08\\u91CD\\u8BD5\\u540E\\uFF09:",t)}}else console.error("\\u4FDD\\u5B58\\u72B6\\u6001\\u5931\\u8D25:",e)}}function go(){if(l.sessionFiles.size<=gt)return;let e=Array.from(l.sessionFiles.entries()).sort((o,r)=>(r[1].lastAccessed||r[1].lastModified||0)-(o[1].lastAccessed||o[1].lastModified||0)),t=e.slice(0,gt),n=e.slice(gt);l.sessionFiles.clear(),t.forEach(([o,r])=>{l.sessionFiles.set(o,r)}),console.log(\`\\u5DF2\\u6E05\\u7406 \${n.length} \\u4E2A\\u65E7\\u6587\\u4EF6\`)}async function tn(e){try{Xt();let t=localStorage.getItem(ht);if(!t)return;let n=JSON.parse(t);if(!n.files||n.files.length===0)return;let o=[];for(let[r,i]of n.files){let a=await e(r,!0);if(a){let s=i.displayedModified||a.lastModified;l.sessionFiles.set(r,{path:a.path,name:a.filename,content:a.content,lastModified:a.lastModified,displayedModified:s,isRemote:a.isRemote||!1,isMissing:!1,lastAccessed:i.lastAccessed||a.lastModified}),o.push([r,i])}}if(o.length!==n.files.length){let r=l.sessionFiles.has(n.currentFile)?n.currentFile:null;localStorage.setItem(ht,JSON.stringify({files:o,currentFile:r}))}if(n.currentFile&&l.sessionFiles.has(n.currentFile))l.currentFile=n.currentFile;else{let r=Array.from(l.sessionFiles.values())[0];l.currentFile=r?r.path:null}}catch(t){console.error("\\u6062\\u590D\\u72B6\\u6001\\u5931\\u8D25:",t)}}function nn(e,t=!1){l.sessionFiles.size>=gt&&!l.sessionFiles.has(e.path)&&go();let n=l.sessionFiles.get(e.path),o=!n,r=n&&n.lastModified>n.displayedModified?n.displayedModified:e.lastModified;l.sessionFiles.set(e.path,{path:e.path,name:e.filename,content:e.content,lastModified:e.lastModified,displayedModified:r,isRemote:e.isRemote||!1,isMissing:!1,lastAccessed:Date.now()}),t&&(l.currentFile=e.path,P(e.path)),ue(e.path),o&&(t||Gt(e.path)),q()}function on(e){let n=Array.from(l.sessionFiles.keys()).indexOf(e);if(l.sessionFiles.delete(e),P(e),ue(e),l.currentFile===e){let o=Array.from(l.sessionFiles.values());l.currentFile=o.length>0?o[Math.max(0,n-1)].path:null}q()}function rn(e){l.currentFile=e;let t=l.sessionFiles.get(e);t&&(t.lastAccessed=Date.now()),P(e),ue(e),q()}function Ei(e,t=!1){let n=l.sessionFiles.get(e),o=Date.now(),r=e.split("/").pop()||n?.name||e;l.sessionFiles.set(e,{path:e,name:r,content:n?.content||\`# \\u6587\\u4EF6\\u5DF2\\u5220\\u9664

\\u8BE5\\u6587\\u4EF6\\u5DF2\\u4ECE\\u78C1\\u76D8\\u5220\\u9664\\uFF0C\\u4E14\\u5F53\\u524D\\u65E0\\u672C\\u5730\\u7F13\\u5B58\\u5185\\u5BB9\\u3002\`,lastModified:n?.lastModified||o,displayedModified:n?.displayedModified||o,isRemote:n?.isRemote||!1,isMissing:!0}),t&&(l.currentFile=e,P(e)),de(e),q()}function X(e){l.searchQuery=e}function an(){let e=l.searchQuery.toLowerCase().trim();return e?Array.from(l.sessionFiles.values()).filter(t=>t.name.toLowerCase().includes(e)||t.path.toLowerCase().includes(e)):Array.from(l.sessionFiles.values())}var l,ht,gt,N=x(()=>{"use strict";xe();Q();l={sessionFiles:new Map,currentFile:null,searchQuery:"",config:dt(),currentWorkspace:null,fileTree:new Map},ht="md-viewer:openFiles",gt=100});function ho(e,t){let n=yo(e);n.size!==0&&bt(t,n)}function yo(e,t=new Map){if(e.type!=="directory")return t;typeof e.isExpanded=="boolean"&&t.set(e.path,e.isExpanded);for(let n of e.children||[])yo(n,t);return t}function bt(e,t){if(e.type==="directory"){let n=t.get(e.path);typeof n=="boolean"&&(e.isExpanded=n)}for(let n of e.children||[])bt(n,t)}var bo=x(()=>{"use strict"});var xo={};le(xo,{addWorkspace:()=>wt,getCurrentWorkspace:()=>Li,hydrateExpandedWorkspaces:()=>cn,inferWorkspaceFromPath:()=>Fi,moveWorkspaceByOffset:()=>vt,removeWorkspace:()=>sn,revealFileInWorkspace:()=>dn,scanWorkspace:()=>z,switchWorkspace:()=>Ai,toggleNodeExpanded:()=>un,toggleWorkspaceExpanded:()=>ln});function Ti(){return\`ws-\${Date.now()}-\${Math.random().toString(36).substr(2,9)}\`}function Te(e){return e.trim().replace(/\\/+\$/,"")}function Si(e){let t=Te(e),n=null;for(let o of l.config.workspaces){let r=Te(o.path);(t===r||t.startsWith(\`\${r}/\`))&&(!n||r.length>Te(n.path).length)&&(n=o)}return n}function Mi(e,t,n){let o=l.fileTree.get(e);if(!o)return;let r=Te(t),i=Te(n);if(!(i===r||i.startsWith(\`\${r}/\`)))return;let s=(i===r?"":i.slice(r.length+1)).split("/").filter(Boolean);if(s.length<=1)return;let c=!1,d=r;for(let u=0;u<s.length-1;u+=1){d=\`\${d}/\${s[u]}\`;let m=pn(o,d);m&&m.type==="directory"&&m.isExpanded===!1&&(m.isExpanded=!0,c=!0)}c&&pt(e,mt(o))}function wt(e,t){let n=Te(t),o=l.config.workspaces.find(i=>i.path===n);if(o)return l.currentWorkspace=o.id,l.fileTree.delete(o.id),o;let r={id:Ti(),name:e,path:n,isExpanded:!1};return l.config.workspaces.push(r),H(l.config),l.currentWorkspace=r.id,r}function sn(e){let t=l.config.workspaces.findIndex(n=>n.id===e);t!==-1&&(l.config.workspaces.splice(t,1),H(l.config),l.fileTree.delete(e),Zt(e),mo(e),l.currentWorkspace===e&&(l.currentWorkspace=l.config.workspaces.length>0?l.config.workspaces[0].id:null))}function Ai(e){l.config.workspaces.find(n=>n.id===e)&&(l.currentWorkspace=e)}function vt(e,t){let n=l.config.workspaces,o=n.findIndex(a=>a.id===e);if(o===-1)return;let r=o+t;if(r<0||r>=n.length)return;let[i]=n.splice(o,1);n.splice(r,0,i),H(l.config)}function ln(e){let t=l.config.workspaces.find(n=>n.id===e);t&&(t.isExpanded=!t.isExpanded,H(l.config))}function Li(){return l.currentWorkspace&&l.config.workspaces.find(e=>e.id===l.currentWorkspace)||null}async function Fi(e){try{let t=await fetch("/api/infer-workspace",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({filePath:e})});if(!t.ok)return null;let n=await t.json();if(!n.workspacePath)return null;let o=l.config.workspaces.find(i=>i.path===n.workspacePath);if(o)return o;let r=n.workspaceName||n.workspacePath.split("/").pop()||"workspace";return wt(r,n.workspacePath)}catch(t){return console.error("\\u63A8\\u65AD\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25:",t),null}}async function z(e){let t=l.config.workspaces.find(n=>n.id===e);if(!t)return null;try{let n=new AbortController,o=window.setTimeout(()=>n.abort(),15e3),r=await fetch("/api/scan-workspace",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:t.path}),signal:n.signal});if(window.clearTimeout(o),!r.ok)return console.error("\\u626B\\u63CF\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25:",await r.text()),null;let i=await r.json(),a=l.fileTree.get(e),s=po(e),c=!a&&(!s||s.size===0);return a?ho(a,i):s&&s.size>0?bt(i,s):(vo(i),\$i(i,2)),l.fileTree.set(e,i),pt(e,mt(i)),Yt(e,wo(i)),i}catch(n){return console.error("\\u626B\\u63CF\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25:",n),null}}function wo(e){if(!e)return[];if(e.type==="file")return[e.path];let t=[];for(let n of e.children||[])t.push(...wo(n));return t}function vo(e){if(e.type==="directory")for(let t of e.children||[])t.type==="directory"&&(t.isExpanded=!1,vo(t))}function ko(e,t=[]){if(e.type==="file")t.push(e);else for(let n of e.children||[])ko(n,t);return t}function Ci(e,t){function n(o){if(o.type==="file")return o.path===t;for(let r of o.children||[])if(n(r))return o.isExpanded=!0,!0;return!1}n(e)}function \$i(e,t){let n=ko(e);n.sort((i,a)=>(a.lastModified||0)-(i.lastModified||0));let o=n.slice(0,t),r=new Set;for(let i of o){let a=i.path.substring(0,i.path.lastIndexOf("/"));r.has(a)||(r.add(a),Ci(e,i.path))}}async function cn(){let e=l.config.workspaces.filter(t=>t.isExpanded);for(let t of e)await z(t.id);!l.currentWorkspace&&l.config.workspaces.length>0&&(l.currentWorkspace=l.config.workspaces[0].id)}async function dn(e){let t=Si(e);t&&(l.currentWorkspace=t.id,t.isExpanded||(t.isExpanded=!0,H(l.config)),l.fileTree.has(t.id)||await z(t.id),Mi(t.id,t.path,e))}function un(e,t){let n=l.fileTree.get(e);if(!n)return;let o=pn(n,t);if(o&&o.type==="directory"){let r=o.isExpanded!==!1;o.isExpanded=!r,pt(e,mt(n))}}function pn(e,t){if(e.path===t)return e;if(e.children)for(let n of e.children){let o=pn(n,t);if(o)return o}return null}var _e=x(()=>{"use strict";N();Q();xe();bo();Vt()});function Ni(){Se||(Se=document.createElement("div"),Se.id="toast-container",Se.className="toast-container",document.body.appendChild(Se))}function Me(e){let t=typeof e=="string"?{message:e,type:"info",duration:3e3}:{type:"info",duration:3e3,...e};Ni();let n=document.createElement("div");n.className=\`toast toast-\${t.type}\`;let o={success:"\\u2713",error:"\\u2717",warning:"\\u26A0",info:"\\u2139"};return n.innerHTML=\`
    <span class="toast-icon">\${o[t.type]}</span>
    <span class="toast-message">\${t.message}</span>
  \`,Se.appendChild(n),requestAnimationFrame(()=>{n.classList.add("toast-show")}),t.duration&&t.duration>0&&setTimeout(()=>{Eo(n)},t.duration),n.addEventListener("click",()=>{Eo(n)}),n}function Eo(e){e.classList.remove("toast-show"),e.classList.add("toast-hide"),setTimeout(()=>{e.remove()},300)}function _(e,t){return Me({message:e,type:"success",duration:t})}function M(e,t){return Me({message:e,type:"error",duration:t})}function To(e,t){return Me({message:e,type:"warning",duration:t})}function mn(e,t){return Me({message:e,type:"info",duration:t})}var Se,Ae=x(()=>{"use strict";Se=null});var kt={};le(kt,{detectPathType:()=>hn,getNearbyFiles:()=>fn,getPathSuggestions:()=>gn,loadFile:()=>Le,openFile:()=>yn,searchFiles:()=>Ke});async function Le(e,t=!1){try{let o=await(await fetch(\`/api/file?path=\${encodeURIComponent(e)}\`)).json();return o.error?(t||M(o.error),null):o}catch(n){return t||M(\`\\u52A0\\u8F7D\\u5931\\u8D25: \${n.message}\`),null}}async function Ke(e,t={}){let n=new URLSearchParams({query:e});t.limit&&Number.isFinite(t.limit)&&n.set("limit",String(t.limit));for(let r of t.roots||[])r.trim()&&n.append("root",r.trim());return(await fetch(\`/api/files?\${n.toString()}\`)).json()}async function fn(e){return(await fetch(\`/api/nearby?path=\${encodeURIComponent(e)}\`)).json()}async function gn(e,t={}){let n=t.kind||"file",o=t.markdownOnly!==!1,r=new URLSearchParams({input:e,kind:n,markdownOnly:o?"true":"false"});return(await fetch(\`/api/path-suggestions?\${r.toString()}\`)).json()}async function hn(e){return(await fetch("/api/detect-path",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:e})})).json()}async function yn(e,t=!0){await fetch("/api/open",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:e,focus:t})})}var me=x(()=>{"use strict";Ae()});function b(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;"):""}function w(e){return b(e)}var fe=x(()=>{"use strict"});function So(e,t){let n=e.split(\`
\`),o=t.split(\`
\`),r=n.length,i=o.length;if(r===0&&i===0)return[];let a=r+i,s=new Array(2*a+1).fill(0),c=[];e:for(let h=0;h<=a;h++){c.push([...s]);for(let v=-h;v<=h;v+=2){let E=v+a,k;v===-h||v!==h&&s[E-1]<s[E+1]?k=s[E+1]:k=s[E-1]+1;let S=k-v;for(;k<r&&S<i&&n[k]===o[S];)k++,S++;if(s[E]=k,k>=r&&S>=i)break e}}let d=[],u=r,m=i;for(let h=c.length-1;h>=0&&(u>0||m>0);h--){let v=c[h],E=u-m,k=E+a,S;E===-h||E!==h&&v[k-1]<v[k+1]?S=E+1:S=E-1;let \$=v[S+a],I=\$-S;for(;u>\$+1&&m>I+1;)d.unshift({type:"equal",x:u-1,y:m-1}),u--,m--;h>0&&(u===\$+1&&m===I+1&&\$>=0&&I>=0&&n[\$]===o[I]?d.unshift({type:"equal",x:\$,y:I}):u>\$?d.unshift({type:"delete",x:\$,y:-1}):d.unshift({type:"insert",x:-1,y:I})),u=\$,m=I}let p=[],g=1,y=1;for(let h of d)h.type==="equal"?p.push({type:"equal",content:n[h.x],oldLineNo:g++,newLineNo:y++}):h.type==="delete"?p.push({type:"delete",content:n[h.x],oldLineNo:g++}):p.push({type:"insert",content:o[h.y],newLineNo:y++});return p}var Mo=x(()=>{"use strict"});function xt(e){let n=Date.now()-e,o=Math.floor(n/1e3),r=Math.floor(o/60),i=Math.floor(r/60),a=Math.floor(i/24);return a>0?\`\${a}\\u5929\\u524D\`:i>0?\`\${i}\\u5C0F\\u65F6\\u524D\`:r>0?\`\${r}\\u5206\\u949F\\u524D\`:"\\u521A\\u521A"}var Ao=x(()=>{"use strict"});function Et(e){let t=Array.from(e.values()),n={};return t.forEach(o=>{n[o.name]=(n[o.name]||0)+1}),t.map(o=>{if(n[o.name]===1)return{...o,displayName:o.name};let r=o.path.split("/").filter(Boolean),i=t.filter(s=>s.name===o.name&&s.path!==o.path),a="";for(let s=r.length-2;s>=0;s--){let c=r[s];if(i.every(d=>d.path.split("/").filter(Boolean)[s]!==c)){a=c;break}}return!a&&r.length>=2&&(a=r[r.length-2]),{...o,displayName:a?\`\${o.name} (\${a})\`:o.name}})}var Lo=x(()=>{"use strict"});function K(e,t=!1){return e.isMissing?{badge:"D",color:"#ff3b30",type:"deleted"}:e.lastModified>e.displayedModified?{badge:"M",color:"#ff9500",type:"modified"}:t?{badge:"dot",color:"#007AFF",type:"new"}:{badge:null,color:null,type:"normal"}}var Tt=x(()=>{"use strict"});function bn(e){let t=e.match(/\\.([^.]+)\$/);return t?t[1].toLowerCase():""}function Bi(e){let t=bn(e);return t==="html"||t==="htm"}function wn(e){return bn(e)==="json"}function Je(e){return bn(e)==="jsonl"}function ge(e){return Bi(e)?{cls:"html",label:"<>"}:wn(e)||Je(e)?{cls:"json",label:"{}"}:{cls:"md",label:"M"}}var Ue=x(()=>{"use strict"});function Fe(e,t,n,o){if(t.length===0)return[];if(e==="close-all")return t.map(r=>r.path);if(!n)return[];if(e==="close-others")return t.filter(r=>r.path!==n).map(r=>r.path);if(e==="close-right"){let r=t.findIndex(i=>i.path===n);return r<0?[]:t.slice(r+1).map(i=>i.path)}return t.filter(r=>r.path!==n&&o(r.path)).map(r=>r.path)}var Fo=x(()=>{"use strict"});function Ve(e){return e&&(e.replace(/\\.(md|markdown|html?)\$/i,"")||e)}var vn=x(()=>{"use strict"});var En={};le(En,{getPinnedFiles:()=>xn,isPinned:()=>kn,pinFile:()=>Ii,unpinFile:()=>Hi});function St(){try{let e=localStorage.getItem(Co);if(!e)return new Set;let t=JSON.parse(e);return Array.isArray(t)?new Set(t):new Set}catch{return new Set}}function \$o(e){try{localStorage.setItem(Co,JSON.stringify(Array.from(e)))}catch{}}function kn(e){return St().has(e)}function Ii(e){let t=St();t.add(e),\$o(t)}function Hi(e){let t=St();t.delete(e),\$o(t)}function xn(){return St()}var Co,Ge=x(()=>{"use strict";Co="md-viewer:pinned-files"});function Wi(e){let t=e.replace(/[.+^\${}()|[\\]\\\\]/g,"\\\\\$&");return t=t.replace(/\\*\\*/g,"\\xA7GLOBSTAR\\xA7"),t=t.replace(/\\*/g,"[^/]*"),t=t.replace(/\\?/g,"[^/]"),t=t.replace(/§GLOBSTAR§/g,".*"),e.endsWith("/")?new RegExp(\`(^|/)\${t}\`):new RegExp(\`(^|/)\${t}(/|\$)\`)}function ji(e,t,n){if(!n.length)return!1;let o=e.startsWith(t+"/")?e.slice(t.length+1):e;return n.some(r=>Wi(r).test(o))}function Bo(e){if(e.type==="file")return[e];let t=[];for(let n of e.children||[])t.push(...Bo(n));return t}function Pi(e,t,n,o){if(!t)return[];let r=Date.now()-n,i=t.ignorePatterns||[];return Bo(t).filter(s=>i.length&&ji(s.path,e,i)?!1:!!(o.has(s.path)||typeof s.lastModified=="number"&&s.lastModified>=r)).sort((s,c)=>{let d=o.has(s.path),u=o.has(c.path);return d!==u?d?-1:1:(c.lastModified||0)-(s.lastModified||0)})}function Di(e){let t=Date.now()-e,n=Math.floor(t/6e4);if(n<60)return\`\${n}m\`;let o=Math.floor(t/36e5);return o<24?\`\${o}h\`:\`\${Math.floor(t/864e5)}d\`}function Ri(e,t){if(!t)return b(e);let n=e.toLowerCase().indexOf(t.toLowerCase());return n===-1?b(e):b(e.slice(0,n))+\`<mark class="search-highlight">\${b(e.slice(n,n+t.length))}</mark>\`+b(e.slice(n+t.length))}function Oi(e,t,n){let o=l.currentFile===e.path,r=t.has(e.path),i=l.sessionFiles.get(e.path),a="normal";i?a=K(i,W(e.path)).type:ze(e.path)?a="modified":W(e.path)&&(a="new");let s=ge(e.path),c=Ve(e.name)||e.name,d=e.lastModified?Di(e.lastModified):"",u=a==="modified"?'<span class="focus-file-dot modified"></span>':a==="new"?'<span class="focus-file-dot new-file"></span>':"",m=r?\`<button class="tree-pin-btn active" title="\\u53D6\\u6D88\\u56FA\\u5B9A" onclick="event.stopPropagation();handleUnpinFile('\${w(e.path)}')" data-path="\${w(e.path)}">\\u{1F4CC}</button>\`:\`<button class="tree-pin-btn" title="\\u56FA\\u5B9A\\u5230\\u7126\\u70B9\\u89C6\\u56FE" onclick="event.stopPropagation();handlePinFile('\${w(e.path)}')">\\u{1F4CC}</button>\`;return\`
...
\`);if(n.length===0){Y=t,be=o,Ne=new Set,Z=!1,\$e=!0;return}\$e&&!Z&&Y===t&&be===o||Z&&Y===t&&be===o||(At+=1,Y=t,be=o,Z=!0,\$e=!1,Ne=new Set,Gi(t,n,o,At))}function qo(){let e=document.getElementById(Ye),t=document.getElementById(Po);if(!t)return;let n=e?.value.trim()||"";t.textContent=n||"\\u8DEF\\u5F84\\u9884\\u89C8\\uFF1A\\u5728\\u4E0A\\u65B9\\u8F93\\u5165\\u540E\\u8FD9\\u91CC\\u4F1A\\u663E\\u793A\\u5B8C\\u6574\\u8DEF\\u5F84"}function Xi(){let e=document.getElementById(Mn);if(e)return e;let t=document.createElement("div");t.id=Mn,t.className="sync-dialog-overlay add-workspace-overlay",t.innerHTML=\`
  ...
  \`,document.body.appendChild(t),t.addEventListener("click",o=>{o.target===t&&Lt()});let n=t.querySelector(\`#\${Ye}\`);return n&&(Mt(n,{kind:"directory",markdownOnly:!1}),n.addEventListener("input",qo),n.addEventListener("keydown",o=>{(o.metaKey||o.ctrlKey)&&o.key==="Enter"&&(o.preventDefault(),window.confirmAddWorkspaceDialog()),o.key==="Escape"&&(o.preventDefault(),Lt())})),t}function Yi(){Xi().classList.add("show");let t=document.getElementById(Ye);t&&(t.value="",qo(),t.focus())}function Lt(){let e=document.getElementById(Mn);e&&e.classList.remove("show")}async function Zi(){try{let e=document.getElementById(Ye),t=e?.value.trim()||"";if(!t){To("\\u8BF7\\u8F93\\u5165\\u5DE5\\u4F5C\\u533A\\u8DEF\\u5F84"),e?.focus();return}let n=Ki(t),{addWorkspace:o}=await Promise.resolve().then(()=>(_e(),xo)),r=o(n,t),{renderSidebar:i}=await Promise.resolve().then(()=>(L(),F));i(),Lt(),_(\`\\u5DF2\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A: \${r.name}\`,2e3)}catch(e){console.error("\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25:",e),M(\`\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A\\u5931\\u8D25: \${e?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)}}function zo(){if(l.config.sidebarTab==="focus")return Io();let e=l.searchQuery.trim().toLowerCase();return Qi(e),\`\${ea(e)}\`}function ea(e){let t=l.config.workspaces,n=t.map((o,r)=>na(o,r,t.length,e)).filter(Boolean).join("");return\`
...
\`,d);return u===-1?o.length:u};switch(n){case"a":return a(s(r)),!0;case"e":return a(c(r)),!0;case"b":return a(Math.max(0,r-1)),!0;case"f":return a(Math.min(o.length,r+1)),!0;case"n":{let d=c(r);return a(d===o.length?d:Math.min(o.length,d+1+(r-s(r)))),!0}case"p":{let d=s(r);if(d===0)return a(0),!0;let u=s(d-1),m=d-1-u;return a(u+Math.min(r-d,m)),!0}case"d":return r<o.length&&(t.value=o.slice(0,r)+o.slice(r+1),a(r),t.dispatchEvent(new Event("input"))),!0;case"k":{let d=c(r),u=r===d&&d<o.length?d+1:d;return t.value=o.slice(0,r)+o.slice(u),a(r),t.dispatchEvent(new Event("input")),!0}case"u":{let d=s(r);return t.value=o.slice(0,d)+o.slice(r),a(d),t.dispatchEvent(new Event("input")),!0}case"w":{let d=r;for(;d>0&&/\\s/.test(o[d-1]);)d--;for(;d>0&&!/\\s/.test(o[d-1]);)d--;return t.value=o.slice(0,d)+o.slice(r),a(d),t.dispatchEvent(new Event("input")),!0}case"h":return r>0&&(t.value=o.slice(0,r-1)+o.slice(r),a(r-1),t.dispatchEvent(new Event("input"))),!0;default:return!1}}function ee(e){return e==="up"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 4l4 4H4z"/></svg>':e==="down"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 12l-4-4h8z"/></svg>':e==="check"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M6.4 11.2L3.5 8.3l1.1-1.1 1.8 1.8 5-5 1.1 1.1z"/></svg>':e==="trash"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M6 2h4l1 1h3v1H2V3h3l1-1zm-1 4h1v7H5V6zm3 0h1v7H8V6zm3 0h1v7h-1V6z"/></svg>':e==="comment"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 2h12v9H8l-3 3v-3H2z"/></svg>':e==="list"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M3 3h10v1H3zm0 4h10v1H3zm0 4h10v1H3z"/></svg>':e==="filter"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M2 3h12L9.5 8v4.5l-3-1.5V8z"/></svg>':e==="edit"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M11.5 2.5a1.5 1.5 0 012.1 2.1L5 13.2l-3 .8.8-3 8.7-8.5z"/></svg>':e==="reopen"?'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M8 2a6 6 0 100 12A6 6 0 008 2zm0 1.5a4.5 4.5 0 110 9 4.5 4.5 0 010-9zM6 5.5l4 2.5-4 2.5V5.5z"/></svg>':'<svg viewBox="0 0 16 16" aria-hidden="true"><path d="M4.2 4.2L8 8l3.8-3.8 1 1L9 9l3.8 3.8-1 1L8 10l-3.8 3.8-1-1L7 9 3.2 5.2z"/></svg>'}function It(){return[...f.annotations].filter(e=>ga(e,f.filter)).sort((e,t)=>e.start-t.start)}function ha(){let e=T();if(e.filterMenu?.querySelectorAll(".annotation-filter-item[data-filter]").forEach(t=>{let n=t;n.classList.toggle("is-active",n.getAttribute("data-filter")===f.filter)}),e.densityToggle&&(e.densityToggle.classList.toggle("is-simple",f.density==="simple"),e.densityToggle.title=f.density==="simple"?"\\u5207\\u6362\\u5230\\u9ED8\\u8BA4\\u5217\\u8868":"\\u5207\\u6362\\u5230\\u6781\\u7B80\\u5217\\u8868"),e.filterToggle){let t={all:"\\u7B5B\\u9009\\uFF1A\\u5168\\u90E8",open:"\\u7B5B\\u9009\\uFF1A\\u672A\\u89E3\\u51B3",resolved:"\\u7B5B\\u9009\\uFF1A\\u5DF2\\u89E3\\u51B3",orphan:"\\u7B5B\\u9009\\uFF1A\\u5B9A\\u4F4D\\u5931\\u8D25"};e.filterToggle.title=t[f.filter]}}function ya(){let e=T();e.annotationCount&&(e.annotationCount.textContent=String(It().length))}function Be(e){let t=T();t.sidebar&&(t.sidebar.classList.toggle("collapsed",e),document.body.classList.toggle("annotation-sidebar-collapsed",e),e&&(t.filterMenu?.classList.add("hidden"),Ie(!0),oe(!0)))}function vr(){try{let e=localStorage.getItem(mr);if(!e)return{};let t=JSON.parse(e);return t&&typeof t=="object"?t:{}}catch{return{}}}function ba(e){localStorage.setItem(mr,JSON.stringify(e))}function kr(e){if(!f.currentFilePath)return;let t=vr();t[f.currentFilePath]=e,ba(t)}function wa(e){return Math.max(sa,Math.min(la,Math.round(e)))}function xr(e){let t=wa(e);document.documentElement.style.setProperty("--annotation-sidebar-width",\`\${t}px\`),localStorage.setItem(ur,String(t))}function va(){let e=Number(localStorage.getItem(ur)),t=Number.isFinite(e)&&e>0?e:pr;xr(t)}function ne(){let e=T();if(!e.sidebar)return;let t=document.getElementById("tabs"),n=Math.max(0,Math.round(t?.getBoundingClientRect().bottom||84)),o=Math.max(0,window.innerHeight-n);e.sidebar.style.top=\`\${n}px\`,e.sidebar.style.height=\`\${o}px\`,e.sidebarResizer&&(e.sidebarResizer.style.top=\`\${n}px\`,e.sidebarResizer.style.height=\`\${o}px\`),e.floatingOpenBtn&&(e.floatingOpenBtn.style.top=\`\${n+6}px\`)}function ar(){Be(!1),kr(!0),ne(),Bn()}function sr(){Be(!0),kr(!1)}function ka(){let e=T().sidebar;e&&Be(!e.classList.contains("collapsed"))}function Er(){let e=T();return e.filterMenu&&!e.filterMenu.classList.contains("hidden")?(e.filterMenu.classList.add("hidden"),!0):e.quickAdd&&!e.quickAdd.classList.contains("hidden")?(Ie(!0),!0):e.composer&&!e.composer.classList.contains("hidden")?(et(),!0):e.popover&&!e.popover.classList.contains("hidden")?(f.pinnedAnnotationId=null,oe(!0),!0):!1}function xa(e,t){return e==="resolved"?"resolved":t}function Ea(e,t,n){let o=T();if(!o.quickAdd)return;o.composer&&!o.composer.classList.contains("hidden")&&et(),f.pendingAnnotation={...n,note:"",createdAt:Date.now()},f.pendingAnnotationFilePath=o.content?.getAttribute("data-current-file")||f.currentFilePath;let r=30,i=30,a=Ct(e,8,window.innerWidth-r-8),s=Ct(t,8,window.innerHeight-i-8);o.quickAdd.style.left=\`\${a}px\`,o.quickAdd.style.top=\`\${s}px\`,o.quickAdd.classList.remove("hidden")}function Ie(e=!1){let t=T();t.quickAdd&&(t.quickAdd.classList.add("hidden"),e&&(\$n(),f.pendingAnnotation=null,f.pendingAnnotationFilePath=null))}function Ta(e,t){let n=T();if(!f.pendingAnnotation||!n.composer||!n.composerNote)return;Aa(),n.composerNote.value="",Mr(n.composerNote);let o=typeof e=="number"?e:n.quickAdd?Number.parseFloat(n.quickAdd.style.left||"0"):0,r=typeof t=="number"?t:n.quickAdd?Number.parseFloat(n.quickAdd.style.top||"0"):0;Fn(n.composer,o,r+34),n.composer.classList.remove("hidden"),Ie(!1),n.composerNote.focus()}function Sa(){let e=T();e.composer&&e.composer.classList.add("hidden")}function Ma(){let e=T();if(!e.composer||!f.pendingAnnotation)return;let n=document.getElementById("reader")?.querySelector(".annotation-mark-temp");if(n){let o=n.getBoundingClientRect();Fn(e.composer,o.right+6,o.top-8)}e.composer.classList.remove("hidden"),e.composerNote?.focus()}function et(){let e=T();e.composer&&(\$n(),f.pendingAnnotation=null,f.pendingAnnotationFilePath=null,e.composerNote&&(e.composerNote.value=""),e.composer.classList.add("hidden"))}function \$n(){let e=document.getElementById("reader");if(!e)return;let t=Array.from(e.querySelectorAll(".annotation-mark-temp"));for(let n of t){let o=n.parentNode;for(;n.firstChild;)o?.insertBefore(n.firstChild,n);o?.removeChild(n)}}function Aa(){let e=T();if(!e.reader||!f.pendingAnnotation)return;\$n();let t=f.pendingAnnotation,n=Ft(e.reader,t.start),o=Ft(e.reader,t.start+t.length);if(!(!n||!o)&&!(n.node===o.node&&n.offset===o.offset)){if(n.node===o.node){let r=document.createRange();r.setStart(n.node,n.offset),r.setEnd(o.node,o.offset);let i=document.createElement("span");i.className="annotation-mark-temp";try{r.surroundContents(i)}catch{}return}try{let r=[],i=document.createTreeWalker(e.reader,NodeFilter.SHOW_TEXT,null,!1),a;for(;a=i.nextNode();){let s=document.createRange();s.selectNode(a);let c=document.createRange();c.setStart(n.node,n.offset),c.setEnd(o.node,o.offset);let d=c.compareBoundaryPoints(Range.END_TO_START,s),u=c.compareBoundaryPoints(Range.START_TO_END,s);if(d>0||u<0)continue;let m=a===n.node?n.offset:0,p=a===o.node?o.offset:a.nodeValue?.length||0;m<p&&r.push({node:a,start:m,end:p})}for(let s=r.length-1;s>=0;s--){let{node:c,start:d,end:u}=r[s],m=document.createRange();m.setStart(c,d),m.setEnd(c,u);let p=document.createElement("span");p.className="annotation-mark-temp",m.surroundContents(p)}}catch{}}}function Nn(e){return fr(e),e.thread||[]}function Tr(e,t=!1){let n=Nn(e),o=n[0],r=n.slice(1);return t?\`
  ...
  \`}function Pn(){let e=document.getElementById("fileList");if(!e)return;if(l.sessionFiles.size===0){e.innerHTML='<div class="empty-tip">\\u70B9\\u51FB\\u4E0A\\u65B9\\u6DFB\\u52A0 Markdown/HTML \\u6587\\u4EF6</div>';return}let t=an();if(t.length===0){e.innerHTML='<div class="empty-tip">\\u672A\\u627E\\u5230\\u5339\\u914D\\u7684\\u6587\\u4EF6</div>';return}let n=new Map(t.map(r=>[r.path,r])),o=Et(n);e.innerHTML=o.map(r=>{let i=r.path===l.currentFile,a=r.isMissing||!1,s=ge(r.path),c=["file-item",i?"current":"",a?"deleted":""].filter(Boolean).join(" "),d=r.displayName||r.name,u=l.searchQuery.toLowerCase().trim();if(u){let g=d.toLowerCase().indexOf(u);if(g!==-1){let y=d.substring(0,g),h=d.substring(g,g+u.length),v=d.substring(g+u.length);d=\`\${y}<mark class="search-highlight">\${h}</mark>\${v}\`}}let m=K(r,W(r.path)),p="&nbsp;";return m.badge==="dot"?p='<span class="new-dot"></span>':m.badge&&(p=\`<span class="status-badge status-\${m.type}" style="color: \${m.color}">\${m.badge}</span>\`),\`
      <div class="\${c}"
    ...
    \`}).join(""),Wr(e)}function A(){let e=l.config.sidebarTab,t=document.querySelector(".sidebar");if(t&&t.classList.toggle("workspace-mode",e==="focus"||e==="full"),Pr(),za(),e==="list"){jn(),Pn(),re();return}if(jn(),!t)return;let n=document.getElementById("fileList");n||(n=document.createElement("div"),n.id="fileList",n.className="file-list",t.appendChild(n)),n.innerHTML=zo(),Ko(),Wr(n),re()}function re(){let e=Array.from(l.sessionFiles.values()),t=document.getElementById("tabs");if(!t)return;Da(),Ra();let n=t.querySelector(".tab-manager-list");n&&(Pt=n.scrollTop);let o=t.querySelector(".tabs-scroll");if(o&&(Dt=o.scrollLeft),e.length===0){t.innerHTML="",t.style.display="none",D=!1,Hn="";return}let r=Et(l.sessionFiles),i=r.map(p=>{let g=K(p,W(p.path));return[p.path,p.displayName||p.name,p.isMissing?"1":"0",p.path===l.currentFile?"1":"0",g.type,g.badge||""].join("|")}).join("||"),a=[l.currentFile||"",D?"1":"0",nt,jt,i].join("###");if(a===Hn)return;Hn=a,Ia(l.currentFile),t.style.display="flex";let s=r.map(p=>{let g=p.path===l.currentFile,y=p.isMissing||!1,h=["tab"];return g&&h.push("active"),y&&h.push("deleted"),\`
      ...
      \`}).join(""),c=jt.toLowerCase().trim(),d=r.filter(p=>{let g=p.displayName||p.name;return c?g.toLowerCase().includes(c)||p.path.toLowerCase().includes(c):!0}).sort((p,g)=>{let y=p.displayName||p.name,h=g.displayName||g.name;if(nt==="name")return y.localeCompare(h,"zh-CN");let v=Hr(p.path)-Hr(g.path);return v!==0?v:y.localeCompare(h,"zh-CN")}),u=d.length===0?'<div class="tab-manager-empty">\\u6CA1\\u6709\\u5339\\u914D\\u7684\\u5DF2\\u6253\\u5F00\\u6587\\u4EF6</div>':d.map(p=>{let g=p.displayName||p.name,y=p.path===l.currentFile,h=K(p,W(p.path)),v=h.badge?\`<span class="tab-manager-status status-\${h.type}">\${b(h.badge)}</span>\`:"";return\`
        ...
        \`}).join(""),m={others:Fe("close-others",r,l.currentFile,()=>!1).length,right:Fe("close-right",r,l.currentFile,()=>!1).length,unmodified:Fe("close-unmodified",r,l.currentFile,p=>{let g=r.find(h=>h.path===p);if(!g)return!1;let y=K(g,W(g.path));return y.type==="normal"||y.type==="new"}).length,all:Fe("close-all",r,l.currentFile,()=>!1).length};t.innerHTML=\`
  ...
  \`,requestAnimationFrame(()=>{let p=t.querySelector(".tab-manager-list");p&&Pt>0&&(p.scrollTop=Pt);let g=t.querySelector(".tabs-scroll");g&&Dt>0&&(g.scrollLeft=Dt),ne()})}var Ht,Wt,Nr,D,jt,nt,Br,Pt,Dt,Ir,Hn,He,L=x(()=>{"use strict";N();Q();xe();fe();Lo();Tt();Ue();Fo();Jo();In();Sn();Ht=0,Wt="",Nr=!1,D=!1,jt="",nt="recent",Br=!1,Pt=0,Dt=0,Ir=!1,Hn="",He=[];typeof window<"u"&&(window.setSidebarTab=jr,window.toggleTabManager=Ha,window.setTabManagerQuery=ja,window.setTabManagerSort=Pa,window.applyTabBatchAction=Oa)});var We,Dr,ot=x(()=>{"use strict";We=\`/*light */
.markdown-body {
  color-scheme: light;
...
}\`});var Dn,Rr=x(()=>{"use strict";ot();Dn=We});var Or,qr=x(()=>{"use strict";ot();Or=We+\`
...
\`});var zr,_r=x(()=>{"use strict";ot();zr=We+\`
...
\`});var Rn,Kr=x(()=>{"use strict";ot();Rn=Dr});var Jr,Ur=x(()=>{"use strict";Jr=\`
...
\`});function Qr(e){return On.find(t=>t.key===e)?.css??Dn}function Xr(e){return qn.find(t=>t.key===e)?.css??Rn}var On,qn,zn=x(()=>{"use strict";Rr();qr();_r();Kr();Ur();Gr();On=[{key:"github",label:"GitHub",css:Dn},{key:"notion",label:"Notion",css:Or},{key:"bear",label:"Bear / iA Writer",css:zr}],qn=[{key:"github",label:"GitHub Light",css:Rn},{key:"github-dark",label:"GitHub Dark",css:Jr},{key:"atom-one-dark",label:"Atom One Dark",css:Vr}]});function Zr(){Rt=l.config.markdownTheme||"github",_n=l.config.codeTheme||"github",document.getElementById("settingsDialogOverlay")||_a(),Ka();let t=document.getElementById("settingsDialogOverlay");t&&t.classList.add("show")}function _a(){let e=document.createElement("div");e.id="settingsDialogOverlay",e.className="sync-dialog-overlay",e.innerHTML=\`
  ...
  \`,document.body.appendChild(e),e.addEventListener("click",t=>{t.target===e&&rt()})}function Ka(){let e=document.getElementById("settingsDialogBody");if(!e)return;let t=Ua();e.innerHTML=\`
...
\`),r=document.createElement("div");r.className="json-viewer";let i=0;for(let a of o){let s=a.trim();if(!s)continue;i++;let c=document.createElement("div");c.className="json-line-header",c.textContent=\`Line \${i}\`,r.appendChild(c);let d;try{d=JSON.parse(s)}catch(m){let p=document.createElement("div");p.className="json-error",p.innerHTML=\`\\u89E3\\u6790\\u5931\\u8D25\\uFF1A\${b(String(m))}<pre>\${b(s.slice(0,200))}</pre>\`,r.appendChild(p);continue}let u=document.createElement("ul");u.innerHTML=Kn(d,null,0,n),r.appendChild(u)}e.appendChild(r)}var ni=x(()=>{"use strict";fe();Ue()});var he={};le(he,{renderAll:()=>ss});function ii(){let e=Qr(l.config.markdownTheme||"github"),t=Xr(l.config.codeTheme||"github"),n=document.getElementById("theme-md-css"),o=document.getElementById("theme-hl-css");n&&(n.textContent=e),o&&(o.textContent=t)}function ke(e=!1){let t=l.currentFile&&!ui(l.currentFile)?l.currentFile:null,n=wr();(e||t!==n)&&yr(t),B(),C(t)}async function si(e,t=!1){let n=l.currentFile,o=t;nn(e,o),o&&(l.config.sidebarTab==="focus"||l.config.sidebarTab==="full")&&await dn(e.path),o&&e.path,A(),U(),ke(o&&n!==e.path),o&&n!==e.path&&li()}function li(){let e=document.getElementById("content");e&&e.scrollTo({top:0,behavior:"auto"})}function os(){return Math.max(ai,Math.min(ns,window.innerWidth-360))}function Xn(e){return Math.min(os(),Math.max(ai,Math.round(e)))}function it(e){let t=Xn(e);document.documentElement.style.setProperty("--sidebar-width",\`\${t}px\`)}function rs(){let e=Number(localStorage.getItem(Gn)),t=Number.isFinite(e)&&e>0?e:Qn;it(t)}function is(){let e=document.getElementById("sidebarResizer");if(!e)return;let t=!1,n=r=>{if(!t)return;let i=Xn(r.clientX);it(i)},o=r=>{if(!t)return;t=!1;let i=Xn(r.clientX);it(i),localStorage.setItem(Gn,String(i)),document.body.classList.remove("sidebar-resizing"),window.removeEventListener("mousemove",n),window.removeEventListener("mouseup",o)};e.addEventListener("mousedown",r=>{window.innerWidth<=900||(t=!0,document.body.classList.add("sidebar-resizing"),window.addEventListener("mousemove",n),window.addEventListener("mouseup",o),r.preventDefault())}),e.addEventListener("dblclick",()=>{it(Qn),localStorage.setItem(Gn,String(Qn))}),window.addEventListener("resize",()=>{let r=Number.parseInt(getComputedStyle(document.documentElement).getPropertyValue("--sidebar-width"),10);Number.isFinite(r)&&it(r)})}async function as(){l.currentFile&&await Zn(l.currentFile,{silent:!0,highlight:!1})}async function ci(e){await Zn(e,{silent:!1,highlight:!0})&&l.currentFile===e&&_("\\u6587\\u4EF6\\u5DF2\\u5237\\u65B0",2e3)}function di(){let e=document.getElementById("content");e&&(e.style.animation="flash 700ms ease-out",setTimeout(()=>{e.style.animation=""},700))}async function Zn(e,t={}){let n=l.sessionFiles.get(e);if(!n||n.isMissing)return!1;let o=(Jn.get(e)||0)+1;Jn.set(e,o);let r=await Le(e,t.silent!==!1);if(!r||Jn.get(e)!==o)return!1;let i=l.sessionFiles.get(e)||l.sessionFiles.get(r.path);if(!i)return!1;if(i.content=r.content,i.pendingContent=void 0,r.lastModified>=(i.lastModified||0)&&(i.lastModified=r.lastModified),i.displayedModified=r.lastModified,i.isMissing=!1,q(),l.currentFile===e||l.currentFile===r.path){if(ie){ie=!1;let a=document.getElementById("diffButton");a&&a.classList.remove("active")}U(),ke(!1),t.highlight&&di()}return A(),await ve(),!0}function ss(){A(),U(),ke(!1)}function ls(e,t){let n=\`\${e}/\${t}\`,o=n.startsWith("/"),r=n.split("/"),i=[];for(let a of r)if(!(!a||a===".")){if(a===".."){i.length>0&&i.pop();continue}i.push(a)}return\`\${o?"/":""}\${i.join("/")}\`}function cs(e,t){let n=e.trim();if(!n||n.startsWith("http://")||n.startsWith("https://")||n.startsWith("data:")||n.startsWith("blob:")||n.startsWith("/api/")||pi(t))return null;let o=n.indexOf("?"),r=n.indexOf("#"),i=[o,r].filter(u=>u>=0).sort((u,m)=>u-m)[0]??-1,a=i>=0?n.slice(0,i):n,s=i>=0?n.slice(i):"",c=t.slice(0,t.lastIndexOf("/")),d=a.startsWith("/")?a:ls(c,a);return\`/api/file-asset?path=\${encodeURIComponent(d)}\${s}\`}function ds(e,t){let n=e.querySelector(".markdown-body");n&&n.querySelectorAll("img[src], video[src], source[src]").forEach(o=>{let r=o.getAttribute("src");if(!r)return;let i=cs(r,t);i&&o.setAttribute("src",i)})}async function us(e){let t=window.mermaid;if(!t)return;let n=Array.from(e.querySelectorAll(".markdown-body pre > code.language-mermaid, .markdown-body pre > code.lang-mermaid, .markdown-body pre > code.language-flowchart, .markdown-body pre > code.lang-flowchart"));if(n.length===0)return;oi||(t.initialize({startOnLoad:!1,theme:"neutral",securityLevel:"loose"}),oi=!0);let o=i=>{let a=i.textContent||"\\u590D\\u5236";i.textContent="\\u2713",i.classList.add("copied"),window.setTimeout(()=>{i.textContent=a,i.classList.remove("copied")},900)},r=(i,a)=>{let s=document.createElement("div");s.className="mermaid-source-panel",s.style.display=a?"block":"none";let c=document.createElement("div");c.className="mermaid-source-head";let d=document.createElement("span");d.textContent="Mermaid \\u6E90\\u7801";let u=document.createElement("button");u.className="mermaid-source-copy",u.textContent="\\u590D\\u5236",u.addEventListener("click",async()=>{try{await navigator.clipboard.writeText(i),o(u)}catch{}}),c.appendChild(d),c.appendChild(u);let m=document.createElement("pre"),p=document.createElement("code");p.className="language-mermaid",p.textContent=i,m.appendChild(p),s.appendChild(c),s.appendChild(m);let g=document.createElement("button");return g.className="mermaid-source-toggle",g.textContent=a?"\\u9690\\u85CF\\u6E90\\u7801":"\\u6E90\\u7801",g.addEventListener("click",()=>{let y=s.style.display!=="none";s.style.display=y?"none":"block",g.textContent=y?"\\u6E90\\u7801":"\\u9690\\u85CF\\u6E90\\u7801"}),{panel:s,toggleButton:g}};for(let i=0;i<n.length;i+=1){let a=n[i],s=a.closest("pre");if(!s)continue;let c=(a.textContent||"").trim();if(!c)continue;let d=a.classList.contains("language-flowchart")||a.classList.contains("lang-flowchart"),u=c.split(\`
...
\${c}\`:c;if(m)try{let p=\`mdv-mermaid-\${Date.now()}-\${i}\`,{svg:g,bindFunctions:y}=await t.render(p,m),h=document.createElement("div");h.className="mermaid-block";let v=document.createElement("div");v.className="mermaid-actions";let{panel:E,toggleButton:k}=r(m,!1);v.appendChild(k);let S=document.createElement("div");S.className="mermaid",S.setAttribute("data-mdv-mermaid","1"),S.innerHTML=g,h.appendChild(v),h.appendChild(S),h.appendChild(E),s.replaceWith(h),typeof y=="function"&&y(S)}catch(p){let g=document.createElement("div");g.className="mermaid-fallback-block";let y=document.createElement("div");y.className="mermaid-actions";let{panel:h,toggleButton:v}=r(m,!0);y.appendChild(v);let E=document.createElement("div");E.className="mermaid-fallback-notice",E.textContent="Mermaid \\u8BED\\u6CD5\\u9519\\u8BEF\\uFF0C\\u5DF2\\u56DE\\u9000\\u4E3A\\u539F\\u6587\\u663E\\u793A",g.appendChild(y),g.appendChild(E),g.appendChild(h),s.replaceWith(g),console.error("Mermaid \\u6E32\\u67D3\\u5931\\u8D25\\uFF0C\\u5DF2\\u56DE\\u9000\\u539F\\u6587:",p)}}}function U(){let e=document.getElementById("content");if(!e)return;if(!l.currentFile){e.removeAttribute("data-current-file"),e.innerHTML=\`
  ...
  \`}async function ps(e){if(e.stopPropagation(),!l.currentFile)return;let t=e.target,n=document.querySelector(".nearby-menu");if(n){n.remove();return}try{let o=await fn(l.currentFile);if(!o.files||o.files.length===0){mn("\\u9644\\u8FD1\\u6CA1\\u6709\\u5176\\u4ED6 Markdown \\u6587\\u4EF6",3e3);return}let r=document.createElement("div");r.className="nearby-menu",r.innerHTML=\`
      ...
      \`).join("")}
    \`;let i=t.getBoundingClientRect();r.style.position="fixed",r.style.left=i.left+"px",r.style.top=i.bottom+5+"px",document.body.appendChild(r);let a=()=>{r.remove(),document.removeEventListener("click",a)};setTimeout(()=>document.addEventListener("click",a),0)}catch(o){M("\\u83B7\\u53D6\\u9644\\u8FD1\\u6587\\u4EF6\\u5931\\u8D25: "+o.message)}}function ms(e){let t=e.split("/").filter(Boolean);return t[t.length-1]||"workspace"}function ui(e){let t=e.toLowerCase();return t.endsWith(".html")||t.endsWith(".htm")}function fs(e){let t=e.toLowerCase();return t.endsWith(".json")||t.endsWith(".jsonl")}function pi(e){return/^https?:\\/\\//i.test(e)}async function gs(e){if(P(e),A(),pi(e)){window.open(e,"_blank","noopener,noreferrer");return}try{let n=await(await fetch("/api/open-local-file",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({path:e})})).json();n?.error&&M(\`\\u6253\\u5F00 HTML \\u5931\\u8D25: \${n.error}\`)}catch(t){M(\`\\u6253\\u5F00 HTML \\u5931\\u8D25: \${t?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)}}function hs(e){let t=e.trim();return t?!!(/^https?:\\/\\//i.test(t)||t.startsWith("/")||t.startsWith("~/")||t.startsWith("./")||t.startsWith("../")||t.includes("/")||t.includes("\\\\")||/\\.[a-zA-Z0-9]{1,10}\$/.test(t)):!1}function at(){J=null;let e=document.getElementById("quickActionConfirm"),t=document.getElementById("quickActionConfirmText"),n=document.getElementById("quickActionConfirmActions");e&&(e.style.display="none",e.className="add-file-confirm"),t&&(t.textContent=""),n&&(n.innerHTML=""),document.body.classList.remove("quick-action-confirm-visible")}function mi(){let e=document.getElementById("quickActionConfirm");return!!e&&e.style.display!=="none"}function Ot(e,t,n={}){document.getElementById("searchInput")?.dispatchEvent(new Event("path-autocomplete-hide"));let r=document.getElementById("quickActionConfirm"),i=document.getElementById("quickActionConfirmText"),a=document.getElementById("quickActionConfirmActions");if(!(!r||!i||!a)){if(i.textContent=e,a.innerHTML="",r.className=\`add-file-confirm state-\${t}\`,r.style.display="flex",document.body.classList.add("quick-action-confirm-visible"),n.primaryLabel&&n.onPrimary){let s=document.createElement("button");s.className="add-file-confirm-button primary",s.textContent=n.primaryLabel,s.onclick=async()=>{await n.onPrimary(),at()},a.appendChild(s)}if(n.allowCancel!==!1){let s=document.createElement("button");s.className="add-file-confirm-button",s.textContent="\\u53D6\\u6D88",s.onclick=()=>at(),a.appendChild(s)}}}async function ri(){if(!J)return;if(J.kind==="add-other-file"){await De(J.path,!0);return}let e=wt(ms(J.path),J.path);A(),_(\`\\u5DF2\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A: \${e.name}\`,2e3),X(""),A()}async function De(e,t=!0){if(!e.trim())return;let n=await Le(e);n&&(await si(n,t),await yn(e,t),X(""),A())}async function fi(e){let t=e.trim();if(!t)return;let n=await hn(t),o=n.path||t;if(n.kind==="md_file"||n.kind==="html_file"){at(),await De(o,!0);return}if(n.kind==="other_file"){J={kind:"add-other-file",path:o,ext:n.ext||null},Ot(\`\\u68C0\\u6D4B\\u5230\\u975E Markdown \\u6587\\u4EF6\${n.ext?\`: \${n.ext}\`:""}\`,"warning",{primaryLabel:"\\u7EE7\\u7EED\\u6DFB\\u52A0\\u6587\\u4EF6",onPrimary:ri});return}if(n.kind==="directory"){J={kind:"add-workspace",path:o},Ot("\\u68C0\\u6D4B\\u5230\\u76EE\\u5F55\\uFF0C\\u662F\\u5426\\u4F5C\\u4E3A\\u5DE5\\u4F5C\\u533A\\u6DFB\\u52A0\\uFF1F","directory",{primaryLabel:"\\u6DFB\\u52A0\\u5DE5\\u4F5C\\u533A",onPrimary:ri});return}if(n.kind==="not_found"){J=null,Ot("\\u8DEF\\u5F84\\u4E0D\\u5B58\\u5728\\uFF0C\\u8BF7\\u68C0\\u67E5\\u540E\\u91CD\\u8BD5","error",{allowCancel:!0});return}J=null,Ot(n.error||"\\u65E0\\u6CD5\\u8BC6\\u522B\\u8F93\\u5165\\u8DEF\\u5F84","error",{allowCancel:!0})}function ys(e){if(ie){ie=!1;let o=document.getElementById("diffButton");o&&o.classList.remove("active")}let t=l.currentFile;rn(e),A(),U(),ke(!0),t!==e&&li();let n=l.sessionFiles.get(e);n&&!n.isMissing&&n.lastModified>n.displayedModified&&Zn(e,{silent:!0,highlight:!1})}function gi(e){on(e),A(),U(),ke(!0)}async function bs(e){let t=document.getElementById("searchInput"),n=(typeof e=="string"?e:t?.value||"").trim();if(n)try{let o=l.config.workspaces.map(i=>i.path).filter(Boolean),r=await Ke(n,{roots:o,limit:50});r.files&&r.files.length>0?await De(r.files[0].path):mn("\\u6CA1\\u6709\\u627E\\u5230\\u5339\\u914D\\u7684\\u6587\\u4EF6",3e3)}catch(o){M("\\u641C\\u7D22\\u5931\\u8D25: "+o.message)}}function ws(){document.body.addEventListener("dragover",e=>{e.preventDefault()}),document.body.addEventListener("drop",async e=>{e.preventDefault();let t=Array.from(e.dataTransfer?.files||[]);for(let n of t){let o=n.name.toLowerCase();(o.endsWith(".md")||o.endsWith(".markdown")||o.endsWith(".html")||o.endsWith(".htm"))&&await De(n.path)}})}function vs(){document.addEventListener("keydown",e=>{if(e.key==="Escape"){if(Er()){e.preventDefault();return}if(document.getElementById("settingsDialogOverlay")?.classList.contains("show")){e.preventDefault(),rt();return}let n=document.getElementById("addWorkspaceDialogOverlay");if(n?.classList.contains("show")){e.preventDefault(),n.classList.remove("show");return}}if((e.metaKey||e.ctrlKey)&&e.key.toLowerCase()==="k"){let t=document.activeElement?.tagName?.toLowerCase();if(t==="textarea"||t==="input")return;e.preventDefault();let n=document.getElementById("searchInput");n&&(n.focus(),n.select());return}(e.metaKey||e.ctrlKey)&&e.key==="w"&&(e.preventDefault(),l.currentFile&&gi(l.currentFile))})}function ks(){let e=new URLSearchParams(window.location.search),t=e.get("file"),n=e.get("focus")!=="false";t&&(De(t,n),window.history.replaceState({},"",window.location.pathname))}async function xs(e){let t=l.sessionFiles.get(e);if(!t)return null;if(t.pendingContent!==void 0)return t.pendingContent;let n=await Le(e,!0);return n?(t.pendingContent=n.content,n.content):null}function Es(e,t){let n=document.getElementById("content");if(!n)return;let o=So(e,t);if(!o.some(d=>d.type!=="equal")){n.innerHTML=\`
  ...
  \`,document.body.appendChild(e);let t=document.getElementById("findBarInput"),n=document.getElementById("findBarCount"),o=document.getElementById("findBarPrev"),r=document.getElementById("findBarNext"),i=document.getElementById("findBarClose"),a=[],s=-1,c=null;function d(){c&&c.querySelectorAll("mark.find-highlight").forEach(k=>{let S=k.parentNode;S&&(S.replaceChild(document.createTextNode(k.textContent||""),k),S.normalize())}),a=[],s=-1,n.textContent=""}function u(k){return k.replace(/[.*+?^\${}()|[\\]\\\\]/g,"\\\\\$&")}function m(k){if(d(),!k)return;let S=document.getElementById("content");if(!S)return;c=S;let \$=new RegExp(u(k),"gi"),I=document.createTreeWalker(S,NodeFilter.SHOW_TEXT,{acceptNode(ae){let R=ae.parentElement;if(!R)return NodeFilter.FILTER_REJECT;let O=R.tagName.toLowerCase();return O==="script"||O==="style"||O==="mark"?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),st=[],lt;for(;lt=I.nextNode();)st.push(lt);for(let ae of st){let R=ae.textContent||"",O,Re=[],Oe=0;for(\$.lastIndex=0;(O=\$.exec(R))!==null;){O.index>Oe&&Re.push(R.slice(Oe,O.index));let se=document.createElement("mark");se.className="find-highlight",se.textContent=O[0],Re.push(se),a.push(document.createRange()),Oe=O.index+O[0].length}if(Re.length===0)continue;Oe<R.length&&Re.push(R.slice(Oe));let qt=document.createDocumentFragment();Re.forEach(se=>{typeof se=="string"?qt.appendChild(document.createTextNode(se)):qt.appendChild(se)}),ae.parentNode.replaceChild(qt,ae)}a=[],S.querySelectorAll("mark.find-highlight").forEach(ae=>{let R=document.createRange();R.selectNode(ae),a.push(R)}),a.length>0&&(s=0,p(0)),g()}function p(k){let S=document.getElementById("content");if(!S)return;let \$=S.querySelectorAll("mark.find-highlight");\$.forEach((st,lt)=>{st.classList.toggle("find-highlight-current",lt===k)});let I=\$[k];I&&I.scrollIntoView({block:"center",behavior:"smooth"})}function g(){a.length===0?(n.textContent=t.value?"\\u65E0\\u7ED3\\u679C":"",n.className=t.value?"no-result":""):(n.textContent=\`\${s+1} / \${a.length}\`,n.className="")}function y(){a.length!==0&&(s=(s+1)%a.length,p(s),g())}function h(){a.length!==0&&(s=(s-1+a.length)%a.length,p(s),g())}function v(){e.classList.add("visible"),t.focus(),t.select(),t.value&&m(t.value)}function E(){e.classList.remove("visible"),d()}window.__showFindBar=v,t.addEventListener("input",()=>m(t.value)),t.addEventListener("keydown",k=>{k.key==="Enter"?(k.shiftKey?h():y(),k.preventDefault()):k.key==="Escape"&&(E(),k.preventDefault())}),o.addEventListener("click",h),r.addEventListener("click",y),i.addEventListener("click",E)}var Gn,Qn,ai,ns,Jn,ie,Un,oi,J,Pe,ye=x(()=>{N();Q();_e();me();fe();Mo();Ao();L();Ae();ei();ni();zn();In();Gn="md-viewer:sidebar-width",Qn=260,ai=220,ns=680,Jn=new Map,ie=!1,Un=!1,oi=!1;J=null;Pe=1;document.addEventListener("click",e=>{let t=document.getElementById("fontScaleMenu"),n=document.getElementById("fontScaleButton");if(!t||!n)return;let o=e.target;!t.contains(o)&&!n.contains(o)&&eo()});window.addFile=()=>{let e=document.getElementById("searchInput");e&&fi(e.value).catch(t=>{M(\`\\u6DFB\\u52A0\\u5931\\u8D25: \${t?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)})};window.handleUnifiedInputSubmit=e=>{let t=document.getElementById("searchInput"),n=(typeof e=="string"?e:t?.value||"").trim();if(n){if(!hs(n)){bs(n).catch(o=>{M(\`\\u641C\\u7D22\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)});return}fi(n).catch(o=>{M(\`\\u6DFB\\u52A0\\u5931\\u8D25: \${o?.message||"\\u672A\\u77E5\\u9519\\u8BEF"}\`)})}};window.dismissQuickActionConfirm=()=>{mi()&&at()};window.switchFile=ys;window.removeFile=gi;window.showNearbyMenu=ps;window.addFileByPath=De;window.refreshFile=ci;window.handleRefreshButtonClick=Ms;window.handleDiffButtonClick=Ts;window.closeDiffView=hi;window.acceptDiffUpdate=Ss;window.copySingleText=Fs;window.copyFileName=Cs;window.copyFilePath=yi;window.showToast=Me;window.showSettingsDialog=Zr;window.toggleFontScaleMenu=Bs;window.setFontScale=Ns;window.openExternalFile=gs;window.renderContent=U;window.applyTheme=ii;(async()=>(rs(),\$s(),\$r(),ne(),window.addEventListener("resize",()=>{ne()}),await tn(Le),ii(),await cn(),Is(),A(),U(),ke(!0),ws(),is(),document.addEventListener("click",e=>{if(!mi())return;let t=e.target;t&&(t.closest(".sidebar-header")||t.closest("#quickActionConfirm")||at())}),ks(),vs(),document.addEventListener("mouseup",()=>{setTimeout(()=>{let e=document.getElementById("content")?.getAttribute("data-current-file")||null;Cr(e)},0)}),await as(),vi(),Hs()))()});ye();})();
